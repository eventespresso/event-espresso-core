			...
			<tbody>
				...
				<tr>
					<th><label for="currency_format">
							...
							do_action('AHEE_help', 'realauth_currency_info'); ?>
						</label></th>
				...
				<tr>
					<th><label for="bypass_payment_page">
							...
							<?php do_action('AHEE_help', 'bypass_confirmation'); ?>
						</label></th>
					<td><?php echo EEH_Form_Fields::select_input('bypass_payment_page', $values, $payment_settings['realauth']['bypass_payment_page']); ?></td>
				</tr>
				<tr>
					<th><label for="auto_settle">
							<?php _e('Auto settle transactions', 'event_espresso'); ?>
							<?php do_action('AHEE_help', 'auto_settle_info'); ?>
						</label></th>
					<td><?php echo EEH_Form_Fields::select_input('auto_settle', $values, $payment_settings['realauth']['auto_settle']); ?></td>
				</tr>
			</tbody>
		</table>
		<?php /* ?><!-- TABLE TEMPLATE -->
