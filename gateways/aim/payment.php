...
function espresso_display_aim($payment_data) {
	...
	<div class="event-display-boxes">
		...
		<form id="aim_payment_form" name="aim_payment_form" method="post" action="<?php echo home_url() . '/?page_id=' . $org_options['return_url'] . '&registration_id=' . $payment_data->registration_id; ?>">
			<div class = "event_espresso_form_wrapper">
				<p>
	        <label for="first_name"><?php _e('First Name', 'event_espresso'); ?></label>
	        <input name="first_name" type="text" id="first_name" value="<?php echo $payment_data->fname ?>" />
				</p>
				<p>
	        <label for="last_name"><?php _e('Last Name', 'event_espresso'); ?></label>
	        <input name="last_name" type="text" id="last_name" value="<?php echo $payment_data->lname ?>" />
				</p>
				<p>
	        <label for="email"><?php _e('Email Address', 'event_espresso'); ?></label>
	        <input name="email" type="text" id="email" value="<?php echo $payment_data->email ?>" />
				</p>
				<p>
	        <label for="address"><?php _e('Address', 'event_espresso'); ?></label>
	        <input name="address" type="text" id="address" value="<?php echo $payment_data->address ?>" />
				</p>
				<p>
	        <label for="city"><?php _e('City', 'event_espresso'); ?></label>
	        <input name="city" type="text" id="city" value="<?php echo $payment_data->city ?>" />
				</p>
				<p>
	        <label for="state"><?php _e('State', 'event_espresso'); ?></label>
	        <input name="state" type="text" id="state" value="<?php echo $payment_data->state ?>" />
				</p>
				<p>
	        <label for="zip"><?php _e('Zip', 'event_espresso'); ?></label>
	        <input name="zip" type="text" id="zip" value="<?php echo $payment_data->zip ?>" />
				</p>
