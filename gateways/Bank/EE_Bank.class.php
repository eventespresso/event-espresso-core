...
Class EE_Bank extends EE_Gateway {
	...
	public function espresso_gateway_process_step_3() {
		...
		$pre_form .= "<body>";
		$form = "<h2 style=\"margin:2em auto; line-height:2em; text-align:center;\">Please wait...<br/>your order is being processed and you will be redirected to the transaction results page, where you can view details of how to complete your bank transfer.</h2>";
