...
<p><?php echo stripslashes_deep(empty($check_payment_settings['check_instructions']) ? '' : $check_payment_settings['check_instructions']) ?></p>
...
<p><strong><?php _e('Payment Address:', 'event_espresso'); ?></strong><br />
    <?php echo stripslashes_deep(empty($check_payment_settings['payment_address']) ? '' : $check_payment_settings['payment_address']); ?></p>