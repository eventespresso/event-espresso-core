			...
			<tr>
				<td valign="top"><ul>
						...
						<li>
							...
							<a href="media-upload.php?post_id=0&amp;type=image&amp;TB_iframe=true&amp;width=640&amp;height=580&amp;rel=button_url" id="add_image" class="thickbox user-add-images" title="Add an Image"><img src="images/media-button-image.gif" alt="Add an Image"></a>
							</li>
							
							<li>
							<label for="image_url">
								<?php _e('Image URL: ', 'event_espresso'); ?><?php apply_filters('espresso_help', 'authnet_image_url_info') ?>
							</label>
							
							<input type="text" name="image_url" size="35" value="<?php echo $authnet_settings['image_url']; ?>" />
							<a href="media-upload.php?post_id=0&amp;type=image&amp;TB_iframe=true&amp;width=640&amp;height=580&amp;rel=image_url" id="add_image" class="thickbox user-add-images" title="Add an Image"><img src="images/media-button-image.gif" alt="Add an Image">
							
							<?php _e(' (used for your business/personal logo on the Authorize.net SIM payment page)', 'event_espresso'); ?></a>
						</li>
					</ul>
				</td>
				<td valign="top">
					<ul>
						<li>
							<label>
								<?php _e('Relay Response URL: ', 'event_espresso'); ?><?php apply_filters('espresso_help', 'relay_response') ?>
							</label>
							<span class="display-path" style="background-color: rgb(255, 251, 204); border:#999 solid 1px; padding:2px;"><?php echo home_url() . '/?page_id=' . $org_options['notify_url']; ?></span> 
						</li>
						
						<li>
							<label for="use_sandbox">
								<?php _e('Use the test mode feature for Autorize.net SIM? ', 'event_espresso'); ?><?php apply_filters('espresso_help', 'authnet_sandbox') ?>
							</label>
