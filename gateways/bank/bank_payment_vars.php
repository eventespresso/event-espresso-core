...
<p><?php echo stripslashes_deep(empty($bank_deposit_settings['bank_instructions']) ? '' : $bank_deposit_settings['bank_instructions']); ?></p>
...
<?php echo stripslashes_deep(empty($bank_deposit_settings['bank_name']) ? '' : $bank_deposit_settings['bank_name']) ?>
<p><strong><?php _e('Address:', 'event_espresso'); ?></strong><br />
    <?php echo stripslashes_deep(empty($bank_deposit_settings['bank_address']) ? '' : $bank_deposit_settings['bank_address']); ?></p>