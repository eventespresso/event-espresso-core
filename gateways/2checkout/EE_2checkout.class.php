...
Class EE_2checkout extends EE_Offsite_Gateway {
	...
	public static function instance(EEM_Gateways &$model) {
		...
		if (self::$_instance === NULL or !is_object(self::$_instance) or ! ( self::$_instance instanceof  EE_2checkout )) {
	...
	protected function _display_settings() {
		...
		<tr>
			<th><label for="currency_format">
					...
					<?php do_action('AHEE_help', '2co_currency_info'); ?>
				</label></th>
		...
		<tr>
			<th>
				<label for="2co_button_url">
					...
					<?php do_action('AHEE_help', '2co_button_image'); ?>
				</label>
			</th>
			<td>
	...
	public function espresso_display_payment_gateways() {
		...
		<div id="reg-page-billing-info-<?php echo $this->_gateway_name; ?>-dv" class="reg-page-billing-info-dv <?php echo $this->_css_class; ?>">
			<?php _e('After finalizing your registration, you will be transferred to the 2CheckOut.com website where your payment will be securely processed.', 'event_espresso'); ?>
		</div>
