...
if (get_option('events_paypal_pro_active') == 'true' || get_option('events_eway_active') == 'true' || get_option('events_authnet_aim_active') == 'true' || get_option('events_firstdata_active') == 'true' || get_option('events_ideal_active') == 'true'){
	echo '<div id="on_site_payment_container" class="payment_container">';
	echo '<hr /><h3 id="on_site_payment" class="payment_option_title">'.__('On-site Payment Processing', 'event_espresso').'</h3>';
...
if (get_option('events_paypal_active') == 'true' || get_option('events_authnet_active') == 'true' || get_option('events_mwarrior_active') == 'true' || get_option('events_alipay_active') == 'true' || get_option('events_plugnpay_active') == 'true' || get_option('events_2checkout_active') == 'true'){
	echo '<div id="off_site_payment_container" class="payment_container">';
	echo '<hr /><h3 id="off_site_payment" class="payment_option_title">'.__('Off-site Payments', 'event_espresso').'</h3>';
...
if (get_option('events_invoice_payment_active') == 'true'||get_option('events_check_payment_active') == 'true' || get_option('events_bank_payment_active') == 'true'){
	...
	echo '<div id="off_line_payment_container" class="payment_container">';
	echo '<hr /><h3 id="off_line_payment" class="payment_option_title">'.__('Off-line Payments', 'event_espresso').'</h3>';
