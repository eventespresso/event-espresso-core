				...
				<td valign="top"><ul>
						...
						<li>
							<label for="currency_format">
								<?php _e('Select the currency for your country: ', 'event_espresso'); ?> <?php do_action('action_hook_espresso_help', 'currency_info') ?>
							</label>
							<br />
						...
						<li>
							<label for="image_url">
								<?php _e('Image URL (logo for payment page): ', 'event_espresso'); ?> <?php do_action('action_hook_espresso_help', 'image_url_info') ?>
							</label>
							<br />
				...
				<td valign="top"><ul>
						<li>
							<label for="bypass_payment_page">
								<?php _e('Bypass Payment Overview Page? ', 'event_espresso'); ?> <?php do_action('action_hook_espresso_help', 'bypass_confirmation') ?>
							</label>
							<?php
							$values = array(
						...
						<li>
							<label for="use_sandbox">
								...
								do_action('action_hook_espresso_help', 'sandbox_info') ?>
							</label>
