				...
				<td valign="top"><ul>
						...
						<li>
							<label for="currency_format">
								<?php _e('Select the currency for your country: ', 'event_espresso'); ?> <?php do_action('AHEE_help', 'currency_info') ?>
							</label>
							<br />
						...
						<li>
							<label for="image_url">
								<?php _e('Image URL (logo for payment page): ', 'event_espresso'); ?> <?php do_action('AHEE_help', 'image_url_info') ?>
							</label>
							<br />
				...
				<td valign="top"><ul>
						<li>
							<label for="bypass_payment_page">
								<?php _e('Bypass Payment Overview Page? ', 'event_espresso'); ?> <?php do_action('AHEE_help', 'bypass_confirmation') ?>
							</label>
							<?php
							$values = array(
									array('id' => false, 'text' => __('No', 'event_espresso')),
									array('id' => true, 'text' => __('Yes', 'event_espresso')));
							echo EEH_Form_Fields::select_input('bypass_payment_page', $values, $payment_settings['mwarrior']['bypass_payment_page']);
							?>
						</li>
						<li>
							<label for="use_sandbox">
								<?php _e('Use the Test Mode for Merchant Warrior? ', 'event_espresso');
								do_action('AHEE_help', 'sandbox_info') ?>
							</label>
