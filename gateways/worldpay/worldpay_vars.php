...
$worldpay_id = empty($worldpay_settings['worldpay_id']) ? '' : $worldpay_settings['worldpay_id'];
$worldpay_cur = empty($worldpay_settings['currency_format']) ? '' : $worldpay_settings['currency_format'];
$no_shipping = isset($worldpay_settings['no_shipping']) ? $worldpay_settings['no_shipping'] : '0';
$use_sandbox = empty($worldpay_settings['use_sandbox']) ? '' : $worldpay_settings['use_sandbox'];
if ($use_sandbox == 1) {
