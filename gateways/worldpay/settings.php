					...
					<ul>
						...
						<li>
							<label for="button_url">
								<?php _e('Button Image URL: ', 'event_espresso'); ?> <?php apply_filters('filter_hook_espresso_help', 'button_image'); ?>
							</label>
						...
						<li>
							<label for="image_url">
								<?php _e('Image URL (logo for payment page):', 'event_espresso'); ?> <?php apply_filters('filter_hook_espresso_help', 'worldpay_image_url_info'); ?>
							</label>
					...
					<ul>
						<li>
							<label for="currency_format">
								<?php _e('Select the currency for your country:', 'event_espresso'); ?> <?php apply_filters('filter_hook_espresso_help', 'worldpay_currency_info'); ?>
							</label>
						...
						<li><label for="bypass_payment_page">
								<?php _e('By-pass the payment confirmation page?', 'event_espresso'); ?> <?php apply_filters('filter_hook_espresso_help', 'worldpay_bypass_confirmation'); ?>
							</label>
							<?php
							$values = array(
						...
						<li>
							<label for="use_sandbox">
								<?php _e('Use the debugging feature and the worldpay Sandbox?', 'event_espresso'); ?> <?php apply_filters('filter_hook_espresso_help', 'worldpay_sandbox_info'); ?>
							</label>
