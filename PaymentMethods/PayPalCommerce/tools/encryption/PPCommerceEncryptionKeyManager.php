...
class PPCommerceEncryptionKeyManager extends EncryptionKeyManager
{
     ...
     */
    const PRODUCTION_ENCRYPTION_KEY_ID = 'eea-pp-commerce-encryption-key-production';

    /**
     * The name of the sandbox encryption key.
     */
    const SANDBOX_ENCRYPTION_KEY_ID = 'ee-pp-commerce-encryption-key-sandbox';

    /**
     * The name of the sandbox encryption keys ID.
     */
    const ENCRYPTION_KEYS_ID = 'eea-pp-commerce-encryption-keys';
