...
class BillingForm extends EE_Billing_Attendee_Info_Form
{
     ...
     * @throws EE_Error
     */
    public function addPaymentButtons(): EE_Form_Section_Proper
    {
        $template_args = [
     ...
     * @throws Exception
     */
    public function localizeParameters(string $client_id): array
    {
     ...
     * @throws EE_Error
     */
    private function throwError(string $error_name)
    {
