...
class OnboardingForm extends EE_Form_Section_Proper
{
     ...
     * @throws EE_Error
     */
    public function onboardSectionContents()
    {
        $subsections = [];
     ...
     * @throws EE_Error
     */
    public function addOnboardButton($subsections, $is_onboard)
    {
     ...
     * @return string
     */
    public function getOnboardSandboxSection()
    {
     ...
     * @return string
     */
    public function getSellerIdSection()
    {
        try {
            $payer_id = PayPalExtraMetaManager::getPmOption($this->pm_instance, Domain::META_KEY_PAYER_ID) !== null ? PayPalExtraMetaManager::getPmOption($this->pm_instance, Domain::META_KEY_PAYER_ID) : '--';
        } catch (Exception $e) {
            $payer_id = '--';
        }
        return ' ' . EEH_HTML::strong(
     ...
     * @return array
     */
    public function addOffboardButton($subsections, $is_onboard)
    {
     ...
     * @return array
     */
    public function addPmSlugHolder($subsections)
    {
     ...
     */
    public function disconnectDialogHtml()
    {
        $message = esc_html__(
