...
class OrderIssues
{
     ...
     */
    public const DECIMALS_NOT_SUPPORTED = 'DECIMALS_NOT_SUPPORTED';
     ...
     * specifications.
     */
    public const INCOMPATIBLE_PARAMETER_VALUE = 'INCOMPATIBLE_PARAMETER_VALUE';
     ...
     */
    public const REFERENCED_CARD_EXPIRED = 'REFERENCED_CARD_EXPIRED';
     ...
     */
    public const TOKEN_ID_NOT_FOUND = 'TOKEN_ID_NOT_FOUND';
