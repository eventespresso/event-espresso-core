...
class CreateOrder extends OrdersApi
{
     ...
     * @return void
     */
    public function sanitizeRequestParameters($billing_info)
    {
    ...
    protected function getParameters()
    {
        ...
        $description = $event->name() !== null ? $event->name() : esc_html__('Tickets for an event', 'event_espresso');
        ...
        $params      = [
            ...
            'payer'               => [
                ...
                'address'       => [
                    ...
                    'admin_area_1'   => isset($state) ? $state : '',
    ...
    protected function getLineItems()
    {
        ...
        foreach ($event_line_items as $line_item) {
            if ($line_item instanceof EE_Line_Item && $line_item->OBJ_type() !== 'Promotion') {
                ...
                $li_description = $line_item->desc() !== null ? $line_item->desc() : esc_html__('Event Ticket', 'event_espresso');
                $line_items [] = [
     ...
     * @return array
     */
    public function validateOrder($response, $parameters)
    {
