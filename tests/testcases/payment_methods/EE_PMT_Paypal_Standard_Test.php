...
//		EEM_Payment_Method::reset();
  ...
  'auth' => 'Abp7Rv87UBZqp18HlystBhVYkr5U-wOEufLDnbUuLIli4sta-Jr-4G1kw4uwGLNlopOjLer38dL3Zp-rBnaT3wg',
		...
		$this->assertFalse( true, 'This should have thrown an exception. Refunds should cause EE to self-combust because we want to totally pretend they dont happen yet' );
		}catch( EE_Error $e ) {
