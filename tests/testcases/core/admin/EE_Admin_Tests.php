...
class EE_Admin_Tests extends EE_UnitTestCase {
	...
	public function test_filter_plugin_actions() {
		...
		$expected = array('<a href="admin.php?page=espresso_general_settings">' . esc_html__( 'Settings', 'event_espresso' ) . '</a>', '<a href="admin.php?page=espresso_events">' . esc_html__( 'Events', 'event_espresso' ) . '</a>', 'link');
