...
namespace EventEspresso\tests\testcases\core\services\orm\tree_traversal;
...
class ModelObjNodeTest extends EE_UnitTestCase
{
    ...
    public function testVisit()
    {
        ...
        // but does NOT have one for the "belongs to" Venue relation
        $this->assertArrayNotHasKey('Venue', $tree['rels']);

        // We should also NOT have relation nodes for HABTM relations...
