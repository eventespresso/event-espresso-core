...
class EE_Messages_Queue_Test extends EE_UnitTestCase
{
    ...
    function test_get_to_send_batch_and_send()
    {
        ...
        $this->assertEquals(
            0,
            $test_queue->count_STS_in_queue(EEM_Message::instance()->stati_indicating_failed_sending())
        );
    ...
    /**
     * This is used to test the execute method when there are messages in the queue that are NOT with a status
    ...
    public function test_send_only_ready_to_send_messages()
    {
        ...
        $this->assertEquals(5, $queue->count_STS_in_queue([EEM_Message::status_incomplete]));
