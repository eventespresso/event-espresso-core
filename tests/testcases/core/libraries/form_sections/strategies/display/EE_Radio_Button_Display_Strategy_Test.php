...
class EE_Radio_Button_Display_Strategy_Test extends EE_UnitTestCase{
	...
	function test_display__normalizing_as_string(){
		...
		$this->assertEquals( '<div id="test-use-captcha-lbl" class="" style="">Use reCAPTCHA</div><label for="test-use-captcha-yesmaam"id="test-use-captcha-yesmaam-lbl"class="ee-radio-label-after micro-lbl"><input id="test-use-captcha-yesmaam"name="test[use_captcha]"class=""style=""type="radio"value="yes ma&#039;am" checked="checked">Yes</label><label for="test-use-captcha-nomaam"id="test-use-captcha-nomaam-lbl"class="ee-radio-label-after micro-lbl"><input id="test-use-captcha-nomaam"name="test[use_captcha]"class=""style=""type="radio"value="no ma&#039;am">No</label>', $form->get_input( 'use_captcha' )->get_html_for_input() );
