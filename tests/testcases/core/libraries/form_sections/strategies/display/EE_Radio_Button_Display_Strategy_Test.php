...
class EE_Radio_Button_Display_Strategy_Test extends EE_UnitTestCase{
	...
	function test_display__normalizing_as_int(){
		...
		$this->assertEquals('<div id="test-use-captcha-lbl" class="" style="">Use reCAPTCHA</div><label for="test-use-captcha-1" id="test-use-captcha-1-lbl" class="ee-radio-label-after micro-lbl">
...
</label>', $form->get_input( 'use_captcha' )->get_html_for_input() );
...
<label for="test-use-captcha-0" id="test-use-captcha-0-lbl" class="ee-radio-label-after micro-lbl">
	...
	function test_display__normalizing_as_string(){
		...
		$this->assertEquals( '<div id="test-use-captcha-lbl" class="" style="">Use reCAPTCHA</div><label for="test-use-captcha-yesmaam"id="test-use-captcha-yesmaam-lbl"class="ee-radio-label-after micro-lbl">
