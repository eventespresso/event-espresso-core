...
class EE_Register_Capabilities_Test extends EE_UnitTestCase {
	...
	private function _pretend_capabilities_registered( $non_numeric = true ) {
		...
		$this->assertContains( array( 'ee_read_ee', 'ee_read_events' ), $role->capabilities, 'Looks like registering capabilities is overwriting default capabilites, that will cause problems' );
