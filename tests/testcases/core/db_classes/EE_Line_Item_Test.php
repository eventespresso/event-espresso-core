...
class EE_Line_Item_Test extends EE_UnitTestCase
{
    ...
    function test_get_nearest_descendant_of_type()
    {
        ...
        $old_tax_subtotal = EEH_Line_Item::get_nearest_descendant_of_type($line_item,
    ...
    function test_recalculate_pre_tax_total__rounding_issues()
    {
        ...
        /** @var EE_Price $percent_surcharge */
        ...
        $surcharge = $base_price->amount() * $percent_surcharge->amount() / 100;
        /** @var EE_Ticket $ticket */
        $ticket = $this->new_model_obj_with_dependencies(
            'Ticket',
            [
                'TKT_price'   => $base_price->amount() + $surcharge,
                'TKT_taxable' => false,
            ]);
        ...
        $quantity = 2;
        $total_line_item = EEH_Line_Item::add_ticket_purchase(
    ...
    function test_recalculate_pre_tax_total__dont_save_if_ignoring_nontaxables()
    {
        ...
        $proper_line_items = EEM_Line_Item::instance()->get_all_of_type_for_transaction(EEM_Line_Item::type_line_item,
            $txn->ID());
