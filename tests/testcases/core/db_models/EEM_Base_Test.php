...
//	}
    ...
    public function test_get_formats_for_with_valid_field()
    {
        ...
        $this->assertStringContainsString('F j, Y', $formats);
        $this->assertStringContainsString('g:i a', $formats);
        ...
        $this->assertStringContainsString('Y-m-d', $test_formats);
        $this->assertStringContainsString('H:i:s', $test_formats);
    }
