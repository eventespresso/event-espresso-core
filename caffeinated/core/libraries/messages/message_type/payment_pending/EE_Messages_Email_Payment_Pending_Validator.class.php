...
/**
 * EE_Messages_Email_Payment_Pending_Validator class
 *
 * Holds any special validation rules for template fields with Email messenger and Payment Pending message type.
 *
 ...
 * ------------------------------------------------------------------------
 */
class EE_Messages_Email_Payment_Pending_Validator extends EE_Messages_Validator {


	public function __construct( $fields, $context ) {
		$this->_m_name = 'email';
		$this->_mt_name = 'payment_pending';
...
} //end class EE_Messages_Email_Payment_Pending_Validator
