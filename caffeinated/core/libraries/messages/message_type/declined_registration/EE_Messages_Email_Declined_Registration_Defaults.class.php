...
class EE_messages_Email_Declined_Registration_Defaults extends EE_Message_Template_Defaults {
	...
	protected function _change_templates() {
		...
		$this->_templates['admin']['content']['main'] = file_get_contents( EE_CAF_LIBRARIES . 'messages/message_type/declined_registration/templates/admin/declined-registration-message-type-admin-main-content.template.php', TRUE );
		...
		$this->_templates['attendee']['content']['event_list'] = file_get_contents( EE_CAF_LIBRARIES . 'messages/message_type/declined_registration/templates/declined-registration-message-type-event-list.template.php', TRUE );
