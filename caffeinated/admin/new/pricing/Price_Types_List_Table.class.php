...
class Price_Types_List_Table extends EE_Admin_List_Table
{
     ...
     * @since $VID:$
     */
    protected function getActionUrl($price_type, $action)
    {
     ...
     * @throws ReflectionException
     */
    public function column_name($price_type, $prep_content = true)
    {
     ...
     * @return string
     */
    public function column_base_type($price_type)
    {
     ...
     * @return string
     */
    public function column_percent($price_type)
    {
     ...
     * @return string
     */
    public function column_order($price_type)
    {
