	...
	var tktHelper = {
		...
		* @param {bool}			getitm return the jquery itm object? (if false then we return the tktHelper object)
		...
		getTotalPrice: function( dotaxes ) {
			...
			totals.subtotal = accounting.formatNumber( accounting.toFixed( runningtotal, 8 ), 8 );
			...
			totals.finalTotal = accounting.formatNumber( accounting.toFixed( runningtotal, 8 ), 8 );
