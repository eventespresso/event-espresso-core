...
class Prices_List_Table extends EE_Admin_List_Table
{
     ...
     * @since $VID:$
     */
    protected function getActionUrl($price, $action)
    {
     ...
     * @throws ReflectionException
     */
    public function column_name($price, $prep_content = true)
    {
     ...
     * @return string
     */
    public function column_type($price)
    {
     ...
     * @return string
     */
    public function column_description($price)
    {
     ...
     * @return string
     */
    public function column_amount($price)
    {
