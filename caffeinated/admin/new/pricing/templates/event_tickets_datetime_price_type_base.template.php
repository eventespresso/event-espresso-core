<input type="hidden" name="edit_prices[<?php echo $tkt_row; ?>][<?php echo $PRC_order; ?>][PRT_ID]"
       class="edit-price-PRT_ID" value="<?php echo $PRT_ID; ?>">
<span class="price-type-text"><?php echo $PRT_name; ?></span>
<input type="hidden" name="ee_price_selected_operator[<?php echo $tkt_row; ?>][<?php echo $PRC_order; ?>]"
