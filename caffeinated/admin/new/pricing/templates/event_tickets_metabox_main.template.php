...
<div id="event-and-ticket-form-content">
    ...
    <div class="event-datetimes-container">
        ...
        <input type="hidden"
               ...
               value="<?php echo esc_attr($total_dtt_rows); ?>"
        >
        <table id="datetime-editing-dtts-table" class="datetime-edit-table">
            <thead>
            <tr valign="top">
                <td>
                    <span class="DTT_name_label"><?php esc_html_e('Name', 'event_espresso'); ?></span>
                </td>
                <td>
                    <span class="DTT_EVT_start_label"><?php esc_html_e('Event Start', 'event_espresso'); ?></span>
                </td>
                <td>
                    <span class="DTT_EVT_end_label"><?php esc_html_e('Event End', 'event_espresso'); ?></span>
                </td>
                <td>
                    <span class="DTT_reg_limit_label"><?php esc_html_e('Limit', 'event_espresso'); ?></span>
                </td>
                <td>
                    <span class="DTT_sold_label"><?php esc_html_e('Sold', 'event_espresso'); ?></span>
                </td>
                <?php if (apply_filters('FHEE__event_tickets_metabox__dtt_reserved', true)) : ?>
                    <td>
                        <span class="DTT_reserved_label"><?php esc_html_e('Rsrvd', 'event_espresso'); ?></span>
                    </td>
                <?php endif; ?>
                <td></td>
            </tr>
            ...
            <table id="add-new-event-datetime-table" class="datetime-edit-table">
                <tr>
                    <td class="event-datetime-column date-name-column">
                        <label class="add-new-event-datetime-DTT_name_label" for="add-new-event-datetime-DTT_name">
                    ...
                    <td class="event-datetime-column date-column">
                        <label class="add-new-event-datetime-DTT_EVT_start_label" for="add-new-event-datetime-DTT_EVT_start">
                            <?php esc_html_e('Event Start', 'event_espresso'); ?>
                        </label>
                    ...
                    <td class="event-datetime-column date-column">
                        <label class="add-new-event-datetime-DTT_EVT_end_label"
                               for="add-new-event-datetime-DTT_EVT_end">
                            <?php esc_html_e('Event End', 'event_espresso'); ?>
                        </label>
                    ...
                    <td class="event-datetime-column reg-limit-column">
                        <label class="add-new-event-datetime-DTT_EVT_end_label"
                               for="add-new-event-datetime-DTT_reg_limit">
                            <?php esc_html_e('Limit', 'event_espresso'); ?>
                        </label>
        ...
        <div class="event-tickets-container"<?php echo $show_tickets_container; ?>>
            <table class="ticket-table">
                <thead>
                    <tr valign="top">
                        <td colspan="2">
                            <span class="TKT_name_label"><?php esc_html_e('Ticket', 'event_espresso'); ?></span>
                        </td>
                        <td>
                            <span class="TKT_goes_on_sale_label">
                                <?php esc_html_e('Sale Starts', 'event_espresso'); ?>
                            </span>
                        </td>
                        <td>
                            <span class="TKT_sell_until_label"><?php esc_html_e('Sell Until', 'event_espresso'); ?></span>
                        </td>
                        <td>
                            <span class="TKT_price_label"><?php esc_html_e('Price', 'event_espresso'); ?></span>
                        </td>
                        <td>
                            <span class="TKT_qty_label"><?php esc_html_e('Qty', 'event_espresso'); ?></span>
                        </td>
                        <td>
                            <span class="TKT_sold_label"><?php esc_html_e('Sold', 'event_espresso'); ?></span>
                        </td>
            ...
            <input type="hidden" name="ticket_total_rows" id="ticket-total-rows" value="<?php echo esc_attr($total_ticket_rows); ?>">
