<section id="edit-event-datetime-tickets-<?php echo $dtt_row; ?>" class="datetime-tickets-edit"<?php echo $show_tickets_row; ?>>
	...
	<div class="add-datetime-ticket-container">
		...
		<table class="add-new-ticket-table">
			<thead>
				<tr valign="top">
					<td><label class="ANT_TKT_name_label"><?php _e('Ticket Name', 'event_espresso'); ?></label></td>
					<td><label class="ANT_TKT_goes_on_sale_label"><?php _e('Goes On Sale', 'event_espresso'); ?></label></td>
					<td><label class="ANT_TKT_sell_until_label"><?php _e('Sell Until', 'event_espresso'); ?></label></td>
					<td><label class="ANT_TKT_price_label"><?php _e('Price', 'event_espresso'); ?></label></td>
					<td><label class="ANT_TKT_qty_label"><?php _e('Qty', 'event_espresso'); ?></label></td>
					<td></td>
				</tr>
			</thead>
			<tbody>
