...
<div class="padding">
    <h3><?php esc_html_e('Price Type Details', 'event_espresso'); ?></h3>
    <table class="form-table">
        <tbody>
            ...
            <tr>
                <th>
                    <label>
                        <?php esc_html_e('Percentage or Fixed Amount?', 'event_espresso'); ?>
                    </label>
                </th>
                <td>
            ...
            <tr>
                <th>
                    <label for="PRT_order">
                        <?php esc_html_e('Order of Application ', 'event_espresso'); ?>
                    </label>
                </th>
                <td>
                    ...
                    />
                    <p class="description">
                        <?php esc_html_e('The order that Price Types are applied.', 'event_espresso'); ?>
                    </p>
                    <p class="description">
                        <?php
                        printf(
