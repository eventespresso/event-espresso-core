...
if (WP_DEBUG) {
    ...
    <td>
        <input maxlength="245"
               type="text"
               name="<?php echo $edit_tickets_name; ?>[<?php echo $tkt_row; ?>][TKT_name]"
    ...
    <td>
        <?php if ($disabled) : ?>
            <input type="hidden"
                   id="edit-ticket-TKT_start_date-<?php echo $tkt_row; ?>"
        ...
        <?php else : ?>
            <input id="edit-ticket-TKT_start_date-<?php echo $tkt_row; ?>"
                   ...
                   data-date-field-context="#display-ticketrow-<?php echo $tkt_row; ?>"
    ...
    <td>
        <?php if ($disabled) : ?>
            <input type="hidden"
                   id="edit-ticket-TKT_end_date-<?php echo $tkt_row; ?>"
            ...
            >
            <input type="text"
                   name="archived_ticket[TKT_end_date]"
                   class="edit-ticket-TKT_end_date ee-text-inp"
                   value="<?php echo $TKT_end_date; ?>"
                   disabled
            >
    ...
    <td>
        <?php if ($disabled) : ?>
            ...
            >
            <input type="text"
                   name="archived_ticket[<?php echo $tkt_row; ?>][TKT_base_price]"
                   class="edit-ticket-TKT_base_price ee-small-text-inp edit-price-PRC_amount ee-numeric"
                   value="<?php echo $TKT_base_price; ?>"
                   disabled
            >
        ...
        <?php endif; ?>
        <input type="hidden"
               id="edit-ticket-TKT_base_price_ID-<?php echo $tkt_row; ?>"
               name="<?php echo $edit_tickets_name; ?>[<?php echo $tkt_row; ?>][TKT_base_price_ID]"
               value="<?php echo $TKT_base_price_ID; ?>"
        >
    </td>
    <td>
        <?php if ($disabled) : ?>
            ...
            <input type="text"
                   class="edit-ticket-TKT_qty ee-small-text-inp ee-numeric"
                   name="archived_ticket[<?php echo $tkt_row; ?>][TKT_qty]"
                   value="<?php echo $TKT_qty_for_input; ?>"
                   disabled
            >
        <?php else : ?>
            <input type="text"
                   id="edit-ticket-TKT_qty-<?php echo $tkt_row; ?>"
                   class="edit-ticket-TKT_qty ee-small-text-inp ee-numeric"
                   name="<?php echo $edit_tickets_name; ?>[<?php echo $tkt_row; ?>][TKT_qty]"
                   value="<?php echo $TKT_qty_for_input; ?>"
            >
    ...
    <td>
        <div class="ee-editing-container <?php echo $edit_tkt_expanded; ?>">
            <span
                class="gear-icon dashicons dashicons-admin-generic clickable"
                data-ticket-row="<?php echo $tkt_row; ?>"
                data-context="ticket"
            >
            </span>
        </div>
        <span class="<?php echo $clone_icon; ?>"
              data-ticket-row="<?php echo $tkt_row; ?>"
              data-context="ticket"
        >
        </span>
        <span class="<?php echo $trash_icon; ?>"
              data-ticket-row="<?php echo $tkt_row; ?>"
...
<tr id="edit-ticketrow-<?php echo $tkt_row; ?>" class="edit-ticket-row">
    ...
    <td colspan="9">
    <?php } ?>
        <fieldset id="fieldset-edit-ticketrow-<?php echo $tkt_row; ?>"
                  class="ticket-fieldset"<?php echo $display_edit_tkt_row; ?>
        >
            <legend></legend>
            <input type="hidden"
                   name="<?php echo $edit_tickets_name; ?>[<?php echo $tkt_row; ?>][TKT_ID]"
                   class="edit-ticket-TKT_ID"
                   value="<?php echo $TKT_ID; ?>"
            >
            <input type="hidden"
                   name="<?php echo $edit_tickets_name; ?>[<?php echo $tkt_row; ?>][TKT_row]"
                   class="edit-ticket-TKT_row"
                   value="<?php echo $tkt_row; ?>"
            >
            ...
            <div class="basic-ticket-container">
                ...
                <button data-context="price-create"
                        class="button-secondary ee-create-button ee-price-create-button"
                        data-ticket-row="<?php echo $tkt_row; ?>"
                ...
                <div class="ticket-is-required-container">
                    <input type="checkbox"
                        ...
                        ?>
                    />
                    <label for="edit-ticket-TKT_required">
                        <?php esc_html_e(
                ...
                <div class="ticket-is-taxable-container">
                    ...
                    if (! empty($tax_rows)) {
                        ...
                        <input class="TKT-taxable-checkbox" id="edit-ticket-TKT_taxable-<?php echo $tkt_row; ?>"
                               type="checkbox"
                               name="archived_ticket[<?php echo $tkt_row; ?>][TKT_taxable]"
                ...
                <table class="price-table">
                    ...
                    <tr class="price-subtotal-row TKT-taxes-display"<?php echo $display_subtotal; ?>>
                        ...
                        <td class="ee-numeric">
                            ...
                            <input type="hidden"
                                   value="<?php echo $TKT_subtotal_amount; ?>"
                                   name="subtotal_amount_<?php echo $tkt_row; ?>"
                    ...
                    <tr class="price-total-row">
                        ...
                        <td class="ee-numeric">
                            <span id="price-total-amount-<?php echo $tkt_row; ?>">
                                <?php echo $TKT_price; ?>
                            </span>
                            <input type="hidden"
                                   name="<?php echo $edit_tickets_name; ?>[<?php echo $tkt_row; ?>][TKT_price]"
                                   class="edit-ticket-TKT_price"
                                   value="<?php echo $TKT_price_amount; ?>"
                            >
                        </td>
                        <td><?php echo $TKT_price_code; ?></td>
                        <td>
                            <input type="hidden"
                                   name="price_total_rows_ticket[<?php echo $tkt_row; ?>]"
                                   id="price-total-rows-<?php echo $tkt_row; ?>"
                                   value="<?php echo $total_price_rows; ?>"
                            >
                        </td>
                    </tr>
                    </tfoot>
            ...
            <div class="ee-editor-footer-container">
                ...
                <div class="save-cancel-button-container">
                    <label for="edit-ticket-TKT_is_default_selector">
                        <?php esc_html_e(
                     ...
                     */?>
                    <button class="button-secondary ee-cancel-button"
                            data-context="ticket"
                            data-ticket-row="<?php echo $tkt_row; ?>"
                    >
            ...
            <input type="hidden"
                   name="starting_ticket_datetime_rows[<?php echo $tkt_row; ?>]"
                   id="starting-ticket-datetime-rows-<?php echo $tkt_row; ?>"
                   value="<?php echo $starting_ticket_datetime_rows; ?>"
                   class="starting-ticket-datetime-rows"
            >
            <input type="hidden"
                   name="ticket_datetime_rows[<?php echo $tkt_row; ?>]"
                   class="ticket-datetime-rows"
                   id="ticket-datetime-rows-<?php echo $tkt_row; ?>"
                   value="<?php echo $ticket_datetime_rows; ?>"
            >

            <!-- these hidden inputs are for tracking changes in prices attached to tickets during a js session -->
            <input type="hidden"
                   name="ticket_price_ids[<?php echo $tkt_row; ?>][]"
                   id="ticket-price-ids-<?php echo $tkt_row; ?>"
                   class="ticket-price-ids"
                   value="<?php echo $existing_ticket_price_ids; ?>"
            >
            <input type="hidden"
                   name="<?php echo $edit_tickets_name; ?>[<?php echo $tkt_row; ?>][TTM_ID]"
                   class="ticket-template-id"
                   value="<?php echo $ticket_template_id; ?>"
            >
            <div style="clear:both"></div>
        </fieldset>
    </td>
