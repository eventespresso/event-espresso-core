...
if (WP_DEBUG) {
    ...
    <input type="hidden" name="<?php echo esc_attr($edit_tickets_name); ?>[<?php echo esc_attr($tkt_row); ?>][TKT_order]" class="edit-ticket-TKT_order" value ="<?php echo esc_attr($TKT_order); ?>" ></span></td>-->
    ...
    <td>
        ...
        <span class="<?php echo sanitize_html_class($clone_icon); ?>" data-ticket-row="<?php echo esc_attr($tkt_row); ?>" data-context="ticket"></span><span
            class="<?php echo sanitize_html_class($trash_icon); ?>" data-ticket-row="<?php echo esc_attr($tkt_row); ?>"
