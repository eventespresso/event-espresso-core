<section id="edit-event-datetime-<?php echo $dtt_row; ?>" class="datetime-edit">
	...
	<table id="edit-event-datetime-table-<?php echo $dtt_row; ?>" class="datetime-edit-table">
		<tr>
			...
			<td>
				<span data-datetime-row="<?php echo $dtt_row; ?>"  data-context="datetime" class="ticket-icon clickable"></span><span  data-context="datetime" data-datetime-row="<?php echo $dtt_row; ?>" class="<?php echo $clone_icon; ?>"></span><span  data-context="datetime" data-datetime-row="<?php echo $dtt_row; ?>" class="<?php echo $trash_icon; ?>"<?php echo $show_trash; ?>></span>
			</td>
			<td>
				<span  data-context="datetime" data-datetime-row="<?php echo $dtt_row; ?>" class="datetime-tickets-sold"><?php printf( __('Tickets Sold: %s', 'event_espresso'), $dtt_sold ); ?></span>
			</td>
		</tr>
	</table>
