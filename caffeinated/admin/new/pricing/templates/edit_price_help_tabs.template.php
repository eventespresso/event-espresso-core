<?php
function type_field_info_help_tab_html() {
?>
	<h2>
...
function name_field_info_help_tab_html() {
?>
	<h2>
...
function description_field_info_help_tab_html() {
?>
	<h2>
...
function amount_field_info_help_tab_html() {
?>
	<h2>
