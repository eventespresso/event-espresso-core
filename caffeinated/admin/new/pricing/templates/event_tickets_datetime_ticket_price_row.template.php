...
<tr id="extra-price-row-<?php echo $tkt_row; ?>-<?php echo $prc_row; ?>">
	<td colspan="5">
		<section class="extra-price-row" style="display:none">
			<textarea name="edit_prices[<?php echo $tkt_row; ?>][<?php echo $prc_row; ?>][PRT_description]" class="edit-price-PRC_description ee-full-textarea-inp" placeholder="Edit the description for the price here"><?php echo $PRC_description; ?></textarea>
		</section>
	</td>
</tr>
<?php
