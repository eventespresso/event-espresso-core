...
<tr id="price-row-<?php echo absint($tkt_row); ?>-<?php echo absint($PRC_order); ?>" class="ee-active-price" valign="top">
    <td>
    ...
    <td>
        ...
        <input type="text" class="edit-price-PRC_name ee-text-inp"
               name="<?php echo esc_attr($edit_prices_name); ?>[<?php echo absint($tkt_row); ?>][<?php echo absint($PRC_order); ?>][PRC_name]"
               value="<?php echo esc_attr($PRC_name); ?>">
    </td>
    <td>
        <textarea name="<?php echo esc_attr($edit_prices_name); ?>[<?php echo absint($tkt_row); ?>][<?php echo absint($PRC_order); ?>][PRC_desc]"
...
<!-- <tr id="extra-price-row-<?php echo absint($tkt_row); ?>-<?php echo absint($PRC_order); ?>"> -->
<!-- <td colspan="5"> -->
<!-- <section class="extra-price-row" style="display:none"> -->
<!-- <textarea name="<?php echo esc_attr($edit_prices_name); ?>[<?php echo absint($tkt_row); ?>][<?php echo absint($PRC_order); ?>][PRC_desc]" class="edit-price-PRC_desc ee-full-textarea-inp" placeholder="Edit the description for the price here"><?php echo esc_textarea($PRC_desc); ?></textarea> -->
<!-- </section> -->
<!-- </td> -->
<!-- </tr> -->
