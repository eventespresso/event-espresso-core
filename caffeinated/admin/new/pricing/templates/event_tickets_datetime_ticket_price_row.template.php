...
<tr id="price-row-<?php echo $tkt_row; ?>-<?php echo $PRC_order; ?>" class="ee-active-price" valign="top">
    ...
    <td>
        ...
        echo $show_plus_or_minus; ?>>+/-</span>
        <span class="ticket-price-info-display ticket-price-plus"<?php
        echo $show_plus; ?>>+</span>
        <span class="ticket-price-info-display ticket-price-minus"<?php
...
echo $edit_prices_name; ?>[<?php
echo $tkt_row; ?>][<?php
echo $PRC_order; ?>][PRC_desc]" class="edit-price-PRC_desc ee-full-textarea-inp" placeholder="Edit the description for the price here"><?php
echo $PRC_desc; ?></textarea> -->
<!-- </section> -->
<!-- </td> -->
<!-- </tr> -->
