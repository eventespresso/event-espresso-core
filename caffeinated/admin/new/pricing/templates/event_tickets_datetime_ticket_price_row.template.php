...
<tr id="price-row-<?php echo esc_attr($tkt_row); ?>-<?php echo esc_attr($PRC_order); ?>" class="ee-active-price" valign="top">
    ...
    <td>
        ...
        <?php else : ?>
            <!-- <span class="gear-icon dashicons dashicons-admin-generic clickable" data-ticket-row="<?php echo esc_attr($tkt_row); ?>" data-context="price" data-price-row="<?php echo esc_attr($PRC_order); ?>"></span> -->
            <span class="trash-icon dashicons dashicons-post-trash clickable" data-ticket-row="<?php echo esc_attr($tkt_row); ?>"
                  data-context="price" data-price-row="<?php echo esc_attr($PRC_order); ?>"<?php echo $show_trash_icon; ?>></span>
...
<!-- <tr id="extra-price-row-<?php echo esc_attr($tkt_row); ?>-<?php echo esc_attr($PRC_order); ?>"> -->
<!-- <td colspan="5"> -->
<!-- <section class="extra-price-row" style="display:none"> -->
<!-- <textarea name="<?php echo esc_attr($edit_prices_name); ?>[<?php echo esc_attr($tkt_row); ?>][<?php echo esc_attr($PRC_order); ?>][PRC_desc]" class="edit-price-PRC_desc ee-full-textarea-inp" placeholder="Edit the description for the price here"><?php echo esc_textarea($PRC_desc); ?></textarea> -->
<!-- </section> -->
<!-- </td> -->
<!-- </tr> -->
