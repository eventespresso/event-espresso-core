...
<p>
<?php esc_html_e('This page allows you to edit a default price for Event Espresso.', 'event_espresso'); ?>
</p>
<ul>
<li>
<strong><?php esc_html_e('Type', 'event_espresso'); ?></strong><br />
<?php esc_html_e('This is the type of pricing. Available options are Percent Discount, Fixed Discount, Percent Surcharge, Fixed Surcharge, Regional Tax, and Federal Tax.', 'event_espresso'); ?>
</li>
<li>
...
<?php esc_html_e('Want to see a tour of this screen? Click on the Edit Default Price Tour button which appears on the right side of the page. To learn more about the options on this page, take a look at the different tabs that appear on the left side of the page.', 'event_espresso'); ?>
</p>
<p>
