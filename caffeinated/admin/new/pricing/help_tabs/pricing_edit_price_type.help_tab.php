<p><strong><?php _e('Edit Price Type', 'event_espresso'); ?></strong></p>
<p>
<?php _e('This page allows you to edit a price type for Event Espresso.', 'event_espresso'); ?>
</p>
<ul>
<li>
<strong><?php _e('Basic Type', 'event_espresso'); ?></strong><br />
<?php _e('This is the kind of base type. Available options are Discount, Surcharge, and Tax.', 'event_espresso'); ?>
</li>
<li>
<strong><?php _e('Price Type Name', 'event_espresso'); ?></strong><br />
