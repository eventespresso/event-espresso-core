...
class espresso_events_Pricing_Hooks extends EE_Admin_Hooks
{
    ...
    protected function _set_date_time_formats()
    {
        ...
        // validate
        $this->_date_format_strings['date'] = isset($this->_date_format_strings['date']) ? $this->_date_format_strings['date'] : '';
        $this->_date_format_strings['time'] = isset($this->_date_format_strings['time']) ? $this->_date_format_strings['time'] : '';
    ...
    protected function _update_tickets($event, $saved_datetimes, $data)
    {
        ...
        foreach ($data['edit_tickets'] as $row => $ticket_data) {
            ...
            $ticket_price  = $ticket_price === 0 && $base_price !== 0
                ? $base_price
                : $ticket_price;
            $base_price_id = isset($ticket_data['TKT_base_price_ID']) ? $ticket_data['TKT_base_price_ID'] : 0;
            ...
            $TKT_values = [
                ...
                'TKT_row'         => $row,
                'TKT_order'       => isset($ticket_data['TKT_order']) ? $ticket_data['TKT_order'] : 0,
     ...
     * @throws ReflectionException
     */
    protected function _get_tax_added($tax, $ticket)
    {
     ...
     * @throws EE_Error
     */
    protected function _get_ticket_js_structure($all_datetimes = [], $all_tickets = [])
    {
        $template_args = [
