    ...
    public function column_TKT_name(EE_Ticket $item)
    {
        ...
        if ($item->ID() !== 1) {
            if ($this->_view == 'all') {
                ...
                $actions['trash'] = '
                <a href="' . $trash_lnk_url . '" title="' . esc_attr__('Move Ticket to trash', 'event_espresso') . '">
                ...
                $actions['restore'] = '
                <a href="' . $restore_lnk_url . '" title="' . esc_attr__('Restore Ticket', 'event_espresso') . '">
                ...
                $actions['delete'] = '
                <a href="' . $delete_lnk_url . '" title="' . esc_attr__('Delete Ticket Permanently', 'event_espresso') . '">
