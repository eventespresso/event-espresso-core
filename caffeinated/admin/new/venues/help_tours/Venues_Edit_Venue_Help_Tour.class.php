...
class Venues_Edit_Venue_Help_Tour extends EE_Help_Tour {
	...
	protected function _start() {
		...
		$content .= '<p>' . __('This tour of the edit venue page will provide an overview of the different areas of the screen to help you understand what they are used for.', 'event_espresso') . '</p>';
		return $content;
	}
