 ...
 * ------------------------------------------------------------------------
 */
class Venues_Edit_Venue_Help_Tour extends EE_Help_Tour {

	protected function _set_tour_properties() {
		$this->_label = __('Edit Venue Tour', 'event_espresso');
	...
	protected function _stop_one() {
		...
		$content .= '<p>' . __('This brief tour of the edit venue page will provide an overview of the different areas of the screen to help you understand what they are used for.', 'event_espresso') . '</p>';
		return $content;
	}

	protected function _venue_title_stop() {
		return '<p>Edit the title for your venue in this field.</p>';
	}
