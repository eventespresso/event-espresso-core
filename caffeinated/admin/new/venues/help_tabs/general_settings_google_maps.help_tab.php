...
<li>
<strong><?php _e('Set Map Height', 'event_espresso'); ?></strong><br />
...
<li>
<strong><?php _e('Set Map Zoom', 'event_espresso'); ?></strong><br />
...
<li>
<strong><?php _e('Set Map Navigation Overlay', 'event_espresso'); ?></strong><br />
<?php _e('The navigation overlay are the controls for panning and zooming the map.', 'event_espresso'); ?>
</li>
<li>
<strong><?php _e('Keep Map Navigation Small', 'event_espresso'); ?></strong><br />
...
<li>
<strong><?php _e('Set Map Type Control', 'event_espresso'); ?></strong><br />
...
<li>
<strong><?php _e('Set Map Alignment', 'event_espresso'); ?></strong><br />
...
<?php _e('Want to see a tour of this screen? Click on the Google Maps Tour button which appears on the right side of the page. <br />To learn more about the options on this page, take a look at the different tabs that appear on the left side of the page.', 'event_espresso'); ?>
</p>
<p>
