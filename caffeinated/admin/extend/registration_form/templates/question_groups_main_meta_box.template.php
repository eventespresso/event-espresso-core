                ...
                <tr>
                    ...
                    <td>
                        <input class='regular-text'
                               id="QSG_name" name="QSG_name"
                               type="text"
                               value="<?php $question_group->f('QSG_name') ?>"
                        >
                ...
                <tr>
                    ...
                    <td>
                        <input class='regular-text'
                            <?php echo $disabled; ?>
                               id="QSG_identifier"
                               name="QSG_identifier<?php echo $id; ?>"
                               type="text"
                               value="<?php $question_group->f('QSG_identifier') ?>"
                        >
                    ...
                    foreach ($all_questions as $question_ID => $question) {
                        ...
                        <li class="ee-question-sortable">
                            <label for="question-<?php echo $question_ID ?>">
                                <input id="question-<?php echo $question_ID; ?>"
                                       name="questions[<?php echo $question_ID; ?>]"
                                       type="checkbox"
