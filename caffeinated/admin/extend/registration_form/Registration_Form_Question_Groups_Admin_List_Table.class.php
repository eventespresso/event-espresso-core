...
class Registration_Form_Question_Groups_Admin_List_Table extends EE_Admin_List_Table
{
     ...
     * @return string
     */
    public function column_name($question_group, $prep_content = true)
    {
        $actions = array();
     ...
     * @since $VID:$
     */
    protected function getActionUrl($question_group, $action)
    {
     ...
     * @return string
     */
    public function column_identifier($question_group)
    {
     ...
     * @return string
     */
    public function column_description($question_group)
    {
     ...
     * @return string
     */
    public function column_show_group_name($question_group)
    {
     ...
     * @return string
     */
    public function column_show_group_desc($question_group)
    {
