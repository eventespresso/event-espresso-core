...
<div class="changelog">
	...
	<h3>New Features</h3>
		...
		Introduced a few new question types, such as "US phone", "integer", "decimal", "url" and "year" which allow site admins to have validated answers to these types of questions.</p>
	...
	<h3>Major Add-on Updates</h3>
		<p><strong>WP User Integration Enhancements</strong>
			<br>In version 2.0.1 of the WP User Integration add-on, we added the [ESPRESSO_MY_EVENTS] shortcode to display list of registrations for user on a front end WordPress page.</p>
			<p align="right"><a href="http://eventespresso.com/2015/09/your-registrations-page-now-available-in-the-event-espresso-4-wp-user-integration-add-on/?ee_ver=ee4&utm_source=ee4_plugin_admin&utm_medium=link&utm_campaign=event_espresso_about_page&utm_content=your_registrations_link&ap_id=EEspresso">Read More</a></p>
	<hr>