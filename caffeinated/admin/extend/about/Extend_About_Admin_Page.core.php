...
class Extend_About_Admin_Page extends About_Admin_Page {
	...
	protected function _whats_new() {
		...
		$this->_template_args['admin_page_subtitle'] = sprintf( __('Thank you for choosing Event Espresso, the most powerful plugin for Event Management.%s', 'event_espresso'), $settings_message );
