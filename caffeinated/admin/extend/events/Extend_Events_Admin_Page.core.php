...
class Extend_Events_Admin_Page extends Events_Admin_Page {
	...
	protected function _extend_page_config() {
		...
		$this->_page_config['add_event']['metaboxes'][] = '_register_caf_metaboxes';
		$this->_page_config['edit_event']['metaboxes'][] = '_register_caf_metaboxes';
	}
	...
	/**
	 * This registers metaboxes used in caffeinated event details editor
	 * @return void
	 */
	protected function _register_caf_metaboxes() {
