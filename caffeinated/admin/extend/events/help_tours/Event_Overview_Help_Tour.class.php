 ...
 *
 * This is the help tour object for the caffeinated Event Overview list table
 *
 *
 * @package		Event_Overview_Help_Tour
 * @subpackage	caffeinated/admin/extend/events/Event_Overview_Help_Tour.core.php
...
class Event_Overview_Help_Tour extends EE_Help_Tour {
	...
	protected function _set_tour_properties() {
		...
		$this->_slug = 'event-overview-caf-joyride';
	}
