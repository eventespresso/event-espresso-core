...
class EE_Event_Registrations_List_Table extends EE_Admin_List_Table
{
     ...
     * @throws ReflectionException
     */
    public function column__REG_att_checked_in($registration)
    {
     ...
     * @throws ReflectionException
     */
    public function column_ATT_name($registration)
    {
     ...
     * @throws ReflectionException
     */
    public function column_Event($registration)
    {
        try {
     ...
     * @throws ReflectionException
     */
    public function column_PRC_name($registration)
    {
