...
function espresso_default_prices_activation_sql( $SQL ) {
	$SQL = "INSERT INTO " . ESP_PRICE_TABLE . "
				...
				(1, 1, '10.00', 'General Admission', 'Regular price for all Events. Example content - delete if you want to', 1, 1, NULL, 0, 0, 1, 0),
				...
				(5, 6, '7.00', 'Local Sales Tax', 'Locally imposed tax. Example content - delete if you want to', 1, 1, NULL, 40, 0, 5, 0),
				(6, 7, '15.00', 'Sales Tax', 'Federally imposed tax. Example content - delete if you want to', 1, 1, NULL, 50, 0, 6, 0);";
	return $SQL;
}
