<div id='mijireh_notice' class='mijireh-info alert-message info' data-alert='alert'>
    <div class='mijireh-logo'><img src='<?php echo $mijireh_image_url; ?>'
                                   alt='<?php printf(esc_attr__('%s Checkout Logo', 'event_espresso'), 'Mijereh'); ?>'>
    </div>
    <div class='mijireh-blurb'>
        ...
        <p class='aligncenter'><a href='<?php echo $slurp_action_link ?>' id='page_slurp' class='button-primary'>Slurp
                This Page!</a></p>
        <p class="aligncenter"><a class="nobold" href="https://secure.mijireh.com/checkout/<?php echo $access_key ?>"
                                  id="view_slurp" target="_new">Preview Checkout Page</a></p>
    </div>
</div>
