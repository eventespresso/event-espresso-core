    ...
    <section class="tckt-slctr-tkt-price-sctn">
        ...
        <div class="tckt-slctr-tkt-details-tbl-wrap-dv">
            <table class="tckt-slctr-tkt-details-tbl">
                <thead>
                <tr>
                    <th class="ee-third-width"><span class="small-text"><?php _e('Name', 'event_espresso'); ?></span>
                    </th>
                ...
                <?php if ($ticket->taxable()) { ?>
                    ...
                    <tr>
                        <td colspan="2" class="jst-rght small-text sbttl"><b><?php _e('subtotal',
                                    'event_espresso'); ?></b></td>
