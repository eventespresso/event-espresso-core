<h3 class="txn-navigation-strip"><?php echo $previous_transaction . '&nbsp;';
    echo __('Transaction # ', 'event_espresso') . $txn_nmbr['value'];
...
<h2 id="txn-status-h2" class="txn-status-h2">
    <?php echo __('Transaction Status: ', 'event_espresso'); ?>
    <span id="txn-status" class="<?php echo $txn_status['class']; ?>"><?php echo $txn_status['value']; ?></span>
</h2>
...
<h2 id="txn-amount-due-h2" <?php echo $attributes; ?>>
    ...
    <span id="txn-admin-total-amount-due" class="<?php echo $amount_due_class; ?>"> <?php echo $amount_due; ?></span>
</h2>
