...
<div id="admin-primary-mbox-dv" class="admin-primary-mbox-dv">
    ...
    <br class="clear"/>
    <?php
    $no_payments = $grand_raw_total > 0 || $TXN_status !== EEM_Transaction::complete_status_code || ! empty($payments);
    ?>
        ...
        <table id="txn-admin-payments-tbl" class="admin-primary-mbox-tbl">
            ...
            <?php if ($payments) : ?>
                ...
                <?php foreach ($payments as $PAY_ID => $payment) : ?>
                    <?php $existing_reg_payment_json = isset($existing_reg_payments[ $PAY_ID ])
                ...
                <span id="payment-status-<?php echo $PAY_ID; ?>"
                      class="ee-status-strip-td ee-status-strip pymt-status-<?php echo $payment->STS_ID(); ?>">
                </span>
                        <div id="payment-STS_ID-<?php echo $PAY_ID; ?>"
                             class="hidden"><?php echo $payment->STS_ID(); ?>
                        </div>
                        <div id="reg-payments-<?php echo $PAY_ID; ?>"
                             class="hidden"><?php echo $existing_reg_payment_json; ?>
                        </div>
                    </td>
                    <td class=" jst-cntr">
                    ...
                    <td class=" jst-rght">
                        <div id="payment-id-<?php echo $PAY_ID; ?>"><?php echo $PAY_ID; ?>
                        </div>
                    </td>
                    <td class=" jst-left">
                        <div id="payment-date-<?php echo $PAY_ID; ?>" class="payment-date-dv">
                            <?php echo $payment->timestamp('Y-m-d', 'g:i a'); ?>
                        </div>
                    </td>
                    <td class=" jst-left">
                    ...
                    <td class=" jst-left">
                        <div id="payment-response-<?php echo $PAY_ID; ?>">
                            <?php echo $payment->gateway_response(); ?>
                        </div>
                    </td>
                    <td class=" jst-left payment-txn-id-chq-nmbr">
                        <div id="payment-txn-id-chq-nmbr-<?php echo $PAY_ID; ?>">
                            <?php echo $payment->txn_id_chq_nmbr(); ?>
                        </div>
                    </td>
                    <td class=" jst-left">
                        <div id="payment-po-nmbr-<?php echo $PAY_ID; ?>">
                            <?php echo $payment->po_number(); ?>
                        </div>
                    </td>
                    <td class=" jst-left">
                        <div id="payment-accntng-<?php echo $PAY_ID; ?>">
                            <?php echo $payment->extra_accntng(); ?>
                        </div>
                    </td>
                    <td class=" jst-rght">
                        <?php
                ...
                <tr id="txn-admin-no-payments-tr" class="admin-primary-mbox-total-tr hidden">
                    ...
                    <span class="important-notice"><?php
                        echo $no_payment_text; ?></span>
                    </td>
                </tr>
                <tr id="txn-admin-payments-total-tr"
                    class="admin-primary-mbox-total-tr<?php
            ...
            <div class="admin-modal-dialog-wrap">
                <div class="admin-modal-dialog-inner">
                    ...
                    <div class="txn-admin-apply-payment-method-dv admin-modal-dialog-row">
                        ...
                        <select name="txn_admin_payment[PMD_ID]"
                                id="txn-admin-payment-method-slct"
                                class="txn-admin-apply-payment-slct required"
                                type="text">
                            <?php foreach ($payment_methods as $method) : ?>
                                ...
                                <option id="payment-method-opt-<?php echo $method->slug(); ?>"
                                    ...
                                    <?php echo $selected; ?>
                                >
                                    <?php echo sanitize_key($method->admin_desc())
                            ...
                            <select name="txn_admin_payment[status]"
                                ...
                                <?php foreach ($payment_status as $STS_ID => $STS_code) : ?>
                                    ...
                                    $selected = $STS_ID == 'PAP'
                                        ? ' selected="selected"'
                                        : ''; ?>
                                    <option id="payment-status-opt-<?php
                                    echo $STS_ID; ?>"
                                            value="<?php
                                            echo $STS_ID; ?>"<?php
                                    echo $selected; ?>><?php
                    ...
                    <div class="txn-admin-apply-payment-registrations-dv admin-modal-dialog-row">
                        ...
                        <?php
                        echo $registrations_to_apply_payment_to; ?>
                    </div>
                    ...
                    <div class="txn-admin-apply-payment-send-notifications-dv admin-modal-dialog-row">
                        ...
                        <label class="txn-admin-payment-send-notifications-lbl">
                            ...
                            />
                            <?php
                            esc_html_e('Payment Messages?', 'event_espresso'); ?>
                        </label>
                        <label class="txn-admin-payment-send-notifications-lbl">
                            <input type="checkbox"
                                   value="1"
                        ...
                        <tr>
                            ...
                            <td class="jst-left"><?php
                                echo isset($delivered_message['message_type'])
                                    ? $delivered_message['message_type']
                                    : ''; ?>
                            </td>
                            <td class="jst-left"><?php
                                echo isset($delivered_message['pay_status'])
                                    ? $delivered_message['pay_status']
                                    : ''; ?>
                            </td>
                            <td class="jst-left"><?php
                                echo isset($delivered_message['txn_status'])
                                    ? $delivered_message['txn_status']
                                    : ''; ?>
                            </td>
                        </tr>
