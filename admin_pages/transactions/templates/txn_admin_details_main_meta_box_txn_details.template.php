			...
			<div class="admin-modal-dialog-wrap">
				<div class="admin-modal-dialog-inner">
					...
					<div class="txn-admin-apply-payment-date-dv admin-modal-dialog-row">
						...
						<input name="txn_admin_payment[date]" id="txn-admin-payment-date-inp" class="txn-admin-apply-payment-inp required" type="text" value="<?php echo current_time( 'mysql' );?>"/>
						<br/>
