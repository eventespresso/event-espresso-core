...
class EE_Admin_Transactions_List_Table extends EE_Admin_List_Table {
	...
	*/
	...
	if ( EEH_MSG_Template::is_mt_active( 'invoice' ) ) {
		$dl_invoice_lnk = '
		<li>
	...
	if ( EEH_MSG_Template::is_mt_active( 'receipt' ) ) {
		$dl_receipt_lnk = '
		<li>
	...
	return $this->_action_string( $view_lnk . $dl_invoice_lnk . $dl_receipt_lnk . $send_pay_lnk . $view_reg_lnk, 'ul', 'txn-overview-actions-ul' );
    }
