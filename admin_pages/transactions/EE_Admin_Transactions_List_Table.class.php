    ...
    function column_actions($item){
		...
		<li>
			<a href="'.$view_lnk_url.'" title="' . __( 'View Transaction Details', 'event_espresso' ) . '">
				<img width="16" height="16" alt="' . __( 'View Transaction Details', 'event_espresso' ) . '" src="'. EE_PLUGIN_DIR_URL .'/images/magnifier.png">
			</a>
		</li>';
		...
		<li>
			<a title="Download Invoice" target="_blank" href="'.$dl_invoice_lnk_url.'">
				<img width="16" height="16" alt="Download Invoice" src="'. EE_PLUGIN_DIR_URL .'/images/invoice-1-16x16.png">
			</a>
		</li>';
		...
		<li>
			<a href="'.$send_pay_lnk_url.'" title="' . __( 'Send Payment Reminder', 'event_espresso' ) . '">
				<img width="20" height="20" alt="' . __( 'Send Payment Reminder', 'event_espresso' ) . '" src="'. EE_PLUGIN_DIR_URL .'/images/payment-reminder-20x20.png">
			</a>
		</li>';
		...
		<li>
			<a href="'.$view_reg_lnk_url.'" title="' . __( 'View Registration Details', 'event_espresso' ) . '">
				<img width="13" height="13" alt="' . __( 'View Registration Details', 'event_espresso' ) . '" src="'. EE_PLUGIN_DIR_URL .'/images/edit.png">
			</a>
		</li>';
