...
class Transactions_List_Table_Tips extends EE_Qtip_Config {
	...
	protected function _set_tips_array() {
		$this->_qtipsa = array(
			...
			2 => array(
				'content_id' => 'transaction-status-' . EEM_Transaction::open_status_code,
				'target' => '.txn-status-' . EEM_Transaction::open_status_code,
				'content' => $this->_transaction_status_legend(EEM_Transaction::open_status_code),
				'options' => array(
					'position' => array(
						'target' => 'mouse'
						)
	...
	private function _transaction_status_legend( $status ) {
		...
		$status_array = array(
			...
			'open' => EEM_Transaction::open_status_code,
