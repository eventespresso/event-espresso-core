<p>
    <strong><?php esc_html_e('Transaction Views', 'event_espresso'); ?></strong>
</p>
<p>
    <?php esc_html_e(
...
<p>
    <strong><?php esc_html_e('Transaction Filters', 'event_espresso'); ?></strong>
</p>
<p>
...
<ul>
    <li>
        <strong><?php esc_html_e('Filter by Time Period', 'event_espresso'); ?></strong>
        <br />
        <?php esc_html_e('Show registrations that fall between a certain date range.', 'event_espresso'); ?>
    </li>
</ul>
<p>
    <strong><?php esc_html_e('Transaction Search', 'event_espresso'); ?></strong>
</p>
<p>
    <?php esc_html_e(
