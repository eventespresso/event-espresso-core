<p><strong><?php esc_html_e('Transaction Items', 'event_espresso'); ?></strong></p>
<p>
<?php esc_html_e('This area of the table shows information about any events that were included in this transactions.', 'event_espresso'); ?>
</p>
<ul>
<li>
...
<li>
<strong><?php esc_html_e('Transaction Total', 'event_espresso'); ?></strong><br />
<?php esc_html_e('The total after any discounts and surcharges have been applied.', 'event_espresso'); ?>
</li>
</ul>
<p><strong><?php esc_html_e('Transaction Session Details', 'event_espresso'); ?></strong></p>
<ul>
<li>
...
<li>
<strong><?php esc_html_e('Transaction placed from IP', 'event_espresso'); ?></strong><br />
<?php esc_html_e('Shows the the IP address that was used for a registration.', 'event_espresso'); ?>
</li>
<li>
<strong><?php esc_html_e('Registrant User Agent', 'event_espresso'); ?></strong><br />
