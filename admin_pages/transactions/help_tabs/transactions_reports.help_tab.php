<p><strong><?php _e('Transaction Reports', 'event_espresso'); ?></strong></p>
<p>
...
<?php _e('Want to see a tour of this screen? Click on the Transaction Reports Tour button which appears on the right side of the page. <br />To learn more about the options on this page, take a look at the different tabs that appear on the left side of the page.', 'event_espresso'); ?>
</p>
<p>
