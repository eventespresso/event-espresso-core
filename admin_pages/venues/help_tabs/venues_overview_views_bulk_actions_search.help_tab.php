<p>
    <strong><?php esc_html_e('Venues Overview Bulk Actions', 'event_espresso'); ?></strong>
</p>
<p>
    <?php esc_html_e(
...
<p>
    <strong><?php esc_html_e('Venues Overview Views', 'event_espresso'); ?></strong>
</p>
<p>
    <?php esc_html_e(
...
<ul>
    <li>
        <strong><?php esc_html_e('View All Venues', 'event_espresso'); ?></strong>
        <br />
...
<p>
    <strong><?php esc_html_e('Venues Overview Search', 'event_espresso'); ?></strong>
</p>
<p>
    <?php esc_html_e(
