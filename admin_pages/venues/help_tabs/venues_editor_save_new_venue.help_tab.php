<p><strong><?php esc_html_e('Save New Venue', 'event_espresso'); ?></strong></p>
<p>
<?php esc_html_e('Quickly publish your venue to allow linking to an event or multiple events.', 'event_espresso'); ?><br />
</p>
<ul>
<li>
...
<?php esc_html_e('Enter the maximum number of registrants that are supported by this venue.', 'event_espresso'); ?>
</li>
<li>
<strong><?php esc_html_e('Venue Website', 'event_espresso'); ?></strong><br />
<?php esc_html_e('Enter the URL (website address) for this venue. This field is optional.', 'event_espresso'); ?>
</li>
<li>
<strong><?php esc_html_e('Venue Phone #', 'event_espresso'); ?></strong><br />
