<p>
    <strong><?php esc_html_e('Google Maps', 'event_espresso'); ?></strong>
</p>
<p>
    <?php esc_html_e(
...
<p>
    ...
    <?php printf(
        esc_html__(
            'Want to see a tour of this screen? Click on the Google Maps Tour button which appears on the right side of the page. %1$sTo learn more about the options on this page, take a look at the different tabs that appear on the left side of the page.',
            'event_espresso'
        ),
        '<br />'
    ); ?>
