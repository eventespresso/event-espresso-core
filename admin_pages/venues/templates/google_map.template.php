<div class="padding">
    ...
    <table class="form-table">
        ...
        if (apply_filters('FHEE__google_map__show_api_key_input', true)) { ?>
            <tr>
                ...
                <td>
                    <input type="text" id="ee-google-map-api-key" class="regular-text" name="google_map_api_key"
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <input type="text" id="event_details_map_width" name="event_details_map_width"
                       value="<?php echo $map_settings->event_details_map_width; ?>"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="event_details_map_height" size="" name="event_details_map_height"
                       value="<?php echo $map_settings->event_details_map_height; ?>"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input id="event_details_map_zoom" type="text" size="" name="event_details_map_zoom"
                       value="<?php echo $map_settings->event_details_map_zoom; ?>"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <label for="event_details_map_align-none" class="ee-admin-radio-lbl">
                    ...
                    <input id="event_details_map_align-none" type="radio" name="event_details_map_align"
                ...
                <label for="event_details_map_align-left" class="ee-admin-radio-lbl">
                    ...
                    <input id="event_details_map_align-left" type="radio" name="event_details_map_align"
                           value="left"<?php echo $checked; ?>/>
                ...
                <label for="event_details_map_align-center" class="ee-admin-radio-lbl">
                    ...
                    <input id="event_details_map_align-center" type="radio" name="event_details_map_align"
                           value="center"<?php echo $checked; ?>/>
                ...
                <label for="event_details_map_align-right" class="ee-admin-radio-lbl">
                    ...
                    <input id="event_details_map_align-right" type="radio" name="event_details_map_align"
                           value="right"<?php echo $checked; ?>/>
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <input id="event_list_map_width" type="text" name="event_list_map_width"
                       value="<?php echo $map_settings->event_list_map_width; ?>"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input id="event_list_map_height" type="text" size="" name="event_list_map_height"
                       value="<?php echo $map_settings->event_list_map_height; ?>"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input id="event_list_map_zoom" type="text" size="" name="event_list_map_zoom"
                       value="<?php echo $map_settings->event_list_map_zoom; ?>"/>
            </td>
        </tr>
        <tr>
            <th>
        ...
        <tr>
            ...
            <td>
                <label for="event_list_control_type-default" class="ee-admin-radio-lbl">
                    ...
                    <input id="event_list_control_type-default" type="radio" name="event_list_control_type"
                           value="default"<?php echo $checked; ?>/>
                    <?php _e(' Default', 'event_espresso') ?>
                </label>
                ...
                <label for="event_list_control_type-dropdown" class="ee-admin-radio-lbl">
                    ...
                    <input id="event_list_control_type-dropdown" type="radio" name="event_list_control_type"
                           value="dropdown"<?php echo $checked; ?>/>
                    <?php _e(' Dropdown', 'event_espresso') ?>
                </label>
        ...
        <tr>
            ...
            <td>
                <label for="event_list_map_align-none" class="ee-admin-radio-lbl">
                    ...
                    <input id="event_list_map_align-none" type="radio" name="event_list_map_align"
                           value="none"<?php echo $checked; ?>/>
                    <?php _e(' None', 'event_espresso') ?>
                </label>
                ...
                <label for="event_list_map_align-left" class="ee-admin-radio-lbl">
                    ...
                    <input id="event_list_map_align-left" type="radio" name="event_list_map_align"
                           value="left"<?php echo $checked; ?>/>
                    <?php _e(' Align Left', 'event_espresso') ?>
                </label>
                ...
                <label for="event_list_map_align-center" class="ee-admin-radio-lbl">
                    ...
                    <input id="event_list_map_align-center" type="radio" name="event_list_map_align"
                           value="center"<?php echo $checked; ?>/>
                    <?php _e(' Align Center', 'event_espresso') ?>
                </label>
                ...
                <label for="event_list_map_align-right" class="ee-admin-radio-lbl">
                    ...
                    <input id="event_list_map_align-right" type="radio" name="event_list_map_align"
                           value="right"<?php echo $checked; ?>/>
                    <?php _e(' Align Right', 'event_espresso') ?>
                </label>
