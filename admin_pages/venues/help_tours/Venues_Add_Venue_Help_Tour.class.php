...
class Venues_Add_Venue_Help_Tour extends EE_Help_Tour
{
    ...
    {
        $content = '<h3>' . esc_html__('Add Venue', 'event_espresso') . '</h3>';
        $content .= '<p>'
                    . esc_html__(
    ...
    protected function _venue_editor_stop()
    {
        return '<p>'
               . esc_html__(
                   'The rich text editor can be used to add information about your venue. Images and links can also be added along with your text.',
                   'event_espresso'
               ) . '</p>';
    }
    ...
    {
        return '<p>' . esc_html__('Quickly add tags to your venue.', 'event_espresso') . '</p>';
    }
    ...
    {
        return '<p>' . esc_html__('Add a physical address for your venue.', 'event_espresso') . '</p>';
    }
