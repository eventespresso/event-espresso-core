...
class Venues_Admin_List_Table extends EE_Admin_List_Table
{
     ...
     * @throws ReflectionException
     */
    public function column_id($venue)
    {
        $content = '
     ...
     * @throws ReflectionException
     */
    public function column_name($venue, $prep_content = true)
    {
     ...
     * @throws ReflectionException
     */
    protected function _column_name_action_setup($venue)
    {
        $actions = [];
     ...
     * @return string
     */
    public function column_address($venue)
    {
     ...
     * @return string
     */
    public function column_city($venue)
    {
     ...
     * @return string
     */
    public function column_capacity($venue)
    {
     ...
     * @return string
     */
    public function column_shortcode($venue)
    {
