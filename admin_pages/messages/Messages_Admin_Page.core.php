...
class Messages_Admin_Page extends EE_Admin_Page
{
    ...
    protected function _set_page_config()
    {
        $this->_page_config = [
            ...
            'global_mtps'              => [
                ...
                // 'help_tour'     => ['Messages_Overview_Help_Tour'],
                'require_nonce' => false,
            ],
            'custom_mtps'              => [
                'nav'           => [
            ...
            'edit_message_template'    => [
                ...
                'has_metaboxes' => true,
                // disabled temporarily. see: https://github.com/eventespresso/eventsmart.com-website/issues/836
                // 'help_tour'     => ['Message_Templates_Edit_Help_Tour'],
                'help_tabs'     => [
                    'edit_message_template'            => [
            ...
            'settings'                 => [
                ...
                // disabled temporarily. see: https://github.com/eventespresso/eventsmart.com-website/issues/836
                // 'help_tour'     => ['Messages_Settings_Help_Tour'],
                'require_nonce' => false,
            ],
        ];
    }
                ...
                if ($template_field === 'extra') {
                    ...
                    foreach ($field_setup_array as $reference_field => $new_fields_array) {
                        ...
                        foreach ($new_fields_array as $extra_field => $extra_array) {
                            ...
                            /*
                             * commented the following lines of code out because they literally did nothing
                             * I'm guessing something got removed at some point ¯\_(ツ)_/¯
                             * but leaving in just in case there was supposed to be something there
                             *
     ...
     * @throws DomainException
     * @throws EE_Error
     * @throws InvalidIdentifierException|ReflectionException
     */
    ...
    {
        $shortcodes = $this->_get_shortcodes([], false); // just make sure shortcodes property is set
        ...
        if (empty($shortcodes)) {
            ...
            $content .= $this->_get_help_tab_link('message_template_shortcodes');
            $content .= '</div>';
            $content .= '<p class="small-text">';
            $content .= sprintf(
                esc_html__(
    ...
    protected function _get_shortcodes($fields = [], $merged = true)
    {
        ...
        return ! empty($GRP_ID)
            ? $this->_message_template_group->get_shortcodes($context, $fields, $merged)
            : [];
    }
     ...
     *
     * @return void
     * @throws DomainException|EE_Error
     */
