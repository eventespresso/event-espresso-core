...
class Messages_Admin_Page extends EE_Admin_Page
{
     ...
     * @throws EE_Error
     */
    protected function _set_context_switcher($template_group_object, $args)
    {
        ...
        if (! empty($fields)) {
            ...
            foreach ($fields as $field_name => $field_props) {
                ...
                $template_form_field[ $field_id ] = [
                    ...
                    'value'      => isset($existing_settings[ $field_id ]) ? $existing_settings[ $field_id ] : $field_props['default'],
                    'css_class'  => '',
