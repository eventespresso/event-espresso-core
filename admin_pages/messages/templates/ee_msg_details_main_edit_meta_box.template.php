<div id="admin-primary-mbox-dv" class="admin-primary-mbox-dv">
    ...
    <h3 class="admin-primary-mbox-h4">
        <?php echo isset($event_name) ? $event_name . ' Custom Template' : ''; ?>
    </h3>
    <input type="hidden"
    ...
    if (! $MTP->is_global()) : ?>
        <div class="non-global-mtp-fields">
            ...
            <p>
                <label for="ee-msg-non-global-fields-MTP_description"
                       class="label-MTP_description"
                ...
                <textarea id="ee-msg-non-global-fields-MTP_description"
                          class="large-text"
                          name="ee_msg_non_global_fields[MTP_description]"
                >
                    <?php echo $MTP->description(); ?>
                </textarea>
            </p>
        </div>
    <?php else : ?>
