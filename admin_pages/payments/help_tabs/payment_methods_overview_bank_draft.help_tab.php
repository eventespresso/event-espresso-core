...
<ul>
<li>
<?php _e('Page Title', 'event_espresso'); ?><br />
<?php _e('Enter a title for this page.', 'event_espresso'); ?>
</li>
<li>
<?php _e('Payment Instructions', 'event_espresso'); ?><br />
...
<li>
<?php _e('Bank Account #', 'event_espresso'); ?><br />
<?php _e('Enter the bank account number.', 'event_espresso'); ?>
</li>
<li>
<?php _e('Bank Name', 'event_espresso'); ?><br />
<?php _e('Enter the name of the bank.', 'event_espresso'); ?>
</li>
<li>
<?php _e('Bank Address', 'event_espresso'); ?><br />
<?php _e('Enter the address for the bank.', 'event_espresso'); ?>
</li>
<li>
