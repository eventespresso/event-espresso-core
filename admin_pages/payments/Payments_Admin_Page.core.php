...
class Payments_Admin_Page extends EE_Admin_Page
{
     ...
     * @return void
     */
    public function setSortLogsAgainDirection($sort_logs_again_direction)
    {
    ...
    protected function _add_payment_method_help_tabs()
    {
        ...
        foreach ($payment_method_types as $payment_method_type) {
            ...
            foreach ($payment_method_type->help_tabs_config() as $help_tab_name => $config) {
                $template_args                              = isset($config['template_args']) ? $config['template_args'] : [];
     ...
     * @throws EE_Error
     */
    protected function _pci_dss_compliance($payment_method)
    {
     ...
     * @throws EE_Error
     */
    protected function _currency_support($payment_method)
    {
     ...
     * @throws ReflectionException
     */
    protected function _payment_method_settings($payment_method)
    {
     ...
     * @throws EE_Error
     */
    protected function _update_payment_method_button($payment_method)
    {
     ...
     * @return EE_Form_Section_HTML
     */
    protected function _deactivate_payment_method_button($payment_method)
    {
     ...
     * @throws EE_Error
     */
    protected function _activate_payment_method_button($payment_method)
    {
        $link_text_and_title = sprintf(
    ...
    protected function _update_payment_settings()
    {
        ...
        if ($form->was_submitted($this->_req_data)) {
            ...
            if ($form->is_valid()) {
                ...
                $show_pending_payment_options             = isset($valid_data['show_pending_payment_options']) ? $valid_data['show_pending_payment_options'] : null;
