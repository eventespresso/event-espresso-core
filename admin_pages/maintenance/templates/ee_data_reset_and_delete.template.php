...
<div class="padding">
	...
	<ol>
		<li><?php  printf( __('First, click the button below to permanently delete all Event Espresso tables, records, and options from your WordPress database . %1$sIf you see a 500 error or a blank white screen, just click refresh in your browser%2$s. The request timed out but will continue if you just refresh the page showing the error.', 'event_espresso'), '<strong>', '</strong>' );?></li>
