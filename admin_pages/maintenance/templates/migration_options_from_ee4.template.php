            ...
            <tr>
                <td>
                    ...
                    echo apply_filters(
                            ...
                            __('Before updating your database, you should first create a database backup',
                                    "event_espresso"),
                            $current_db_state,
                            $next_db_state
                    );
                    ...
                    <a id="display-migration-details"
                       ...
                       rel="migration-details"><?php _e('How Do I Make a Database Backup?', "event_espresso"); ?>
                        &nbsp;+</a>
                </td>
                <td>
                    <a id="db-backed-up"
                       class="toggle-migration-monitor button-primary"><?php echo apply_filters('FHEE__ee_migration_page__option_1_button_text',
                                sprintf(__("My Database Is Backed Up, Continue", "event_espresso"), $current_db_state,
                ...
                <td colspan="2" style="padding: 0">
                    <div id="migration-details-dv" style="display: none; padding: 1em;">
                        <p>
                            <?php
                            printf(
                                    __('%1$sClick Here to Learn How To Backup your Database Yourself%2$s. Or have one of our dedicated support technicians help you by %3$spurchasing a Priority Support Token.%2$s',
                                            "event_espresso"),
