...
>
    <table class='widefat'>
        <tr>
            <td><label for='from'><?php esc_html_e("From/Reply-To:", "event_espresso"); ?></label></td>
            <td>
                <input name='from'
                       id='from'
                       type='text'
                       style="width:200px"
                       value='<?php echo esc_html(get_bloginfo('admin_email', 'display')); ?>'
                />
            </td>
        </tr>
        <tr>
            <td>
                <label for='from_name'><?php esc_html_e("Your Name", "event_espresso"); ?></label>
            </td>
            <td>
        ...
        <tr>
            <td colspan="2">
                <input type="submit"
                       value="<?php esc_html_e("Mail Crash Report to Event Espresso", "event_espresso"); ?>"
                />
            </td>
        </tr>
    </table>
