...
<div class="misc-pub-section" id="visibility">
	<img src="<?php echo EE_PLUGIN_DIR_URL ?>images/group.png" width="16" height="16" alt="<?php _e('View Attendees', 'event_espresso'); ?>" />
...
<div class="misc-pub-section <?php echo $misc_pub_section_class; ?>" id="visibility2">
	<a href="<?php echo $email_attendees_url;?>" title="<?php _e('Email Event Attendees', 'event_espresso'); ?>">
		<img src="<?php echo EE_PLUGIN_DIR_URL ?>images/email_go.png" width="16" height="16" alt="<?php _e('Newsletter', 'event_espresso'); ?>" />
