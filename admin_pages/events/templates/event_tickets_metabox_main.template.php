    ...
    <div id="event-and-ticket-form-content">
        ...
        <div class="event-datetimes-container">
            ...
            <section id="edit-event-datetime-1" class="datetime-edit">
                <input type="hidden" name="edit_event_datetimes[1][DTT_ID]" id="event-datetime-DTT_ID-1"
                       class="event-datetime-DTT_ID" value="<?php echo $time->get('DTT_ID'); ?>">
                <table class="datetime-edit-table">
                    ...
                    <tr valign="top">
                        <td class="event-datetime-column date-column">
                            <input type="text" name="edit_event_datetimes[1][DTT_EVT_start]"
                                   id="event-datetime-DTT_EVT_start-1"
                                   class="ee-text-inp event-datetime-DTT_EVT_start ee-datepicker"
                                   data-context="start-dtt" data-date-field-context="#edit-event-datetime-1"
                                   data-related-field=".event-datetime-DTT_EVT_end"
                                   data-next-field=".event-datetime-DTT_EVT_end"
                                   value="<?php echo $time->get_date('DTT_EVT_start', 'Y-m-d h:i a'); ?>">
                        </td>
                        <td class="event-datetime-column date-column">
                            <input type="text" name="edit_event_datetimes[1][DTT_EVT_end]"
                                   id="event-datetime-DTT_EVT_end-1"
                                   class="ee-text-inp event-datetime-DTT_EVT_end ee-datepicker" data-context="end-dtt"
                                   ...
                                   value="<?php echo $time->get_date('DTT_EVT_end', 'Y-m-d h:i a'); ?>">
                        </td>
