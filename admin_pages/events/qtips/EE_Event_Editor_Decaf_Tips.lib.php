...
class EE_Event_Editor_Decaf_Tips extends EE_Qtip_Config {
	...
	private function _get_event_datetime_DTT_reg_limit_label_info() {
		return esc_html__('This field allows you to set a maximum number of tickets that you want to make available for an event datetime.', 'event_espresso');
	}
	private function _get_event_datetime_DTT_sold_label_info() {
		return esc_html__('This shows the number of tickets that have been sold that have access to this event datetime.', 'event_espresso');
	}
	private function _get_event_datetime_DTT_reserved_label_info() {
		return esc_html__('This shows the number of reserved tickets that have access to this event datetime.', 'event_espresso');
	}
	...
	private function _get_event_ticket_TKT_qty_label_info() {
		return esc_html__('This field shows the quantity of tickets that are available for this type of ticket.', 'event_espresso');
	}
	...
	private function _get_event_ticket_TKT_regs_label_info() {
		return esc_html__('This shows the number of registrations that have occurred from ticket sales.', 'event_espresso');
	}
	...
	private function _get_event_ticket_TD_TKT_number_datetimes_label_info() {
		return esc_html__('This field allows you to set the number of datetimes that a ticket should have access to.', 'event_espresso');
	}
	private function _get_event_ticket_TD_TKT_min_qty_label_info() {
		return esc_html__('This shows the minimum quantity that can be purchased for this ticket.', 'event_espresso');
	}
