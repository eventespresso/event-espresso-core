...
<?php _e('The is the numerical ID of an event. This value is used internally for Event Espresso and is used to populate certain shortcodes.', 'event_espresso'); ?>
</li>
<li>
<strong><?php _e('Name', 'event_espresso'); ?></strong><br />
<?php _e('This is the name of an event. ', 'event_espresso'); ?>
<?php _e('Hovering over the name of the event will provide you will several options: View, Edit, Registrations, Export, and Trash. Clicking on View will take you to the event on the front-end of your site. Clicking on Edit will open the event for editing in the Event Editor. Clicking on Registrations will take you to a page that shows a list of attendees for that event. Clicking on Export will download a CSV for that event. Clicking on Trash will move that event to the trash.<br /> Note: an event can only be deleted after associated payments have been removed and registrations have been removed.', 'event_espresso'); ?>
</li>
<li>
<strong><?php _e('Venue', 'event_espresso'); ?></strong><br />
<?php _e('The location or place that is hosting the event.<br /> Note: an event is not required to have a venue associated with it.', 'event_espresso'); ?>
</li>
<li>
<strong><?php _e('Event Start', 'event_espresso'); ?></strong><br />
...
<li>
<strong><?php _e('Registrations', 'event_espresso'); ?></strong><br />
<?php _e('This is the number of registrations that have been approved. Clicking on this number will take you to a page that shows you a list of registrants for that event.', 'event_espresso'); ?>
</li>
<li>
