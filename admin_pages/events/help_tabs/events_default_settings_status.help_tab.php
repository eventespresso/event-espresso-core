...
<p>
    <strong>
        <?php echo EEH_Template::pretty_status(RegStatus::APPROVED, false, 'sentence'); ?>
    </strong>
    <br />
    <?php sprintf(
        esc_html__(
...
<p>
    <strong>
        <?php echo EEH_Template::pretty_status(RegStatus::PENDING_PAYMENT, false, 'sentence'); ?>
    </strong>
    <br />
    <?php printf(
        esc_html__(
...
<p>
    <strong>
        <?php echo EEH_Template::pretty_status(RegStatus::AWAITING_REVIEW, false, 'sentence'); ?>
    </strong>
    <br />
    <?php printf(
        esc_html__(
        ...
        EEH_Template::pretty_status(RegStatus::PENDING_PAYMENT, false, 'upper'),
        EEH_Template::pretty_status(RegStatus::APPROVED, false, 'upper')
    ); ?>
</p>
