<p><strong><?php esc_html_e('Save New Event', 'event_espresso'); ?></strong></p>
<p>
<?php esc_html_e('Quickly publish your event to allow immediate registrations.', 'event_espresso'); ?><br />
</p>
...
<?php esc_html_e('An event can be published immediately or you can schedule it to be published at a later date in the future.', 'event_espresso'); ?>
</li>
<li>
<strong><?php esc_html_e('Approved Registrations', 'event_espresso'); ?></strong><br />
<?php esc_html_e('Shows number of registrants who are attending event. Click on the Approved Registrations link to be brought to a page where you can be a list of registrants who are attending the event.', 'event_espresso'); ?>
</li>
<li>
<strong><?php esc_html_e('Pending Payment Registrations', 'event_espresso'); ?></strong><br />
<?php esc_html_e('Shows number of registrants who need to pay to attend the event. Click on the Pending Payment Registrations link to be brought to a page where you can be a list of registrants who need to pay for this event.', 'event_espresso'); ?>
</li>
<li>
<strong><?php esc_html_e('Not Approved Registrations', 'event_espresso'); ?></strong><br />
<?php esc_html_e('Shows number of registrants who cannot attend the event because they were not approved. Click on the Not Approved Registrations link to be brought to a page where you can be a list of registrants who cannot attend the event.', 'event_espresso'); ?>
</li>
<li>
<strong><?php esc_html_e('Move to Trash', 'event_espresso'); ?></strong><br />
<?php esc_html_e('Click the Move to Trash link to move an event to the trash. Note: an event can only be deleted after associated payments have been removed and registrations have been removed.', 'event_espresso'); ?>
</li>
</ul>