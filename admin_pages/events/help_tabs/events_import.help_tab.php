<p><strong><?php esc_html_e('Event Espresso Import', 'event_espresso'); ?></strong></p>
<p>
    <?php esc_html_e('This page allows you to import information into Event Espresso.', 'event_espresso'); ?>
</p>
<p>
...
<p>
    ...
    <?php esc_html_e(
        'Want to see a tour of this screen? Click on the Import Tour button which appears on the right side of the page.',
        'event_espresso'
    ); ?>
