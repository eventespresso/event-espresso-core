<p><strong><?php esc_html_e('Default Event Settings', 'event_espresso'); ?></strong></p>
<p>
<?php esc_html_e('Customize the default settings for your events.', 'event_espresso'); ?>
</p>
<p>
<strong><?php esc_html_e('Recommendations', 'event_espresso'); ?></strong><br />
<?php esc_html_e('Want to see a tour of this screen? Click on the Default Settings Tour button which appears on the right side of the page.', 'event_espresso'); ?>
</p>
<p>
