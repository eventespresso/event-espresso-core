<h3><?php _e('Default Event Settings', 'event_espresso'); ?></h3>
<p>
<?php _e('Customize the default settings for your events.', 'event_espresso'); ?>
</p>
<p>
<?php _e('<strong>Recommendations</strong><br /> Want to see a tour of this screen? Click on the Default Settings Tour button which appears on the right side of the page.', 'event_espresso'); ?>
</p>
<p>
