<p>
<strong><?php _e('Certain options below such as the event featured image and event excerpt will only be displayed if supported by your WordPress theme.', 'event_espresso'); ?></strong>
</p>
<p><strong><?php _e('Event Featured Image', 'event_espresso'); ?></strong></p>
<p>
<?php _e('Set a featured image for your event.', 'event_espresso'); ?>
</p>
<p><strong><?php _e('Event Excerpt', 'event_espresso'); ?></strong></p>
<p>
<?php _e('An excerpt can be thought of as a short description for your event. HTML tags are supported here.', 'event_espresso'); ?>
</p>
<p><strong><?php _e('Event Custom Fields', 'event_espresso'); ?></strong></p>
<p>
<?php _e('Setup custom fields for your events.', 'event_espresso'); ?>
</p>
<p><strong><?php _e('Event Discussion', 'event_espresso'); ?></strong></p>
<p>
...
<p><strong><?php _e('Event Slug', 'event_espresso'); ?></strong></p>
<p>
<?php _e('The slug is the customizable portion of the URL for your event. For example, if my event was called "Holiday Celebrations," then the URL could appear as such: http://example.com/events/holiday-celebrations -- the slug would be then be holiday-celebrations.', 'event_espresso'); ?>
</p>
<p><strong><?php _e('Event Author', 'event_espresso'); ?></strong></p>
<p>
...
<p><strong><?php _e('Event Notifications', 'event_espresso'); ?></strong></p>
<p>
...
<p><strong><?php _e('Espresso Ticket Selector', 'event_espresso'); ?></strong></p>
<p>
