...
class Events_Admin_Page extends EE_Admin_Page_CPT
{
     ...
     * @throws ReflectionException
     */
    protected function _default_venue_update($event, $data)
    {
     ...
     * @throws Exception
     */
    protected function _default_tickets_update($event, $data)
    {
        if ($this->admin_config->useAdvancedEditor()) {
            return [];
        }
     ...
     * @throws ReflectionException
     */
    private function _add_prices_to_ticket(array $prices_data, EE_Ticket $ticket, $new_prices = false)
    {
        $new_prices = (bool) $new_prices;
     ...
     * @throws ReflectionException
     */
    private function _get_ticket_row(EE_Ticket $ticket, $skeleton = false, $row = 0)
    {
                ...
                'subsections'     => apply_filters(
                    ...
                    [
                        ...
                        'default_max_tickets'     => new EE_Integer_Input(
                            [
                                'default'         => isset($registration_config->default_maximum_number_of_tickets) ? $registration_config->default_maximum_number_of_tickets : EEM_Event::get_default_additional_limit(),
     ...
     */
    private function _insert_category($new_category)
    {
        $new_category = (bool) $new_category;
        $category_ID         = $this->request->getRequestParam('EVT_CAT_ID', 0, DataType::INT);
        ...
        $category_ID = isset($insert_ids['term_id']) ? $insert_ids['term_id'] : 0;
        if (! $category_ID) {
            EE_Error::add_error(
                esc_html__(
