...
class Events_Admin_Page extends EE_Admin_Page_CPT {
	...
	protected function _default_event_settings() {
		...
		$this->_template_args['default_reg_status'] = isset( EE_Registry::instance()->CFG->registration->default_STS_ID ) ? sanitize_text_field( EE_Registry::instance()->CFG->registration->default_STS_ID ) : EEM_Registration::status_id_pending_payment_payment;
	...
	protected function _update_default_event_settings() {
		...
		EE_Config::instance()->registration->default_STS_ID = isset($this->_req_data['default_reg_status']) ? sanitize_text_field($this->_req_data['default_reg_status']) : EEM_Registration::status_id_pending_payment_payment;
