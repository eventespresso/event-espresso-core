...
class Events_Admin_List_Table extends EE_Admin_List_Table
{
     ...
     * @throws ReflectionException
     */
    public function column_id($event)
    {
     ...
     * @throws ReflectionException
     */
    public function column_name($event, $prep_content = true)
    {
        $edit_query_args = [
            'action' => 'edit',
            'post'   => $event->ID(),
     ...
     * @throws ReflectionException
     */
    protected function _column_name_action_setup($event)
    {
     ...
     * @throws ReflectionException
     */
    public function column_author($event)
    {
        // user author info
     ...
     * @throws ReflectionException
     */
    public function column_event_category($event)
    {
     ...
     * @throws ReflectionException
     */
    public function column_venue($event)
    {
     ...
     * @throws ReflectionException
     */
    public function column_start_date_time($event)
    {
     ...
     * @throws ReflectionException
     */
    public function column_reg_begins($event)
    {
     ...
     * @throws ReflectionException
     */
    public function column_attendees($event)
    {
        $attendees_query_args = [
            'action'   => 'default',
            'event_id' => $event->ID(),
     ...
     * @throws ReflectionException
     */
    public function column_tkts_sold($event)
    {
     ...
     * @throws ReflectionException
     */
    public function column_actions($event)
    {
        // todo: remove when attendees is active
        if (! defined('REG_ADMIN_URL')) {
            define('REG_ADMIN_URL', EVENTS_ADMIN_URL);
