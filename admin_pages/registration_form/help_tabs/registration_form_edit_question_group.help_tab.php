<p><strong><?php esc_html_e('Edit Question Group', 'event_espresso'); ?></strong></p>
<p>
<?php esc_html_e('This page allows you to edit a question group for Event Espresso.', 'event_espresso'); ?>
</p>
<p>
<strong><?php esc_html_e('Notice', 'event_espresso'); ?></strong><br />
<?php esc_html_e('System questions groups may have some options disabled. This is to ensure that your registrations don\'t break from accidental changes.', 'event_espresso'); ?>
</p>
<ul>
<li>
...
<?php esc_html_e('This shows all available custom questions. If checked, then that question will appear with this question group. Questions that appear here can also be sorted using drag and drop.', 'event_espresso'); ?>
</li>
</ul>
<p>
<strong><?php esc_html_e('Recommendations', 'event_espresso'); ?></strong><br />
<?php esc_html_e('Want to see a tour of this screen? Click on the Edit Question Group Tour button which appears on the right side of the page. To learn more about the options on this page, take a look at the different tabs that appear on the left side of the page.', 'event_espresso'); ?>
</p>
<p>
