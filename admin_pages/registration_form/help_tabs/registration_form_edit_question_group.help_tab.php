...
<p>
<?php _e("A name or heading for this group of questions that can be used to organize your Registration Form. For example: Address Information.(HTML not permitted)", 'event_espresso'); ?>
</p>
...
<p>
<?php _e('The "Group Identifier" is a unique name for this group that can be used to distinguish it from all other groups in the system. A Group Identifier therefore can not be the same as any other. It will NOT be displayed to site visitors. If left blank, one will be automagically generated for you, ie: address-info-12345. (HTML not permitted)','event_espresso')?>
</p>
<h2>
<?php _e('Group Description', 'event_espresso'); ?>
</h2>
<p>
<?php _e('A description of this question group.(HTML permitted)','event_espresso')?>
</p>
<h2>
