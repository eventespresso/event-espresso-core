<p>
    <strong><?php esc_html_e('Questions Overview Bulk Actions', 'event_espresso'); ?></strong>
</p>
<p>
    <?php esc_html_e(
...
<p>
    <strong><?php esc_html_e('Questions Groups Overview Search', 'event_espresso'); ?></strong>
</p>
<p>
    <?php esc_html_e(
