...
?>
<p>
    <strong><?php esc_html_e('Add New Question', 'event_espresso'); ?></strong>
</p>
<p>
    <?php printf(
...
<ul>
    ...
    <li>
        <strong><?php esc_html_e('Required Question', 'event_espresso'); ?></strong>
        <br />
...
<p>
    ...
    <br />
    <?php esc_html_e(
        'Want to see a tour of this screen? Click on the Add New Question Tour button which appears on the right side of the page. To learn more about the options on this page, take a look at the different tabs that appear on the left side of the page.',
        'event_espresso'
    ); ?>
</p>
<p>
