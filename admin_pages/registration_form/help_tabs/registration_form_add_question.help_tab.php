...
<li>
	<?php _e('Answer Options (for applicable question types)</strong>', 'event_espresso');?><br/>
...
<li>
<?php _e('<strong>Required Text</strong>', 'event_espresso'); ?><br />
...
<p>
<?php _e('<strong>Recommendations</strong><br /> Want to see a tour of this screen? Click on the Add New Question Tour button which appears on the right side of the page. <br />To learn more about the options on this page, take a look at the different tabs that appear on the left side of the page.', 'event_espresso'); ?>
</p>
<p>
