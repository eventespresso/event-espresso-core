...
<p><?php _e('If you cannot use the drag and drop feature on the question overview page to re-order the questions, you can manually add numbers into each questions Question Order field. The lower the number the earleier it will appear in the question order e.g. a question with order 1 will appear above a question with order 2.', 'event_espresso'); ?></p>
...
<?php
    echo sprintf(
                 __("
                    ...
                    'MULTIPLE' (checkboxes) allow users to select multiple answer options. Best used when there are only a few predetermined answer options.%s
                    'DROPDOWN' (select boxes) allow users to select one or more answer options. Best used when there are many predetermined answer options%s
...
<p>
<?php _e("Text to display when the registrant does not answer the question but is required to. The default message is 'This field is required'", 'event_espresso'); ?>
</p>