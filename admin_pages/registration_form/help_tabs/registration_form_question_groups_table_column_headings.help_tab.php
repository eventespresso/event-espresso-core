<p>
    <strong><?php esc_html_e('Question Groups Table Column Headings', 'event_espresso'); ?></strong>
</p>
<ul>
    <li>
    ...
    <li>
        ...
        <?php esc_html_e('Shows if the group name will be displayed on the registration form.', 'event_espresso'); ?>
    </li>
    <li>
