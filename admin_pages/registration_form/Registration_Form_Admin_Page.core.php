...
class Registration_Form_Admin_Page extends EE_Admin_Page
{
    ...
    protected function _set_page_config()
    {
        $this->_page_config = [
            'default' => [
                ...
                // 'help_tour'     => ['Registration_Form_Questions_Overview_Help_Tour'],
                'require_nonce' => false,
                'qtips'         => [
            ...
            'question_groups' => [
                ...
                // disabled temporarily. see: https://github.com/eventespresso/eventsmart.com-website/issues/836
                // 'help_tour'     => ['Registration_Form_Question_Groups_Help_Tour'],
                'require_nonce' => false,
            ],
            ...
            'edit_question' => [
                ...
                // disabled temporarily. see: https://github.com/eventespresso/eventsmart.com-website/issues/836
                // 'help_tour'     => ['Registration_Form_Edit_Question_Help_Tour'],
                'require_nonce' => false,
            ],
        ];
    }
    ...
    protected function _set_column_values_for(EEM_Base $model)
    {
        ...
        foreach ($model->field_settings() as $fieldName => $settings) {
            if ($fieldName === 'QSG_identifier'
                ...
                $QSG_name                        =
                    isset($this->_req_data['QSG_name']) ? $this->_req_data['QSG_name'] : '';
                $set_column_values[ $fieldName ] = sanitize_title($QSG_name) . '-' . uniqid('', true);
            } elseif ($fieldName === 'QST_admin_label'
                ...
                $QST_text                        =
                    isset($this->_req_data['QST_display_text']) ? $this->_req_data['QST_display_text'] : '';
    ...
    protected function get_query_params($model, $per_page = 10, $current_page = 10)
    {
        ...
        $order                    =
            (isset($this->_req_data['order']) && ! empty($this->_req_data['order'])) ? $this->_req_data['order']
                : 'ASC';
    ...
    public function get_question_groups($per_page, $current_page = 1, $count = false)
    {
        ...
        return $count
            ? $questionGroupModel->count($where)
            : $questionGroupModel->get_all($query_params);
    }
}
