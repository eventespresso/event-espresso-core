    ...
    <table class="form-table">
        ...
        <tr>
            <th>
                ...
                <?php echo EEH_Template::get_help_tab_link('question_text_info'); ?>
            </th>
            <td>
                <input type="text" class="regular-text" id="QST_display_text" name="QST_display_text"
        ...
        <tr>
            <th>
                ...
                <?php echo EEH_Template::get_help_tab_link('question_label_info'); ?>
            </th>
            <td>
                <?php
        ...
        <tr>
            <th>
                <label for="QST_admin_only"><?php echo $fields['QST_admin_only']->get_nicename(); ?></label>
                ...
                <table class="question-options-table">
                    ...
                    <tr class="question-option sample">
                        <td class="option-value-cell">
                            <input type="hidden" class="QSO_order" name="question_options[xxcountxx][QSO_order]"
                                   value="0"/>
                            <input type="text" name="question_options[xxcountxx][QSO_value]"
                                   class="option-value regular-text">
                        </td>
                        <td class="option-desc-cell">
                            <input type="text" name="question_options[xxcountxx][QSO_desc]"
                    ...
                    if (! empty($question_options)) {
                        foreach ($question_options as $option_id => $option) {
                            ...
                            <tr class="question-option ee-options-sortable">
                                <td class="option-value-cell">
                                    ...
                                    <input type="text" class="option-value regular-text"
                                           name="question_options[<?php echo $count ?>][QSO_value]"
                                           value="<?php $option->f('QSO_value') ?>"<?php echo $disabled_attr; ?>>
                                    <?php if ($has_answers) : ?>
                                        <input type="hidden" name="question_options[<?php echo $count; ?>][QSO_value]"
                                               value="<?php echo $option->f('QSO_value'); ?>">
                                    <?php endif; ?>
                                </td>
                                <td class="option-desc-cell">
                                    <input type="text" class="option-desc regular-text"
                        ...
                        <tr class="question-option ee-options-sortable">
                            <td class="option-value-cell">
                                ...
                                <input type="text" name="question_options[0][QSO_value]"
                                       class="option-value regular-text">
                            </td>
                            <td class="option-desc-cell">
                                <input type="text" name="question_options[0][QSO_desc]"
                                       class="option-desc regular-text">
                            </td>
                            <td>
                                <?php
