...
<?php printf( 
		__('Note that if you are accessing your filesystem over FTP, or SSH, logging writes to the filesystem on every request, and so you should put your credentials in your wp-config.php file, like described %1$shere.%2$s', 'event_espresso'),
