...
<?php _e('Notice: Certain options in Country Details and States/Provinces use a 1 or 0 to indicate a selection. A value of 1 equals yes. A value of 0 equals no.', 'event_espresso'); ?>
</p>
<p><strong><?php _e('Country Details', 'event_espresso'); ?></strong></p>
<p>
...
<p><strong><?php _e('States/Provinces', 'event_espresso'); ?></strong></p>
<p>
<?php _e('Define the states/provinces that are used in Event Espresso. New states / provinces can be added using the Add New State/Province field.', 'event_espresso'); ?>
</p>
<p>
<strong><?php _e('Recommendations', 'event_espresso'); ?></strong><br />
<?php _e('Want to see a tour of this screen? Click on the Countries Tour button which appears on the right side of the page. <br />To learn more about the options on this page, take a look at the different tabs that appear on the left side of the page.', 'event_espresso'); ?>
</p>
<p>
