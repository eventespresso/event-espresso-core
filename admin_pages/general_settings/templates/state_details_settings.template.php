    ...
    <tr>
        ...
        <th colspan="2">
            <span class="small-text">
                <?php esc_html_e('State Appears in<br/>Dropdown Select Lists ', 'event_espresso'); ?>
            </span>
        </th>
    </tr>
    </thead>
        ...
        <tr id="state-<?php echo $STA_ID; ?>-tr" class="country-state-columns">
            ...
            <td class="delete-state-td">
                <a id="delete-state-<?php echo $STA_ID; ?>-lnk"
                   ...
                   rel="<?php echo $STA_ID; ?>"
                   title="<?php esc_attr_e('Delete State #', 'event_espresso') . $STA_ID; ?>?"
                   href="<?php echo $state['delete_state_url']; ?>"
                >
                </a>
            </td>
        </tr>
...
<br/>
<input id="country_settings_save3"
       class="button-primary save right"
       type="submit"
       name="save"
...
<table class="form-table add-new-state-tbl">
    ...
    <tr>
        <td class="general-settings-country-state-input-td">
            ...
            <br/>
            <input id="STA_abbrev-XXX"
                   class="STA_abbrev mid-text "
                   type="text"
                   title=""
                   value=""
                   name="STA_abbrev_XXX"
        ...
        <td class="general-settings-country-state-input-td">
            ...
            <br/>
            <input id="STA_name-XXX"
                   class="STA_name regular-text "
                   type="text"
                   title=""
                   value=""
                   name="STA_name_XXX"
    ...
    <tr>
        <td colspan="2">
            <input type="submit"
                   ...
                   class="secondary-button button right"
