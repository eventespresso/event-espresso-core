...
<div class="padding">
            ...
            <tr <?php echo isset($_REQUEST['license_key']) && $_REQUEST['license_key'] == true ? 'class="yellow_alert"'
                ...
                <th>
                    <label for="site_license_key">
                        ...
                        <?php echo EEH_Template::get_help_tab_link(
                            'site_license_key_info'
                        ); ?>
                    </label>
                </th>
                <td>
                    <input name="site_license_key" id="site_license_key" size="10" class="regular-text" type="text"
                           value="<?php echo esc_attr($site_license_key); ?>"/><?php echo $site_license_key_verified; ?>
                    <br/>
                    <p class="description">
                        <?php printf(
                            __(
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <input class="regular-text" type="text" name="organization_name"
                       value="<?php echo esc_textarea($organization_name); ?>"/>
                <p class="description">
        ...
        <tr>
            ...
            <td>
                <input class="regular-text" type="text" name="organization_address_1"
                       value="<?php echo esc_textarea($organization_address_1); ?>"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input class="regular-text" type="text" name="organization_address_2"
                       value="<?php echo esc_textarea($organization_address_2); ?>"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input id="organization_city" class="regular-text" type="text" name="organization_city"
                       value="<?php echo esc_textarea($organization_city); ?>"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input class="regular-text" type="text" name="organization_zip" size="10"
                       value="<?php echo esc_textarea($organization_zip); ?>"/>
            </td>
        </tr>
        <tr>
            <th>
            ...
            <td>
                <input class="regular-text" type="text" name="organization_email"
        ...
        <tr>
            ...
            <td>
                <input class="regular-text" type="text" name="organization_phone"
                       value="<?php echo esc_textarea($organization_phone); ?>"/>
                <p class="description">
        ...
        <tr>
            ...
            <td>
                <input class="regular-text" type="text" name="organization_vat"
                       value="<?php echo esc_textarea($organization_vat); ?>"/>
                <p class="description">
    ...
    <h2 class="ee-admin-settings-hdr">
        <?php _e('Company Logo', 'event_espresso'); ?><?php echo EEH_Template::get_help_tab_link(
            'organization_logo_info'
        ); ?>
    </h2>
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <input id="upload_image" type="text" class="regular-text" name="organization_logo_url"
                       value="<?php echo esc_textarea($organization_logo_url) ?>"/>
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <input placeholder="facebook.com/profile.name" id="organization_facebook" type="text"
                       class="regular-text" name="organization_facebook"
                       value="<?php echo esc_url($organization_facebook) ?>"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input placeholder="twitter.com/twitterhandle" id="organization_twitter" type="text"
                       class="regular-text" name="organization_twitter"
                       value="<?php echo esc_url($organization_twitter) ?>"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input placeholder="linkedin.com/in/profilename" id="organization_linkedin" type="text"
                       class="regular-text" name="organization_linkedin"
                       value="<?php echo esc_url($organization_linkedin) ?>"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input placeholder="pinterest.com/profilename" id="organization_pinterest" type="text"
                       class="regular-text" name="organization_pinterest"
                       value="<?php echo esc_url($organization_pinterest) ?>"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input placeholder="google.com/+profileName" id="organization_google" type="text" class="regular-text"
                       name="organization_google" value="<?php echo esc_url($organization_google) ?>"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input placeholder="instagram.com/handle" id="organization_instagram" type="text" class="regular-text"
                       name="organization_instagram" value="<?php echo esc_url($organization_instagram) ?>"/>
            </td>
        </tr>
