...
class General_Settings_Admin_Page extends EE_Admin_Page {
	...
	public function template_settings_caff_features() {
		...
		$this->_template_args['preview_text'] = '<strong>'.__( 'Template Settings is a feature that is only available in the Caffeinated version of Event Espresso. Template Settings allow you to configure some of the appear options for both your Event Detail and Event List pages.', 'event_espresso' ).'<strong>';
