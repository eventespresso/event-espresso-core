...
class Event_Checkin_Help_Tour extends EE_Help_Tour
{
    ...
    {
        $this->_label = esc_html__('Event Check-in Tour', 'event_espresso');
    ...
    {
        $content = '<h3>' . esc_html__('Event Check-in', 'event_espresso') . '</h3>';
        if (isset($this->_req_data['event_id'])) {
            $content .= '<p>'
                        . esc_html__(
    ...
    {
        return '<p>' . esc_html__('View email address for a registrant.', 'event_espresso') . '</p>';
    }
    ...
    {
        return '<p>' . esc_html__('View price for ticket.', 'event_espresso') . '</p>';
    }

    protected function _txn_paid_stop()
    {
        return '<p>' . esc_html__('View if registrant has paid for ticket.', 'event_espresso') . '</p>';
    }

    protected function _txn_total_stop()
    {
        return '<p>' . esc_html__('View total amount paid.', 'event_espresso') . '</p>';
    }

    protected function _prc_name_stop()
    {
        return '<p>' . esc_html__('View type of ticket.', 'event_espresso') . '</p>';
    }
