...
class Registration_List_Table_Tips extends EE_Qtip_Config {
	...
	protected function _set_tips_array() {
		$this->_qtipsa = array(
			...
			1 => array(
				'content_id' => 'registration-status-' . EEM_Registration::status_id_pending_payment_payment,
				'target' => '.reg-status-' . EEM_Registration::status_id_pending_payment_payment,
				'content' => $this->_registration_status_legend(EEM_Registration::status_id_pending_payment_payment),
				'options' => array(
					'position' => array(
						'target' => 'mouse'
						)
	...
	private function _registration_status_legend( $status ) {
		...
		$status_array = array(
			...
			'pending_status' => array(
				'class' => 'ee-status-legend ee-status-legend-' . EEM_Registration::status_id_pending_payment_payment,
				'desc' => __('Pending Payment', 'event_espresso'),
				'status' => EEM_Registration::status_id_pending_payment_payment
				),
