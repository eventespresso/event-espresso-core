<p>
    <strong><?php esc_html_e('Event Check-In Table Column Headings', 'event_espresso'); ?></strong>
</p>
<ul>
    <li>
        <strong><?php esc_html_e('Check-In', 'event_espresso'); ?></strong>
        <br />
        <?php printf(
            esc_html__(
    ...
    <li>
        ...
        <br />
        <?php esc_html_e(
            'This is the registrant number in the group. For example, 1 of 1 means that there was a single registrant. 1 of 2 means that this registrant is the first to register of the the two registrants in the group.',
            'event_espresso'
        ); ?>
    </li>
    <li>
        <strong><?php esc_html_e('Registrations', 'event_espresso'); ?></strong>
        <br />
    ...
    <li>
        <strong><?php esc_html_e('Reg Code', 'event_espresso'); ?></strong>
        <br />
        <?php esc_html_e('This is a unique registration code for an registrant.', 'event_espresso'); ?>
    </li>
    <li>
        <strong><?php esc_html_e('Reg Status', 'event_espresso'); ?></strong>
        <br />
        <?php esc_html_e('This is the current status for a registration.', 'event_espresso'); ?>
    </li>
    <li>
        <strong><?php esc_html_e('TKT Price', 'event_espresso'); ?></strong>
        <br />
    ...
    <li>
        <strong><?php esc_html_e('TKT Option', 'event_espresso'); ?></strong>
        <br />
