<p>
    <strong><?php esc_html_e('Registrations Event Check-In', 'event_espresso'); ?></strong>
</p>
<p>
    <?php esc_html_e('This page allows you to check in registrants for an event.', 'event_espresso'); ?>
</p>
<p>
    <?php esc_html_e(
