<p>
    <strong><?php esc_html_e('Registration Filters', 'event_espresso'); ?></strong>
</p>
<p>
...
<ul>
    <li>
        <strong><?php esc_html_e('Filter by Month / Year', 'event_espresso'); ?></strong>
        <br />
        <?php esc_html_e('Show registrations that fall under a specific month and year.', 'event_espresso'); ?>
    </li>
    <li>
        <strong><?php esc_html_e('Filter by Categories', 'event_espresso'); ?></strong>
        <br />
