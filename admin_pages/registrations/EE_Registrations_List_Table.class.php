...
class EE_Registrations_List_Table extends EE_Admin_List_Table
{
    ...
    protected function _set_properties()
    {
        ...
        $DTT_ID = isset($req_data['datetime_id']) ? $req_data['datetime_id'] : $DTT_ID;
        $DTT_ID = (int) $DTT_ID;
     ...
     */
    protected function _set_related_details($registration)
    {
     ...
     * @return string
     */
    private function lockedRegMessage()
    {
        return esc_html__(
     ...
     * @throws ReflectionException
     */
    public function column_id($registration)
    {
     ...
     * @throws ReflectionException
     */
    public function column_ATT_fname($registration, $prep_content = true)
    {
     ...
     * @throws ReflectionException
     */
    public function column__REG_date($registration, $prep_content = true)
    {
     ...
     * @throws ReflectionException
     */
    public function column_event_name($registration)
    {
        $this->_set_related_details($registration);
     ...
     * @throws ReflectionException
     */
    public function column_DTT_EVT_start($registration)
    {
        $datetime_strings = [];
     ...
     * @return string
     */
    public function generateDisplayForDatetimes($datetime_strings)
    {
     ...
     * @throws ReflectionException
     */
    public function column_ATT_email($registration)
    {
     ...
     * @return string
     */
    public function column__REG_count($registration)
    {
        $content =
     ...
     * @throws ReflectionException
     */
    public function column_PRC_amount($registration)
    {
        $ticket   = $registration->ticket();
        $req_data = $this->_admin_page->get_request_data();
     ...
     * @throws ReflectionException
     */
    public function column__REG_final_price($registration)
    {
        $ticket   = $registration->ticket();
        $req_data = $this->_admin_page->get_request_data();
        $content  = isset($req_data['event_id']) || ! $ticket instanceof EE_Ticket
     ...
     * @throws EE_Error
     */
    public function column__REG_paid($registration)
    {
     ...
     * @throws ReflectionException
     */
    public function column_TXN_total($registration)
    {
     ...
     * @throws ReflectionException
     */
    public function column_TXN_paid($registration)
    {
        $content = '&nbsp;';
        $align   = 'end';
     ...
     * @throws ReflectionException
     */
    public function column_actions($registration)
    {
     ...
     * @return string
     */
    private function viewRegistrationUrl(EE_Registration $registration)
    {
     ...
     * @return string
     */
    private function viewRegistrationAction(EE_Registration $registration)
    {
        return $this->caps_handler->userCanReadRegistration($registration)
            ? '
            <a  href="' . $this->viewRegistrationUrl($registration) . '"
     ...
     * @return string
     */
    private function editContactAction(EE_Registration $registration, $attendee = null)
    {
     ...
     * @return string
     */
    private function viewTransactionUrl()
    {
        return EE_Admin_Page::add_query_args_and_nonce(
            [
     ...
     * @return string
     */
    private function viewTransactionAction()
    {
     ...
     * @return string
     */
    private function viewNotificationsAction(EE_Registration $registration)
    {
     ...
     * @return string
     */
    private function editEventLink($EVT_ID, $event_name)
    {
        $EVT_ID = (int) $EVT_ID;
     ...
     * @return string
     */
    private function eventFilterLink($EVT_ID, $event_name)
    {
        $EVT_ID = (int) $EVT_ID;
        $event_name = (string) $event_name;
        if (!$EVT_ID) {
