<div id="admin-primary-mbox-questions-dv" class="admin-primary-mbox-dv">
	<p><?php _e('This displays the custom questions and answers for this attendee.  Please note that any answers to system questions have been saved with the attendee record.  You can edit those answers via the "View/Edit this Attendee" link in the Attendee Details metabox in the sidebar.', 'event_espresso'); ?></p>
