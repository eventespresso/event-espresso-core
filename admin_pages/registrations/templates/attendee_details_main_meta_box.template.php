...
<div style="padding:1em;">
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            <th>
                <label for="ATT_fname"><?php _e('First Name', 'event_espresso'); ?><span
        ...
        <tr valign="top">
            <th>
                <label for="ATT_lname"><?php _e('Last Name', 'event_espresso'); ?><span
                        class="denotes-required-spn">*</span></label>
            </th>
            <td>
                <div class="validation-notice-dv">
        ...
        <tr valign="top">
            <th>
                <label for="ATT_email"><?php _e('Email Address', 'event_espresso'); ?><span
                        class="denotes-required-spn">*</span></label>
            </th>
            <td>
                <div class="validation-notice-dv">
