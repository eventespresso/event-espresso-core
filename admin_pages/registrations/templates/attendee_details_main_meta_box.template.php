...
<div style="padding:1em;">
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            <th>
                <label for="ATT_fname"><?php esc_html_e('First Name', 'event_espresso'); ?><span
                        class="denotes-required-spn">*</span></label>
            </th>
            <td>
        ...
        <tr valign="top">
            <th>
                <label for="ATT_lname"><?php esc_html_e('Last Name', 'event_espresso'); ?><span
                        class="denotes-required-spn">*</span></label>
            </th>
            <td>
                <div class="validation-notice-dv">
        ...
        <tr valign="top">
            <th>
                <label for="ATT_email"><?php esc_html_e('Email Address', 'event_espresso'); ?><span
                        class="denotes-required-spn">*</span></label>
            </th>
            <td>
                <div class="validation-notice-dv">
        ...
        <tr valign="top">
            ...
            <td>
                <input class="regular-text" type="text" id="ATT_phone" name="ATT_phone"
        ...
        <tr valign="top">
            ...
            <td>
                <input class="regular-text" type="text" id="ATT_address" name="ATT_address"
                       value="<?php echo $attendee->address(); ?>"/>
                <br/>
                <input class="regular-text" type="text" id="ATT_address2" name="ATT_address2"
                       value="<?php echo $attendee->address2(); ?>"/>
                <br/>
                <p class="description"><?php esc_html_e('The registrant\'s street address.', 'event_espresso'); ?></p>
            </td>
        </tr>
        ...
        <tr valign="top">
            ...
            <td>
                <input class="regular-text" type="text" id="ATT_city" name="ATT_city"
                       value="<?php echo $attendee->city(); ?>"/>
            </td>
        </tr>
        ...
        <tr valign="top">
            ...
            <td>
                <input class="medium-text" type="text" id="ATT_zip" name="ATT_zip"
