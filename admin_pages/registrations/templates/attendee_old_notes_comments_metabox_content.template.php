	...
	<tbody>
		<tr valign="top">
			<td>
				...
				<p class="description"><?php _e('Comments from the contact regarding your events, services, etc collected via forms, emails, etc.', 'event_espresso'); ?></p>
			</td>						
		</tr>
		<tr valign="top">
			<td>
				...
				<p class="description"><?php _e('A place for you to keep any notes pertaining to this contact, their preferences, special circumstances, etc.', 'event_espresso'); ?></p>
			</td>							
		</tr>
	</tbody>
</table>