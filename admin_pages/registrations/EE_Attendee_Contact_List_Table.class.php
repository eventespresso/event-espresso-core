...
class EE_Attendee_Contact_List_Table extends EE_Admin_List_Table
{
     ...
     * @throws ReflectionException
     */
    public function column_id($attendee)
    {
        $content = '
     ...
     * @throws ReflectionException
     */
    public function column_ATT_lname($attendee)
    {
        // edit attendee link
     ...
     * @since   $VID:$
     */
    private function editAttendeeLink($ID, $attendee_name)
    {
        $ID = (int) $ID;
     ...
     * @throws ReflectionException
     */
    public function column_ATT_fname($attendee)
    {
        // Build row actions
        $actions = [];
        // edit attendee link
     ...
     * @throws EE_Error
     */
    public function column_ATT_email($attendee)
    {
     ...
     * @throws ReflectionException
     */
    public function column_Registration_Count($attendee)
    {
     ...
     * @throws EE_Error
     */
    public function column_ATT_address($attendee)
    {
     ...
     * @throws EE_Error
     */
    public function column_ATT_city($attendee)
    {
     ...
     * @throws ReflectionException
     */
    public function column_STA_ID($attendee)
    {
     ...
     * @throws ReflectionException
     */
    public function column_CNT_ISO($attendee)
    {
     ...
     * @throws EE_Error
     */
    public function column_ATT_phone($attendee)
    {
