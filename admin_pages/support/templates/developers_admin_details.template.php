<div class="padding">
	...
	<ul>
		...
		<li><a href="http://developer.eventespresso.com/docs/ee4-rest-api-reading/?ee_ver=ee4&utm_source=ee4_plugin_admin&utm_medium=link&utm_campaign=ee_support_page&utm_content=developers_tab" target="_blank">REST API: Reading Data</a></li>
		<li>REST API: Writing Data (coming soon)</li>
		<li><a href="https://eventespresso.com/2014/03/messages-systemyour-tool-getting-word/?ee_ver=ee4&utm_source=ee4_plugin_admin&utm_medium=link&utm_campaign=ee_support_page&utm_content=developers_tab" target="_blank">Building an EE4 Addon Using the REST API</a></li>
	</ul>
</div>