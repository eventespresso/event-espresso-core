...
<h3 class="wp-people-group"><?php _e('Founders', 'event_espresso'); ?></h4>
...
<h3 class="wp-people-group"><?php _e('Core Developers', 'event_espresso'); ?></h4>
...
<h3 class="wp-people-group"><?php _e('Support Staff', 'event_espresso'); ?></h4>
...
<h3 class="wp-people-group"><?php _e('Contributor Recognition', 'event_espresso'); ?></h4>
<p class="description">
...
<h3 class="wp-people-group"><?php _e('External Libraries', 'event_espresso'); ?></h4>
<p class="description">
