...
<p>See what people have to say about the Event Espresso software and support services on
    ...
    ,
    <a href="http://evts.io/EEDecafReviews" target="_blank" rel="noopener noreferrer">WordPress.org</a>
    and
    <a href="https://eventespresso.com/about/testimonials/">EventEspresso.com</a>
    :
</p>
<div class="feature-section ee-card-grid ee-card-grid-3-cols">

    <div class='ee-card ee-card__review'>
        <h3>
            ...
            <p class="review-user-nicename">
                ...
                >
                    <img alt=""
                         ...
                         class="avatar avatar-100 photo no-round"
                         width="100"
                         height="100"
                    >
                </a>
    ...
    <div class='ee-card ee-card__review'>
        <h3>
            <a href='https://wordpress.org/support/topic/excellent-event-plugin-3/'>Excellent Event Plugin</a>
        </h3>
        <?php echo espressoFiveStars(); ?>
        <div class="review-body">
            <p class="review-user-nicename">
    ...
    <div class="ee-card ee-card__review">
        <h3>
            <a href="https://wordpress.org/support/topic/event-espresso-to-the-max/">Event Espresso to the MAX!</a>
        </h3>
        <?php echo espressoFiveStars(); ?>
        <div class="review-body">
            <p class="review-user-nicename">
