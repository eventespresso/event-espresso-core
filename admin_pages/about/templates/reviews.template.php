...
<p><?php
    ...
    <div class="feature-section col has-3-columns is-fullwidth three-col about-updates">
                ...
                <li class="review-body">
                    <div class="eventopic type-topic status-publish hentry">
                        <div class="review-topic-content">
                            <p class="review-user-nicename"><a href="https://wordpress.org/support/users/sock2me/"
                                                               title="View sock2me's profile" class="bbp-author-avatar"
                            ...
                            <p>I started using EE many years ago and we still use it everyday to run our school at <a
                                ...
                                the community for feedback.</p>
                            <p>I highly recommend Event Espresso if you are looking to offer events, classes or really
                                anything that you need to sell seats for. It’s not perfect, but what plugin is? The fact
                                that we can get so much accomplished using this tool is amazing. </p>
            ...
            <ul>
                <li class="review-body">
                    <div class="even topic type-topic status-publish hentry">
                        <div class="review-topic-content">
                            <p class="review-user-nicename"><a href="https://wordpress.org/support/users/ivycat/"
                                                               title="View ivycat's profile" class="bbp-author-avatar"
                                                               rel="nofollow"><img alt=""
                                                                                   ...
                                                                                   class="avatar avatar-100 photo"
                                                                                   width="100" height="100"></a><br><a
                                    href="https://wordpress.org/support/users/ivycat/" title="View ivycat's profile"
                                    class="bbp-author-name" rel="nofollow">ivycat</a></p>
                            <p>We&#8217;ve been using and developing sites powered by Event Espresso for several years
                                now. Event Espresso is our go-to for Event Management on WordPress for several
                                reasons:</p>
                            <ol>
                                <li>The team behind the plugin provides outstanding support and are clearly committed to
                                    improving the state of Event Management on WordPress.
                                </li>
                                <li>It&#8217;s a solid plugin with a robust codebase and APIs</li>
                                <li>It&#8217;s capable and flexible &#8211; we&#8217;ve used it for everything from
        ...
        <div class="column col-3 last-feature">
            ...
            <ul>
                <li class="review-body">
                    <div class="even topic type-topic status-publish hentry">
                        <div class="review-topic-content">
                            <p class="review-user-nicename"><a href="https://wordpress.org/support/users/amandaleigh/"
                                    ...
                                    title="View amandaleigh's profile" class="bbp-author-name" rel="nofollow">amandaleigh</a>
                            </p>
                            <p>We just closed registration for a girls/ladies conference at our church next month. This
                                ...
                                Registrants stated that it was much easier to use than in previous years.</p>
                        </div><!-- .review-topic-content -->
                    </div>
                </li><!-- .review-body -->
            </ul>
        ...
        <div class="column col-1">
            ...
            <ul>
                <li class="review-body">
                    <div class="even topic type-topic status-publish hentry">
                        <div class="review-topic-content">
                            <p class="review-user-nicename"><a href="https://wordpress.org/support/users/birchfinch/"
                                                               title="View Bryan's profile" class="bbp-author-avatar"
                                                               rel="nofollow"><img alt=""
                                                                                   ...
                                                                                   class="avatar avatar-100 photo"
                                                                                   width="100" height="100"></a><br><a
                                    href="https://wordpress.org/support/users/birchfinch/" title="View Bryan's profile"
                                    class="bbp-author-name" rel="nofollow">Bryan</a></p>
                            <p>We&#8217;ve been using Event Espresso for just over a year now, for the <a
                                    href="https://duluthfolkschool.com/" rel="nofollow">Duluth Folk School</a>.</p>
                            <p>EE has a lot of customisability, and solid customer payment options. For us, we bought
                                the &#8216;all the add ons&#8217; option, since we&#8217;re using quite a few different
                                add ons.</p>
                            <p>I do wish it were easier to customize some of the deeply buried text (EE calls them
                                ...
                                class).</p>
                            <p>Overall, it does a good job, and our customers have a pretty easy time figuring it all
                                out. </p>
                        </div><!-- .review-topic-content -->
                    </div>
                </li><!-- .review-body -->
        ...
        <div class="column col-2">
            ...
            <ul>
                <li class="review-body">
                    <div class="even topic type-topic status-publish hentry">
                        <div class="review-topic-content">
                            <p class="review-user-nicename"><a href="https://wordpress.org/support/users/elainewildash/"
                                                               ...
                                                               class="bbp-author-avatar" rel="nofollow"><img alt=""
                                                                                                             ...
                                                                                                             width="100"
                                                                                                             height="100"></a><br><a
                                    href="https://wordpress.org/support/users/elainewildash/"
                                    title="View elaine.wildash's profile" class="bbp-author-name" rel="nofollow">elaine.wildash</a>
                            </p>
                            <p>Event Espresso was easy to setup and is easy to use. It’s also easy to style for
                            ...
                            <p>The support staff have always been very helpful and will work with you when there are
        ...
        <div class="column col-3 last-feature">
            ...
            <ul>
                <li class="review-body">
                    <div class="even topic type-topic status-publish hentry">
                        <div class="review-topic-content">
                            <p class="review-user-nicename"><a href="https://wordpress.org/support/users/rhj4/"
                                                               title="View rhj4's profile" class="bbp-author-avatar"
                                                               rel="nofollow"><img alt=""
                                                                                   ...
                                                                                   class="avatar avatar-100 photo"
                                                                                   width="100" height="100"></a><br><a
                                    href="https://wordpress.org/support/users/rhj4/" title="View rhj4's profile"
                                    class="bbp-author-name" rel="nofollow">rhj4</a></p>
                            <p>I did a pretty exhaustive review of WordPress event management plugins and settled on
                                Event Espresso for two reasons:</p>
                            <ol>
        ...
        <div class="column col-1">
            ...
            <ul>
                <li class="review-body">
                    <div class="even topic type-topic status-publish hentry">
                        <div class="review-topic-content">
                            <p class="review-user-nicename"><a href="https://wordpress.org/support/users/wooninjas/"
                                    ...
                                    title="View Wooninjas's profile" class="bbp-author-name"
                                    rel="nofollow">Wooninjas</a></p>
                            <p>With 50+ features including multiple ticketing to Attendee Management and Events
        ...
        <div class="column col-2">
            ...
            <ul>
                <li class="review-body">
                    <div class="even topic type-topic status-publish hentry">
                        <div class="review-topic-content">
                            <p class="review-user-nicename"><a href="https://wordpress.org/support/users/johnmacek/"
                                    ...
                                    title="View johnmacek's profile" class="bbp-author-name"
                                    rel="nofollow">johnmacek</a></p>
                            <p>I researched a number of Event Ticketing plugins and Event Espresso was the only one that
                                ...
                                now I use the forums when I need help.</p>
                        </div><!-- .review-topic-content -->
                    </div>
                </li><!-- .review-body -->
            </ul>
        ...
        <div class="column col-3 last-feature">
            ...
            <ul>
                <li class="review-body">
                    <div class="even topic type-topic status-publish hentry">
                        <div class="review-topic-content">
                            <p class="review-user-nicename"><a href="https://wordpress.org/support/users/10bradders10/"
                                                               ...
                                                               class="bbp-author-avatar" rel="nofollow"><img alt=""
                                                                                                             ...
                                                                                                             width="100"
                                                                                                             height="100"></a><br><a
                                    href="https://wordpress.org/support/users/10bradders10/"
                                    title="View 10bradders10's profile" class="bbp-author-name" rel="nofollow">10bradders10</a>
                            </p>
                            <p>After using Event Espresso for several years, this is still the best event registration
                                ...
                                forward to their next set of enhancements this year!</p>
                        </div><!-- .review-topic-content -->
                    </div>
                </li><!-- .review-body -->
            </ul>
