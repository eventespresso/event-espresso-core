...
<div class="changelog">
    ...
    <p>This release brings many improvements to existing core features and a few new features, such as duplicate events,
        iCal integration, batch email/newsletter system, and registration form optimizations.
    </p>
    ...
    <ul>
        <li>
            <a href="https://eventespresso.com/wiki/create-ticket-bundle/" target="_blank">Ticket Bundles</a>
            Starting with Event Espresso 4.3 you can offer discount pricing based on ticket quantities.
            <a href="https://eventespresso.com/wiki/create-ticket-bundle/" target="_blank">
                This article
            </a>
            shows how to create a ticket bundle where you can set a lower price per ticket when purchased in a bundle.
        </li>
        <li>
            <a href="https://eventespresso.com/wiki/set-graduated-ticket-pricing/" target="_blank">
                Graduated Ticket Pricing
            </a>
            Starting with Event Espresso 4.3 you can offer graduated pricing based on ticket quantities.
            <a href="https://eventespresso.com/wiki/set-graduated-ticket-pricing/" target="_blank">
                This article
            </a>
    ...
    <p>
        <a href="https://eventespresso.com/wp-content/uploads/2014/05/acf-home-panel-fields.png">
            <strong>Advanced Custom Fields Integration</strong>
        </a>
        <br>
        Fully customize WordPress edit screens with powerful custom fields.
    </p>
    <ul>
        <li>
            <a href="https://eventespresso.com/2014/05/developers-corner-using-advanced-custom-fields-extend-ee4/"
               target="_blank"
            >Developers Corner: Using Advanced Custom Fields to Quickly Extend EE4
            </a>
        </li>
        <li>
            <a href="https://eventespresso.com/wiki/add-course-curriculum-events-using-advanced-custom-fields/"
               target="_blank"
            >Add a Course Curriculum Section to the “Thank You” Page Using Advanced Custom Fields
            </a>
        </li>
        <li>
            <a href="https://eventespresso.com/wiki/add-sponsors-section-events-using-advanced-custom-fields/"
               target="_blank"
            >Add a Sponsors Section to Events Using Advanced Custom Fields
            </a>
        </li>
        <li>
            <a href="https://eventespresso.com/wiki/ee4-thank-page-actions-filters-hooks/" target="_blank">
                EE4 “Thank You” Page Actions &amp; Filters
            </a>
        </li>
        <li>
            <a href="https://eventespresso.com/wiki/ee4-single-page-checkout-page-actions-filters/" target="_blank">
