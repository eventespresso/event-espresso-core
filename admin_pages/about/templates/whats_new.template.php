...
<h3>Calendar Add-on for EE 4.2+</h3>
<a href="http://ee-screenshots.s3.amazonaws.com/ee4/ee4-calendar-3-0.jpg"><img class="alignright" alt="calendar-large" src="http://ee-screenshots.s3.amazonaws.com/ee4/ee4-calendar-3-0.jpg" width="258" height="352" /></a>
<p>Announcing the ability to integrate with <strong>over 90 different gateways and payment providers</strong>, using the Mijireh Checkout system! <a href="http://www.mijireh.com/" target="_blank">Mijireh Checkout</a> is a PCI compliant checkout page that looks exactly like your site, with support for over 90 gateways and payment providers to use on Mijireh's <a href="http://www.mijireh.com/docs/payment-gateways/" target="_blank">secure PCI compliant servers</a>. (see the Payment Settings inside EE 4.2).</p>

<p>The events calendar allow you to display your events in a way that customers are familiar with, gives you another page of your website or another way for customers to find your events, and allows you to invite attendees to add the events to their own calendars as a friendly reminder.</p>

<p>The first version the the Calendar Add-on for EE4 is available in the <a href="http://eventespresso.com/wiki/pre-release-channel-guide/">Pre-release Channel</a> on your account.</p>
