...
<div class="ee-card-grid">
    ...
    <div class="ee-card ee-add-on-card">
        ...
        <p>
            <a class='ee-add-on-card-img'
               href="https://eventespresso.com/product/eea-promotions/?ee_ver=ee4&utm_source=ee4_plugin_admin&utm_medium=link&utm_campaign=other_services_tab&utm_content=promtions_addon_link&ap_id=EEspresso"
               target="_blank"
            >
    ...
    <div class="ee-card ee-add-on-card">
        ...
        <p>
            <a class='ee-add-on-card-img'
               href="https://eventespresso.com/product/eea-paypal-smart-buttons/?utm_source=ee4_plugin_admin
               &utm_medium=link&utm_campaign=other_services_tab&utm_content=paypal_smart_buttons_add_on&ap_id=EEspresso"
               target="_blank"
            >
