		...
		$caps =  array(
			...
			**/
			...
			//prices
				...
				'ee_read_others_default_prices',
				'ee_read_others_default_price_types',
				'ee_edit_default_price',
				'ee_edit_default_prices',
				'ee_edit_default_price_type',
				'ee_edit_default_price_types',
				'ee_edit_others_default_prices',
				'ee_edit_others_default_price_types',
				'ee_delete_default_price',
				'ee_delete_default_prices',
				'ee_delete_default_price_type',
				'ee_delete_default_price_types',
				'ee_delete_others_default_prices',
				'ee_delete_others_default_price_types',
			//registration form
				'ee_edit_question',
				'ee_edit_questions',
				'ee_edit_system_questions',
				'ee_edit_others_questions',
				'ee_read_questions',
				'ee_read_others_questions',
				'ee_delete_question',
				'ee_delete_questions',
				'ee_delete_others_questions',
				'ee_edit_question_group',
				'ee_edit_question_groups',
				'ee_edit_others_question_groups',
				'ee_read_question_groups',
				'ee_read_others_question_groups',
