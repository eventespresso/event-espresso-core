...
final class EE_Capabilities extends EE_Base
{
     ...
     * @since 4.9.42
     */
    public function addCaps($capabilities_to_add)
    {
     ...
     * @since 4.5.0
     */
    public function get_ee_capabilities($role = EE_Capabilities::ROLE_ADMINISTRATOR)
    {
        if (! $this->initialized) {
            $this->init_caps();
        }
        ...
        return isset($this->capabilities_map[ $role ]) ? $this->capabilities_map[ $role ] : [];
    }
     ...
     * @deprecated 4.9.42
     */
    public function init_role_caps($reset = false, $caps_map = [])
    {
...
abstract class EE_Meta_Capability_Map
{
     ...
     *
     */
    public function __construct($meta_cap, array $map_values)
    {
        $meta_cap = (string) $meta_cap;
