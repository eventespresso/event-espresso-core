...
class EE_Dependency_Map
{
     ...
     */
    public static function instance($class_cache = null)
    {
     ...
     */
    public function setLegacyRequest($legacy_request)
    {
     ...
     * @throws DomainException
     */
    public function registerClassLoader($class_name, $loader = 'load_core', $overwrite = false)
    {
