	 ...
	 */
	 public static function espresso_data_collection_optin_text( $extra = true ) {
	 	if ( ! $extra ) {
			...
			printf( esc_html__( 'The Event Espresso UXIP feature is active on your site. For %smore info%s and to opt-out %sclick here%s.', 'event_espresso' ), '<a href="https://eventespresso.com/about/user-experience-improvement-program-uxip/" target="_blank">', '</a>', '<a href="' . $settings_url . '" target="_blank">', '</a>' );
		}
	}
