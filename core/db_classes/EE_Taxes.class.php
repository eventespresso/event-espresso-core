...
class EE_Taxes extends EE_Base
{
     ...
     */
    public static function get_total_taxes_for_admin($ticket)
    {
        $tax = 0;
        $total_tax = 0;
     ...
     * @throws ReflectionException
     */
    public static function get_subtotal_for_admin($ticket)
    {
        $TKT_ID = $ticket->ID();
        return isset(EE_Taxes::$_subtotal[ $TKT_ID ]) ? EE_Taxes::$_subtotal[ $TKT_ID ] : EE_Taxes::_get_subtotal_for_admin($ticket);
    }
