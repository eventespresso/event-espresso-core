...
class EE_Ticket extends EE_Soft_Delete_Base_Class implements EEI_Line_Item_Object, EEI_Event_Relation, EEI_Has_Icon
{
     ...
     * @since   $VID:$
     */
    public function usesGlobalTaxes()
    {
        return $this->taxable();
    }
     ...
     * @since 4.9.80.p
     */
    protected function increaseSoldForDatetimes($qty, $datetimes = [])
    {
     ...
     * @since 4.9.80.p
     */
    protected function decreaseSoldForDatetimes($qty = 1, $datetimes = [])
    {
        $datetimes = ! empty($datetimes) ? $datetimes : $this->datetimes();
     ...
     * @since 4.9.80.p
     */
    protected function increaseReservedForDatetimes($qty = 1, $datetimes = [])
    {
        $datetimes         = ! empty($datetimes) ? $datetimes : $this->datetimes();
        $datetimes_updated = [];
     ...
     * @since 4.9.80.p
     */
    protected function decreaseReservedForDatetimes($qty = 1, $datetimes = [])
    {
        $datetimes = ! empty($datetimes) ? $datetimes : $this->datetimes();
        foreach ($datetimes as $datetime) {
            if ($datetime instanceof EE_Datetime) {
