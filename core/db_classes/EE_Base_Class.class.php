...
abstract class EE_Base_Class
{
     ...
     * single related model object. see the model's _model_relations. The keys should match those specified. And if the
    ...
    public function get_original($field_name)
    {
        if (isset($this->_props_n_values_provided_in_constructor[$field_name])
            && $field_settings = $this->get_model()
                                      ->field_settings_for($field_name)
        ) {
