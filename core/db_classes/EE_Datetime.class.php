...
class EE_Datetime extends EE_Soft_Delete_Base_Class{
	...
	*/	
	public function time_range( $tm_format = NULL, $conjunction = ' - ' ) {
		return str_replace( ' ', '&nbsp;', date_i18n( $tm_frmt, strtotime( $this->_show_datetime( 'T', 'start', NULL, NULL )))) . $conjunction . str_replace( ' ', '&nbsp;', date_i18n( $tm_frmt, strtotime( $this->_show_datetime( 'T', 'end', NULL, NULL ))));
