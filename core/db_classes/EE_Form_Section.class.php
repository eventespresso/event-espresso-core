...
class EE_Form_Section extends EE_Base_Class
{
     ...
     * @throws ReflectionException
     */
    public function appliesToRegistrant($registrant)
    {
     ...
     * @throws ReflectionException
     */
    public function setAppliesTo($user_type)
    {
     ...
     * @throws ReflectionException
     */
    public function setBelongsTo($parent_UUID)
    {
     ...
     * @throws ReflectionException
     */
    public function filterFormElements($all_form_elements)
    {
        return array_filter($all_form_elements, ($this->formElementFilter() === null ? function ($v, $k) {
            return !empty($v);
        } : $this->formElementFilter()) === null ? function ($v, $k) {
            return !empty($v);
        } : ($this->formElementFilter() === null ? function ($v, $k) {
            return !empty($v);
        } : $this->formElementFilter()), ($this->formElementFilter() === null ? function ($v, $k) {
            return !empty($v);
        } : $this->formElementFilter()) === null ? ARRAY_FILTER_USE_BOTH : ($this->formElementFilter() === null ? ARRAY_FILTER_USE_BOTH : 0));
    }
     ...
     * @throws ReflectionException
     */
    public function formElementFilter()
    {
     ...
     * @throws ReflectionException
     */
    public function isTopLevelFormSection()
    {
