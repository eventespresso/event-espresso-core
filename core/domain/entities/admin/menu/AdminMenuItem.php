...
abstract class AdminMenuItem
{
    ...
    const DISPLAY_BLOG_ONLY        = 1;

    const DISPLAY_BLOG_AND_NETWORK = 2;

    const DISPLAY_NETWORK_ONLY     = 3;

    const TYPE_MENU_TOP           = 'top';

    const TYPE_MENU_GROUP          = 'group';

    const TYPE_MENU_SUB_ITEM       = 'sub-item';
     ...
     * @since  4.4.0
     */
    abstract protected function registerMenuItem();
     ...
     * @return string
     */
    public function registerAdminMenuItem($network_admin = false)
    {
        ...
        if (
            ...
            throw new InvalidArgumentException(
                sprintf(
                    ...
                    print_r(isset($menu_args['admin_init_page']) ? $menu_args['admin_init_page'] : null, true)
                )
            );
        }
    }
     ...
     * @return bool
     */
    public function displayOnBlogAdmin($network_admin)
    {
     ...
     * @return bool
     */
    public function displayOnBlogAndNetworkAdmin()
    {
     ...
     * @return bool
     */
    public function displayOnNetworkAdmin($network_admin)
    {
     ...
     * @return string
     */
    public function maintenanceModeParent()
    {
     ...
     * @return void
     */
    public function setMaintenanceModeParent($maintenance_mode_parent)
    {
     ...
     * @return void
     */
    public function setMenuCallback($menu_callback)
    {
     ...
     * @return void
     */
    public function setMenuGroup($menu_group)
    {
     ...
     * @return int
     */
    public function showOnMaintenanceModeMenu()
    {
     ...
     * @return void
     */
    public function setShowOnMenu($show_on_menu)
    {
        $valid_menu_options = [
