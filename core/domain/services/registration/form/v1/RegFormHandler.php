...
class RegFormHandler
{
     ...
     */
    public function processRegistrations($registrations, $reg_form_data)
    {
     ...
     * @return bool
     */
    private function isValidRegUrlLink($reg_url_link)
    {
        $reg_url_link = (string) $reg_url_link;
     ...
     * @return bool
     */
    private function isValidRegistration($registration)
    {
        // verify EE_Registration object
     ...
     * @throws ReflectionException
     */
    private function processRegFormData(EE_Registration $registration, $reg_url_link, array $reg_form_data)
    {
        $reg_url_link = (string) $reg_url_link;
        if (isset($reg_form_data[ $reg_url_link ])) {
            ...
            if (isset($reg_form_data['primary_attendee'])) {
                $primary_reg_url_link = isset($reg_form_data['primary_attendee']) ? $reg_form_data['primary_attendee'] : '';
