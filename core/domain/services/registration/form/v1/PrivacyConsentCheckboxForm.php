...
class PrivacyConsentCheckboxForm extends EE_Form_Section_Proper
{
     ...
     * @throws EE_Error
     */
    public function __construct($reg_step_slug, $consent_checkbox_label_text)
    {
        $reg_step_slug = (string) $reg_step_slug;
        $consent_checkbox_label_text = (string) $consent_checkbox_label_text;
        parent::__construct(
            [
                'layout_strategy' =>
