...
class DatetimeToJson implements ModelObjectToJsonConverterInterface
{
     ...
     * @since $VID:$
     */
    public function convertAndEncodeArrayOf($datetimes)
    {
        $jsonDates = [];
     ...
     * @since $VID:$
     */
    public function convertArrayOf($datetimes)
    {
        $arrayOfDates = [];
        foreach ($datetimes as $datetime) {
            if ($datetime instanceof EE_Datetime) {
     ...
     * @since $VID:$
     */
    public function encodeArrayOf($datetimes)
    {
        $jsonDates = [];
        foreach ($datetimes as $datetime) {
            if ($datetime instanceof EE_Datetime) {
     ...
     * @since $VID:$
     */
    public function encode($datetime_array)
    {
