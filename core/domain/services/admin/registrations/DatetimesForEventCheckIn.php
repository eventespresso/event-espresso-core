...
class DatetimesForEventCheckIn
{
     ...
     */
    public function __construct(EE_Capabilities $capabilities, $event = null)
    {
        $this->event             = $event;
     ...
     * @throws ReflectionException
     */
    public function getAllDatetimesForAllEvents()
    {
     ...
     * @throws ReflectionException
     */
    public function getAllDatetimesForEvent($hide_expired = false, $hide_upcoming = false)
    {
