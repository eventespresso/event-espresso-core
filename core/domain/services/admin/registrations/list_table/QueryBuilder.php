...
class QueryBuilder
{
    ...
    protected function addCategoryIdToWhereConditions()
    {
        ...
        $EVT_CAT = isset($this->filters['EVT_CAT']) ? $this->filters['EVT_CAT'] : $EVT_CAT;
        $EVT_CAT = (int) $EVT_CAT;
        if ($EVT_CAT > 0) {
    ...
    protected function addDatetimeIdToWhereConditions()
    {
        ...
        $DTT_ID = isset($this->filters['datetime_id']) ? $this->filters['datetime_id'] : $DTT_ID;
        $DTT_ID = (int) $DTT_ID;
    ...
    protected function addTicketIdToWhereConditions()
    {
        ...
        $TKT_ID = isset($this->filters['ticket_id']) ? $this->filters['ticket_id'] : $TKT_ID;
        $TKT_ID = (int) $TKT_ID;
    ...
    protected function addRegistrationStatusToWhereConditions()
    {
        ...
        $registration_status = isset($this->filters['_reg_status']) ? $this->filters['_reg_status'] : $registration_status;
    ...
    protected function addDateToWhereConditions()
    {
        ...
        $month_range = isset($this->filters['month_range']) ? $this->filters['month_range'] : $month_range;
        if ($month_range) {
