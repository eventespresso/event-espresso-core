...
class DefaultPrices implements DefaultEntityGeneratorInterface
{
    ...
    public function create($entity)
    {
        ...
        list($has_base_price, $is_free) = $this->cloneDefaultPrices(
            $entity,
            $default_prices,
     ...
     * @throws ReflectionException
     */
    private function applyTaxes(EE_Ticket $ticket, $is_free)
    {
    ...
    private function cloneDefaultPrices(
        ...
        $remove_existing_relations = (bool) $remove_existing_relations;
        $has_base_price = (bool) $has_base_price;
        $is_free = (bool) $is_free;
     ...
     * @throws ReflectionException
     */
    private function createNewBasePrice(EE_Ticket $ticket)
    {
     ...
     * @throws ReflectionException
     */
    private function separateTaxesFromOtherPrices(array $prices = [])
    {
        $default_prices = [];
        if (is_array($prices)) {
