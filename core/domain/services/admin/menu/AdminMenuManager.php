...
class AdminMenuManager
{
     ...
     */
    public function getAdminMenu($admin_page_init)
    {
     ...
     */
    private function instantiateAdminMenu(array $menu_properties)
    {
        $type = isset($menu_properties['menu_type']) ? $menu_properties['menu_type'] : AdminMenuItem::TYPE_MENU_GROUP;
     ...
     */
    private function getMenuGroup(AdminMenuItem $admin_menu)
    {
     ...
     */
    public function generateAdminMenu($network_admin = false)
    {
     ...
     * @param bool  $network_admin
     */
    private function registerAdminMenu(array $admin_menu, $network_admin)
    {
        $network_admin = (bool) $network_admin;
        foreach ($admin_menu as $menu_item) {
            ...
            try {
                ...
                $admin_init_page = isset($this->installed_pages[ $menu_item->menuSlug() ]) ? $this->installed_pages[ $menu_item->menuSlug() ] : null;
     ...
     * @return bool
     */
    private function skipMenuItem($menu_item)
    {
     ...
     * @return void
     */
    public function setInstalledPages($installed_pages)
    {
     ...
     * @return AdminMenuItem[]
     * @throws DomainException
     * @param mixed[] $admin_menu
     */
    public function sortMenu($admin_menu)
    {
     ...
     */
    private function sortMenuItems(AdminMenuItem $a, AdminMenuItem $b)
    {
     ...
     * @return array
     */
    public function reorderAdminMenu($menu_order)
    {
