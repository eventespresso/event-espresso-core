...
class RequestTypeContextDetector
{
    ...
    {
        $globalRouteCondition = (string) $globalRouteCondition;
        return isset($this->globalRouteConditions[ $globalRouteCondition ]) ? $this->globalRouteConditions[ $globalRouteCondition ] : $default;
    }
     ...
     * @return bool
     */
    private function isRestApiRequest($extra_path = '')
    {
        $extra_path = (string) $extra_path;
