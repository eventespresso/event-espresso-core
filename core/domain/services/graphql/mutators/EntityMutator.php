...
abstract class EntityMutator
{
    ...
    protected static function getEntityFromInputData(
        ...
        list($keyPrefix) = explode('_', $primaryKey);
     ...
     * @throws UserError
     */
    protected static function checkPermissions($model, $capability = 'ee_edit_events')
    {
        /**
     ...
     * @throws OutOfBoundsException
     */
    protected static function getEntityIDFromGlobalId($model, $input)
    {
     ...
     * @throws EE_Error
     */
    protected static function getEntity($model, $ID = 0)
    {
     ...
     * @throws RuntimeException
     */
    protected static function handleExceptions($exception, $message_prefix = '')
    {
