...
class RootQuery extends TypeBase
{
     ...
     * @since $VID:$
     */
    public function getEventRelationalData($source, $args, $context, $info)
    {
        /**
     ...
     * @since $VID:$
     */
    public function getDatetime($source, $args, $context, $info)
    {
     ...
     * @since $VID:$
     */
    public function getTicket($source, $args, $context, $info)
    {
        $parts = Relay::fromGlobalId(sanitize_text_field($args['id']));
