...
use EventEspresso\core\services\address\formatters\AddressFormatter;
...
class EE_messages
{
     ...
     * @deprecated 4.9.0
     */
    public function validate_for_use($message)
    {
        // EE_messages has been deprecated
        $this->_class_is_deprecated(__FUNCTION__);
        return [
 ...
 * @deprecated 4.9.0
 */
class EE_Address_Formatter extends AddressFormatter
{
}
 ...
 * @deprecated 4.9.0
 */
class EE_MultiLine_Address_Formatter extends NullAddressFormatter
{
}
 ...
 * @deprecated 4.9.0
 */
class EE_Inline_Address_Formatter extends InlineAddressFormatter
{
}
 ...
 * @deprecated 4.9.0
 */
class EE_Null_Address_Formatter extends NullAddressFormatter
{
}
 ...
 * @deprecated 4.9.0
 */
class EE_Generic_Address extends GenericAddress
{
}
