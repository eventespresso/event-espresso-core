...
.ee-icon {
	...
	font-family: 'ee_dashicons' !important;
 	font-style: normal;
	font-weight: 400;
	font-variant: normal;
	line-height: 1;
...
.ee-upcoming-events-widget-ul li p {
...
.ee-button:visited {
	...
	background-image: -moz-linear-gradient( center top , #4EBFDE, #00B1CA );
...
.espresso-ajax-notices {
	...
	text-align: center;
	font-weight: bold;
	box-shadow: 4px 10px 15px -3px rgba(0,0,0,.3), 0px 1px 3px -1px rgba(0,0,0,.6), -3px -2px 10px rgba(0,0,0,.1);
}
.espresso-notices p,
...
/*#espresso-notices-success .close-espresso-notice,
#espresso-ajax-notices-success .close-espresso-notice,
#espresso-notices-error .close-espresso-notice,
#espresso-ajax-notices-error .close-espresso-notice {
	color:#fff;
}

#espresso-notices-attention .close-espresso-notice,
#espresso-ajax-notices-attention .close-espresso-notice {
	color: #fff;
	text-shadow: 0 -1px 0px rgba(0,0,0,0.25);
}
#espresso-notices-attention .close-espresso-notice,
#espresso-ajax-notices-attention .close-espresso-notice,
#espresso-notices-success .close-espresso-notice:hover,
#espresso-ajax-notices-success .close-espresso-notice:hover,
#espresso-notices-error .close-espresso-notice:hover,
#espresso-ajax-notices-error .close-espresso-notice:hover {
	color: #fff !important;
}*/
...
#ee-m-mode-admin-notice-dv p {
	margin: 0;
}
#ee-m-mode-admin-notice-dv a {
	color:#FEDF6C;
	text-shadow:0 1px 1px rgba( 0, 0, 0, 0.4 );
}
#ee-m-mode-admin-notice-dv a:hover {
	color: #F8D755;
	text-shadow:0 .5px 0px rgba( 0, 0, 0, 0.2 );
}
#ee-m-mode-admin-notice-dv a:active {
	color: #F8D755;
	text-shadow:0 -1px 0px rgba( 0, 0, 0, 0.4 );
}
