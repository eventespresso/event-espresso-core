...
class ModelFieldFactory implements InterminableInterface
{
     ...
     *          // whether this status should be shown on the frontend of the site
     *          'public' => true,
     *          // whether this status should be excluded from wp searches
     *          'exclude_from_search' => false,
     *          // whether this status is included in queries for the admin "all" view in list table views.
     *          'show_in_admin_all_list' => true,
     *          // show in the list of statuses with post counts at the top of the admin list tables (i.e. Status Reference(2) )
     *          'show_in_admin_status_list' => true,
     *          // the text to display on the admin screen ( or you won't see your status count ).
     *          'label_count' => _n_noop(
