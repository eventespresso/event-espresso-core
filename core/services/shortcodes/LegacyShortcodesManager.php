...
class LegacyShortcodesManager
{
     ...
     * @return    bool
     */
    public function registerShortcode($shortcode_path = '')
    {
     ...
     */
    public function initializeShortcodes($wp_query)
    {
        if (
            empty($this->registry->shortcodes)
     ...
     * @return void
     */
    public function initializeShortcode($shortcode_class = '', $wp = null)
    {
     ...
     * @return string
     */
    public static function stripShortcodeClassPrefix($class_name)
    {
        return strpos($class_name, LegacyShortcodesManager::SHORTCODE_PREFIX) === 0
            ? substr($class_name, 4)
            : $class_name;
