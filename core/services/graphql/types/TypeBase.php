...
abstract class TypeBase implements TypeInterface
{
     ...
     * @since $VID:$
     */
    public function resolveField($source, $args, $context, $info)
    {
     ...
     * @throws EE_Error
     */
    public function resolveFromPayload($payload, $args, $context)
    {
        if (empty($payload['id'])) {
            return null;
        }
     ...
     */
    public function formatDatetime($datetime, $source)
    {
     ...
     */
    public function toJson($object, $source)
    {
