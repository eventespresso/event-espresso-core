	...
	protected function __construct(){
		...
		$this->_fields = array(
			'Question_Group'=>array(
				...
				'QSG_show_group_name'=>new EE_Boolean_Field('QSG_show_group_name', __('Flag indicating whether to show the group\'s name on the registration page','event_espresso'), false, 1),
