	...
	protected function __construct( $timezone ) {
		...
		$this->_fields = array(
			'Ticket'=>array(
				...
				'TKT_qty'=>new EE_Infinite_Integer_Field('TKT_qty', __('Quantity of this ticket that is available','event_espresso'), true, INF),
				'TKT_uses'=>new EE_Infinite_Integer_Field('TKT_uses', __('Number of datetimes this ticket can be used at', 'event_espresso'), TRUE, INF ),
