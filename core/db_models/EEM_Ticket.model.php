...
class EEM_Ticket extends EEM_Soft_Delete_Base
{
     ...
     */
    const TICKET_VISIBILITY_NONE_KEY            = 'NONE';

    const TICKET_VISIBILITY_NONE_VALUE          = 0;

    const TICKET_VISIBILITY_PUBLIC_KEY          = 'PUBLIC';

    const TICKET_VISIBILITY_PUBLIC_VALUE        = 100;

    const TICKET_VISIBILITY_MEMBERS_ONLY_KEY    = 'MEMBERS_ONLY';

    const TICKET_VISIBILITY_MEMBERS_ONLY_VALUE  = 200;

    const TICKET_VISIBILITY_ADMINS_ONLY_KEY     = 'ADMINS_ONLY';

    const TICKET_VISIBILITY_ADMINS_ONLY_VALUE   = 300;

    const TICKET_VISIBILITY_ADMIN_UI_ONLY_KEY   = 'ADMIN_UI_ONLY';

    const TICKET_VISIBILITY_ADMIN_UI_ONLY_VALUE = 400;
     ...
     * @throws ReflectionException
     */
    private function _set_default_dates(array $tickets)
    {
     ...
     * @throws ReflectionException
     */
    public function get_tickets_with_IDs($ticket_IDs)
    {
        return $this->get_all(
            [
                [
     ...
     * @return array
     */
    public function getTicketVisibilityEnumOptions()
    {
        $ticket_visibility = [];
     ...
     * @return array
     */
    public function getTicketVisibilityValues()
    {
     ...
     * @return array
     */
    public function getTicketVisibilityLabels()
    {
     ...
     * @return array
     */
    public function ticketVisibilityOptions()
    {
