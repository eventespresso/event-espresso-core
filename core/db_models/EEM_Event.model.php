...
class EEM_Event extends EEM_CPT_Base
{
     ...
     * @throws ReflectionException
     */
    public function get_question_groups_for_event($EVT_ID, $registration)
    {
        if (! absint($EVT_ID)) {
            EE_Error::add_error(
                esc_html__(
     ...
     * @throws ReflectionException
     */
    public function get_all_not_expired_event_ids($query_params = [])
    {
        $query_params[0] = [
     ...
     * @return array
     */
    public function set_where_conditions_for_status($where_params)
    {
        // let's add specific query_params for active_events
        // keep in mind this will override any sent status in the query AND any date queries.
     ...
     * @throws ReflectionException
     */
    public function set_where_conditions_for_end_datetime($where_params)
    {
     ...
     * @throws ReflectionException
     */
    protected function _get_count_or_all($query_params, $where_params, $count = false)
    {
     ...
     * @access     public
     */
    public function assemble_array_of_groups_questions_and_options($registration, $EVT_ID = 0)
    {
        if (empty($EVT_ID)) {
