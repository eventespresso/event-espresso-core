 ...
 * @method EE_Datetime    create_default_object()
 * @method EE_Datetime[]  get_all($query_params = [])
 * @method EE_Datetime    get_one($query_params = [])
 * @method EE_Datetime    get_one_by_ID($DTT_ID)
 */
class EEM_Datetime extends EEM_Soft_Delete_Base
{
     ...
     * @throws EE_Error
     */
    public function get_datetimes_for_event_ordered_by_importance($EVT_ID, $limit = 0)
    {
     ...
     *                                 EE_Datetime::expired
     */
    public function get_datetime_counts_by_status($stati_to_include = [], $query_params = [])
    {
     ...
     * @throws EE_Error
     */
    public function get_datetime_count_for_status($status = EE_Datetime::active, $query_params = [])
    {
