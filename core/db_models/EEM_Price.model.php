...
class EEM_Price extends EEM_Soft_Delete_Base
{
    ...
    protected function __construct($timezone)
    {
        ...
        $this->_cap_restriction_generators[ EEM_Base::caps_read ] =
            new EE_Restriction_Generator_Default_Public('PRC_is_default', 'Ticket.Datetime.Event');
        // account for default tickets in the caps
        $this->_cap_restriction_generators[ EEM_Base::caps_read_admin ] =
            new EE_Restriction_Generator_Default_Protected('PRC_is_default', 'Ticket.Datetime.Event');
