...
class EE_Restriction_Generator_Default_Protected extends EE_Restriction_Generator_Base
{
    ...
    {
        $default_field_name = (string) $default_field_name;
        $path_to_event_model = (string) $path_to_event_model;
     ...
     * @since   $VID:$
     */
    private function getCapKey(EEM_Base $model, $action)
    {
     ...
     * @since   $VID:$
     */
    private function nonDefaultRestrictions($use_default_field_name)
    {
        $use_default_field_name = (bool) $use_default_field_name;
     ...
     * @since   $VID:$
     */
    private function othersDefaultRestrictions($action)
    {
        $action = (string) $action;
     ...
     * @since   $VID:$
     */
    private function othersNonDefaultRestrictions(EEM_Event $event_model, $action)
    {
        $action = (string) $action;
        return new EE_Default_Where_Conditions(
            [
     ...
     * @since   $VID:$
     */
    private function privateRestrictions(EEM_Event $event_model, $action)
    {
        $action = (string) $action;
        return new EE_Default_Where_Conditions(
            [
