    ...
    extends EE_Restriction_Generator_Base
{
    ...
    protected function _generate_restrictions(): array
    {
        ...
        $restrictions = [
            ...
            // controlled by which events are accessible if they don't have
            // the basic event cap, they can't access ANY non-default items
            ...
            EE_Restriction_Generator_Base::get_cap_name(
                ...
                [
                    ...
                    EE_Restriction_Generator_Base::get_cap_name(
                        ...
                        $this->_path_to_event_model .
                        'EVT_wp_user'                          => EE_Default_Where_Conditions::current_user_placeholder,
                        $this->_path_to_event_model . 'status' => [
                            '!=',
                            'private',
                        ],
                        $this->_default_field_name             => true,
            ...
            // if they don't have the default capability,
