 ...
 * For generating default where conditions relating to caps for questions,
 * question groups, and question-group-question models.
 * These are distinct in that they have "system" items which
 *
...
class EE_Restriction_Generator_Reg_Form extends EE_Restriction_Generator_Base
{
    ...
    {
        $system_field_name = (string) $system_field_name;
