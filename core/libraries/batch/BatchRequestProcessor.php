...
class BatchRequestProcessor
{
    ...
    private function initializeJobHandler(
        ...
        $job_handler_class = (string) $job_handler_class;
        $this->_job_id         = $job_id;
     ...
     * @return JobStepResponse
     */
    public function continueJob($job_id, $batch_size = 50)
    {
        try {
     ...
     * @return JobStepResponse
     */
    public function advanceJob($job_id)
    {
        try {
            $job_handler  = $this->initializeJobHandler($job_id);
     ...
     * @return JobStepResponse
     */
    public function cleanupJob($job_id)
    {
        try {
            $job_handler  = $this->initializeJobHandler($job_id);
     ...
     * @throws BatchRequestException
     */
    public function instantiateBatchJobHandlerFromJobParameters($job_parameters)
    {
     ...
     * @return JobStepResponse
     */
    protected function _get_error_response($exception, $method_name)
    {
     ...
     * @since   $VID:$
     */
    private function validateResponse($function, $job_id, $job_response)
    {
     ...
     * @since   $VID:$
     */
    private function validateJobHandler($job_handler, JobParameters $job_parameters)
    {
