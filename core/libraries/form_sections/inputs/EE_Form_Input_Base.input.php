...
abstract class EE_Form_Input_Base extends EE_Form_Section_Validatable
{
    ...
    public function __construct($input_args = [])
    {
        ...
        $this->set_required(
            $this->_required,
            isset($input_args['required_validation_error_message']) ? $input_args['required_validation_error_message'] : null
        );
     ...
     */
    protected function _set_display_strategy($strategy)
    {
     ...
     */
    protected function _set_normalization_strategy($strategy)
    {
     ...
     * @return void
     */
    protected function _add_validation_strategy($validation_strategy)
    {
        $validation_strategy->_construct_finalize($this);
     ...
     * @return void
     */
    public function add_validation_strategy($validation_strategy)
    {
    ...
    public function html_name()
    {
        ...
        return isset($this->_html_name) ? $this->_html_name : '';
    }
    ...
    {
        return isset($this->_html_label_class) ? $this->_html_label_class : '';
    }
    ...
    {
        return isset($this->_html_label_style) ? $this->_html_label_style : '';
    }
    ...
    {
        return isset($this->_html_label_text) ? $this->_html_label_text : '';
    }
    ...
    {
        return isset($this->_html_help_text) ? $this->_html_help_text : '';
    }
    ...
    {
        return isset($this->_html_help_class) ? $this->_html_help_class : '';
    }
    ...
    {
        return isset($this->_html_style) ? $this->_html_style : '';
    }
