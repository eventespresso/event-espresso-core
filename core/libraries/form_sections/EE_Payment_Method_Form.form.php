...
class EE_Payment_Method_Form extends EE_Model_Form_Section{
	...
	public function __construct($options_array = array()){
		...
		//exclude Currency from being auto-created because it's an odd-ball and we want it to be 
		$this->_subsections['Currency'] = new EE_Payment_Method_Currencies_Input(array(
