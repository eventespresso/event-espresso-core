...
class EE_Billing_Attendee_Info_Form extends EE_Billing_Info_Form
{
    ...
    public function __construct(EE_Payment_Method $payment_method, $options_array = [])
    {
        $options_array['subsections'] = array_merge(
            ...
            isset($options_array['subsections']) ? $options_array['subsections'] : []
        );
     ...
     * @since 4.10.0.p
     */
    protected function getAttendeeStateValueForForm($attendee)
    {
     ...
     * @throws EE_Error
     */
    public function copy_billing_form_data_to_attendee($attendee)
    {
