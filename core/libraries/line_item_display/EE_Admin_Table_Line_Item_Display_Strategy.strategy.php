...
class EE_Admin_Table_Line_Item_Display_Strategy extends LineItemDisplayStrategy
{
    ...
    protected function _item_row(EE_Line_Item $line_item, $options = [])
    {
        ...
        $parent_related_object_name =
            $parent_line_item_related_object instanceof EEI_Line_Item_Object
                ? $parent_line_item_related_object->name()
                : '';
        $parent_related_object_name =
            empty($parent_related_object_name) && $line_item->parent() instanceof EE_Line_Item
                ? $line_item->parent()->name()
                : $parent_related_object_name;
        $parent_related_object_link =
            $parent_line_item_related_object instanceof EEI_Admin_Links
        ...
        $name_html =
            $line_item_related_object instanceof EEI_Has_Icon
        ...
        $name_html .= sprintf(
            ...
            $parent_related_object_link ? '<a href="'
                                          . $parent_related_object_link
                                          . '">'
                                          . $parent_related_object_name
                                          . '</a>' : $parent_related_object_name,
            '</span>'
        );
        ...
        // total column
        $html .= EEH_HTML::td($line_item->prettyTotal(), '', 'jst-rght');
    ...
    protected function _tax_row(EE_Line_Item $line_item, $options = [])
    {
        ...
        // name th
        $html .= EEH_HTML::th(
            $line_item->name() . '(' . $line_item->prettyPercent() . ')',
            '',
            'jst-rght',
            '',
            ' colspan="4"'
