...
class EE_Admin_Table_Line_Item_Display_Strategy implements EEI_Line_Item_Display
{
    ...
    protected function _item_row($line_item, $options = array())
    {
        ...
        if ($line_item->is_percent()) {
            ...
            $include_taxes = $this->prices_include_taxes && $line_item->quantity() > 0
     ...
     * @throws ReflectionException
     */
    protected function _get_cancellations($line_item)
    {
        $html = '';
     ...
     * @return mixed
     */
    protected function _sub_item_row($line_item, $options = array())
    {
     ...
     * @return mixed
     */
    protected function _sub_total_row($line_item, $text = '', $options = array())
    {
