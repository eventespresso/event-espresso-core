                    ...
                    mutations: {
                        ...
                        updateEntityById: function (state, payload) {
                            ...
                            if (!_.has(payload, 'model') || !_.has(payload, 'changes') || !_.has(payload, 'id')) {
                                throw new eejs.exception('The payload for `setById` is missing a required key.  Double-check and make' + ' sure there is a `model`, `changes` and `id` key set.');
                            }
