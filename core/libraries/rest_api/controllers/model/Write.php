...
class Write extends Base
{
    ...
    private static function controller()
    {
        ...
        return $loader->getNew(Write::class);
    }
    ...
    protected function getOneBasedOnRequest(EEM_Base $model, WP_REST_Request $request, $obj_id)
    {
        ...
        $read_controller = LoaderFactory::getLoader()->getShared(Read::class);
        $read_controller->setRequestedVersion($this->getRequestedVersion());
    ...
    {
        // This endpoint doesn't accept body parameters
        // (it's understandable to think it might, so let developers know up-front that it doesn't.)
