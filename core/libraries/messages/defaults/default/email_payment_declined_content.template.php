...
<p class="lead"><?php _e('Your payment was <strong>DECLINED</strong> for the following transaction and ticket purchases:', 'event_espresso'); ?></p>
...
<ul>
	...
	<li><strong><?php _e('Payment Method:', 'event_espresso'); ?></strong> [PAYMENT_GATEWAY]</li>
...
<!-- Callout Panel -->
<p class="callout"><?php printf( __( 'Please %sretry your payment%s, or choose an alternate payment method to reserve your space.', 'event_espresso'), '<a href="[PAYMENT_URL]">', '</a>' ); ?></p>
<!-- /Callout Panel -->
[EVENT_LIST]
<!-- Callout Panel -->
<p class="callout"><?php printf( __( 'Please %sretry your payment%s, or choose an alternate payment method to reserve your space.', 'event_espresso'), '<a href="[PAYMENT_URL]">', '</a>' ); ?></p>
