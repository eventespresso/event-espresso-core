						...
						<tbody>
							<tr>
								<td>
									...
									<p class="lead"><?php _e( 'Your payment is <strong>PENDING</strong> for the following transaction and ticket purchases:', 'event_espresso' ); ?></p>
									...
									<p class="callout">
										<?php printf( __( 'Please %scomplete your payment%s, or choose an alternate payment method to reserve your space.', 'event_espresso' ), '<a href="[PAYMENT_URL]">', '</a>' ); ?>
									</p>
									[EVENT_LIST]
									<p class="callout">
										<?php printf( __( 'Please %scomplete your payment%s, or choose an alternate payment method to reserve your space.', 'event_espresso' ), '<a href="[PAYMENT_URL]">', '</a>' ); ?>
