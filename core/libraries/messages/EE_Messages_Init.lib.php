...
class EE_Messages_Init extends EE_Base {
	...
	private function _do_actions() {
		add_action( 'AHEE__EE_Payment_Processor__update_txn_based_on_payment__successful', array( $this, 'payment' ), 10, 2 );
		//add_action( 'AHEE__EE_Payment_Processor__update_txn_based_on_payment__no_payment_made', array( $this, 'payment_reminder'), 10 );
