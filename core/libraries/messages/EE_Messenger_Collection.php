...
class EE_Messenger_Collection extends EE_Object_Collection {
	...
	public function set_info( $object, $info = null ) {
		return parent::set_info( $object, $info ); // TODO: Change the autogenerated stub
	}
	 ...
	 * has_by_classname
	 *
	 * returns TRUE or FALSE depending on whether the supplied messenger classname is within the Collection
	 *
	 * @access public
	 * @param string $messenger_classname
	 * @return bool
	 */
	public function has_by_classname( $messenger_classname ) {
		return $this->get_by_info( $messenger_classname ) instanceof $messenger_classname ? true :false;
	}
