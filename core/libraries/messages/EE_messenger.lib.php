    ...
    protected function _get_admin_content_events_edit($message_types, $extra)
    {
        ...
        foreach ($global_templates as $mtpgID => $mtpg) {
            if ($mtpg instanceof EE_Message_Template_Group) {
                ...
                $st_args['create_button'] = $mtpg->get('MTP_is_override') ? '' : '<a data-messenger="' . $this->name . '" data-messagetype="' . $mtpg->message_type() . '" data-grpid="' . $default_value . '" target="_blank" href="' . $create_url . '" class="button button--secondary button--small create-mtpg-button">' . esc_html__('Create New Custom', 'event_espresso') . '</a>';
                ...
                $st_args['edit_button'] = EE_Registry::instance()->CAP->current_user_can('ee_edit_message', 'espresso_messages_edit_message_template', $mtpgID) ? '<a data-messagetype="' . $mtpg->message_type() . '" data-grpid="' . $default_value . '" target="_blank" href="' . $edit_url . '" class="button button--secondary button--small edit-mtpg-button">' . esc_html__('Edit', 'event_espresso') . '</a>' : '';
