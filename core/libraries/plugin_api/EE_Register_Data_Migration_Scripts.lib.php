    ...
    public static function register($dms_id = null, $setup_args = array())
    {
        ...
        if (! did_action('AHEE__EE_System__load_espresso_addons')
            ...
            EE_Error::doing_it_wrong(
                __METHOD__,
                __('An attempt to register Data Migration Scripts has failed because it was not registered at the correct time.  Please use the "AHEE__EE_System__load_espresso_addons" hook to register Data Migration Scripts.',
                    'event_espresso'),
                '4.3.0'
            );
        }
        ...
        // setup DMS
        add_filter('FHEE__EE_Data_Migration_Manager__get_data_migration_script_folders',
