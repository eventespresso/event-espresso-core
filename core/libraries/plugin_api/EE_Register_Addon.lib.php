    ...
    private static function _register_shortcodes($addon_name)
    {
        ...
        if (
            ...
            EE_Register_Shortcode::register(
                $addon_name,
                [
                    'shortcode_paths' => isset(self::$_settings[ $addon_name ]['shortcode_paths']) ? self::$_settings[ $addon_name ]['shortcode_paths'] : [],
                    'shortcode_fqcns' => isset(self::$_settings[ $addon_name ]['shortcode_fqcns']) ? self::$_settings[ $addon_name ]['shortcode_fqcns'] : [],
                ]
            );
        }
    }
