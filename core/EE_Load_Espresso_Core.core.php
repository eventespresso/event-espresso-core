...
class EE_Load_Espresso_Core implements RequestDecorator, RequestStackCoreAppInterface
{
	...
	public function __construct(EE_Registry $registry, EE_Dependency_Map $dependency_map) {
        EE_Error::doing_it_wrong(
            __METHOD__,
            esc_html__(
                'This class is deprecated. Please use EventEspresso\core\services\request\RequestStackCoreApp instead. All Event Espresso request stack classes have been moved to \core\services\request and are now under the EventEspresso\core\services\request_stack namespace',
                'event_espresso'
            ),
            '4.9.53'
        );
