...
class EE_Admin_Page_Loader
{
     ...
     * @since   $VID:$
     */
    private function findAdminPages()
    {
     ...
     * @return string
     */
    private function getClassnameForAdminPageInit($dir_name = '')
    {
     ...
     * @throws EE_Error
     */
    private function loadAdminPageInit($page = '')
    {
        $page = (string) $page;
     ...
     * @throws EE_Error
     */
    private function findCaffeinatedAdminPages(array $admin_pages)
    {
    ...
    private function findAdminPageFolders(
        ...
        array $exclude = [],
        $flags = GLOB_ONLYDIR,
        $register_autoloaders = true
    ) {
        $path = (string) $path;
        $flags = (int) $flags;
        $register_autoloaders = (bool) $register_autoloaders;
        $folders = [];
