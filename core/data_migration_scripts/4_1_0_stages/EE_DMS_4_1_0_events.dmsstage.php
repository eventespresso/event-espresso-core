 ...
 * $this->_tables = array(
		...
		$this->_fields = array(
			...
			'Event_Meta'=>array(
				...
				'EVT_default_registration_status'=>new EE_Enum_Text_Field('EVT_default_registration_status', __("Default Registration Status on this Event", "event_espresso"), false, EEM_Registration::status_id_pending_payment_payment, EEM_Registration::reg_status_array()),
