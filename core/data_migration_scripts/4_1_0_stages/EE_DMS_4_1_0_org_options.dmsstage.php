...
/**
 * Converts 3.1 $org_options to the 4.1 EE_Config class (which maybe should be included at the bottom of this file, in
 * case EE_Config ever gets dropped)
 ...
 * [contact]. If you have not done so already, please submit your payment in the amount of [cost]. Cli'... (length=607)
 ...
 * 'events_in_dashboard' => string '<br /><font size=\'1\'><table class=\'xdebug-error xe-notice\' dir=\'ltr\'
 * border=\'1\' cellspacing=\'0\' cellpadding=\'1\'><tr><th align=\'left\' bgcolor=\'#f57900\' colspan=' (length=175)
 ...
 *
 * @todo: inform clients that messages have COMPLETELY changed in 4.1; themeroller isn't in there; event list page is
 *        no more;
 */
