...
class EE_DMS_Core_4_10_0 extends EE_Data_Migration_Script_Base
{
    ...
    public function schema_changes_before_migration()
    {
        ...
        $sql = "PAY_ID int(10) unsigned NOT NULL AUTO_INCREMENT,
				...
				PAY_amount decimal(12,6) DEFAULT NULL,
        ...
        $sql = "REG_ID int(10) unsigned NOT NULL AUTO_INCREMENT,
				...
				REG_final_price decimal(12,6) NOT NULL DEFAULT '0.000000',
				REG_paid decimal(12,6) NOT NULL DEFAULT '0.000000',
        ...
        $sql = "RPY_ID int(10) unsigned NOT NULL AUTO_INCREMENT,
					  ...
					  RPY_amount decimal(12,6) NOT NULL DEFAULT '0.000000',
					  PRIMARY KEY  (RPY_ID),
					  KEY REG_ID (REG_ID),
					  KEY PAY_ID (PAY_ID)";
        $this->_table_has_not_changed_since_previous($table_name, $sql, 'ENGINE=InnoDB ');
        ...
        $sql = "TXN_ID int(10) unsigned NOT NULL AUTO_INCREMENT,
				...
				TXN_total decimal(12,6) DEFAULT '0.000000',
				TXN_paid decimal(12,6) NOT NULL DEFAULT '0.000000',
        ...
        $sql = "TKT_ID int(10) unsigned NOT NULL AUTO_INCREMENT,
				...
				TKT_price decimal(12,6) NOT NULL DEFAULT '0.000000',
