jQuery(document).ready(function($) {
	...
	if ( EE_QTIP_HELPER.qtips.length > 0 ) {
		...
		$.each(EE_QTIP_HELPER.qtips, function(i, v ) {
			...
			if ( typeof( v.options.position.container) !== 'undefined' && v.options.position.container.indexOf('jQuery::') > -1 ) {
				parse = v.options.position.container.replace('jQuery::', '');
				v.options.position.container = $(parse);
			}

			if ( typeof( v.options.hide.target) !== 'undefined' && v.options.hide.target.indexOf('jQuery::') > -1 ) {
