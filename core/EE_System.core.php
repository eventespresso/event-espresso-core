	...
	public function wp_enqueue_scripts() {
		...
		if ( apply_filters( 'FHEE_load_EE_System_scripts', TRUE ) ) {
			...
			if ( apply_filters( 'FHEE_load_jquery_validate', FALSE ) ) {
				...
				//wp_register_script( 'jquery-validate', EE_GLOBAL_ASSETS_URL . 'scripts/jquery.validate.min.js', array('jquery'), '1.13.1', TRUE );
				wp_register_script( 'jquery-validate', 'http://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/jquery.validate.min.js', array('jquery'), '1.14.0', TRUE );
			}
		}
	}
