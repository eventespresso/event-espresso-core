...
final class EE_System implements ResettableInterface
{
    ...
    *
     * @param mixed[] $activation_history the option's value which stores the activation history for
                                               this
    ...
    */
     ...
     * @since $VID:$
     */
    private static function getRequestType(array $activation_history, $version_change, $is_activation)
    {
        $version_change = (int) $version_change;
     ...
     */
    private static function compareVersionWithPrevious(array $activation_history, $current_version)
    {
     ...
     * @return string
     */
    private static function getMostRecentlyActiveVersion(array $activation_history)
    {
