...
?>
	...
	<?php if ( $is_primary && $SPCO_attendee_information_url ) { ?>
		<p class="small-text jst-rght"><span><a href='<?php echo $SPCO_attendee_information_url?>'><?php _e("Click here to edit All Attendee Information", 'event_espresso'); ?></a></span></p>
	<?php } ?>
