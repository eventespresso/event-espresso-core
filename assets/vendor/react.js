	...
	*/
				...
				function shouldUseNative() {
					try {
						...
						test1[ 5 ] = 'de';
						if ( Object.getOwnPropertyNames( test1 )[ 0 ] ===
							'5' ) {
							return false;
						}
						...
						if ( Object.keys( Object.assign( {}, test3 ) )
								.join( '' ) !==
				...
				function warnNoop( publicInstance, callerName ) {
					{
						...
						var componentName = _constructor &&
							(
				...
				function escape( key ) {
					...
					var escapedString = (
						'' + key
					).replace( escapeRegex, function( match ) {
				...
				function isValidElementType( type ) {
					return typeof type ===
						'string' ||
						typeof type ===
						'function' || // Note: its typeof might be other than 'symbol' or 'number' if it's a polyfill.
						type ===
						REACT_FRAGMENT_TYPE ||
						type ===
				...
				if ( // If Scheduler runs in a non-DOM environment, it falls back to a naive
					...
					typeof window ===
					'undefined' || // Check if MessageChannel is supported, too.
				...
				var sharedProfilingBuffer =  // $FlowFixMe Flow doesn't know about SharedArrayBuffer
					typeof SharedArrayBuffer === 'function' ?
						new SharedArrayBuffer( profilingStateSize *
							Int32Array.BYTES_PER_ELEMENT ) : // $FlowFixMe Flow doesn't know about ArrayBuffer
						typeof ArrayBuffer === 'function' ?
							new ArrayBuffer( profilingStateSize *
				...
				function logEvent( entries ) {
					if ( eventLog !== null ) {
						...
						if ( eventLogIndex + 1 > eventLogSize ) {
							...
							var newEventLog = new Int32Array( eventLogSize *
								4 );
				...
				function workLoop( hasTimeRemaining, initialTime ) {
					...
					! (
						...
						if ( callback !== null ) {
							...
							var didUserCallbackTimeout = currentTask.expirationTime <=
								currentTime;
				...
				function unstable_trace( name, timestamp, callback ) {
					var threadID = arguments.length >
					3 &&
					arguments[ 3 ] !==
					undefined ? arguments[ 3 ] : DEFAULT_THREAD_ID;
				...
				function unstable_wrap( callback ) {
					...
					1 &&
					arguments[ 1 ] !==
					undefined ? arguments[ 1 ] : DEFAULT_THREAD_ID;
