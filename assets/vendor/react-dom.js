	...
	function( global, factory ) {
		...
		(
			function( exports, React ) {
				...
				if ( ! ReactSharedInternals.hasOwnProperty(
				...
				function printWarning( level, format, args ) {
					...
					{
						var hasExistingStack = args.length >
							0 &&
				...
				function publishEventForPlugin(
					...
					if ( phasedRegistrationNames ) {
						for ( var phaseName in phasedRegistrationNames ) {
							if ( phasedRegistrationNames.hasOwnProperty(
								phaseName ) ) {
				...
				function shouldRemoveAttribute(
					...
					if ( shouldRemoveAttributeWithWarning(
						name,
						value,
						propertyInfo,
						isCustomComponentTag
				...
				var REACT_BLOCK_TYPE = hasSymbol ?
					...
					0xead9;
				var MAYBE_ITERATOR_SYMBOL = typeof Symbol ===
					'function' &&
					Symbol.iterator;
...

				{
					...
					var propTypes = {
						value: function( props, propName, componentName ) {
							if ( hasReadOnlyValue[ props.type ] ||
								props.onChange ||
								props.readOnly ||
								props.disabled ||
								props[ propName ] ==
				...
				function initWrapperState( element, props ) {
					...
					node._wrapperState = {
						initialChecked: props.checked != null ?
							props.checked :
							props.defaultChecked,
						initialValue: getToStringValue( props.value != null ?
							props.value :
							defaultValue ),
				...
				function updateNamedCousins( rootNode, props ) {
					...
					if ( props.type === 'radio' && name != null ) {
						...
						var group = queryRoot.querySelectorAll( 'input[name=' +
							JSON.stringify( '' + name ) +
							'][type="radio"]' );
						...
						for ( var i = 0; i < group.length; i++ ) {
							...
							var otherProps = getFiberCurrentPropsFromNode$1(
								otherNode );
				...
				function setDefaultValue( node, type, value ) {
					if ( // Focused number inputs synchronize on blur. See ChangeEventPlugin.js
						...
						if ( value == null ) {
							node.defaultValue
								= toString( node._wrapperState.initialValue );
				...
				function updateOptions(
					...
					if ( multiple ) {
						...
						var _selectedValue = toString( getToStringValue(
							propValue ) );
				...
				var TOP_DOUBLE_CLICK = unsafeCastStringToDOMTopLevelType(
					'dblclick' );
				var TOP_AUX_CLICK = unsafeCastStringToDOMTopLevelType(
					'auxclick' );
				var TOP_DRAG = unsafeCastStringToDOMTopLevelType( 'drag' );
				var TOP_DRAG_END = unsafeCastStringToDOMTopLevelType( 'dragend' );
				var TOP_DRAG_ENTER = unsafeCastStringToDOMTopLevelType(
					'dragenter' );
				var TOP_DRAG_EXIT = unsafeCastStringToDOMTopLevelType(
					'dragexit' );
				var TOP_DRAG_LEAVE = unsafeCastStringToDOMTopLevelType(
					'dragleave' );
				var TOP_DRAG_OVER = unsafeCastStringToDOMTopLevelType(
					'dragover' );
				var TOP_DRAG_START = unsafeCastStringToDOMTopLevelType(
					'dragstart' );
				var TOP_DROP = unsafeCastStringToDOMTopLevelType( 'drop' );
				var TOP_DURATION_CHANGE = unsafeCastStringToDOMTopLevelType(
					'durationchange' );
				var TOP_EMPTIED = unsafeCastStringToDOMTopLevelType( 'emptied' );
				var TOP_ENCRYPTED = unsafeCastStringToDOMTopLevelType(
					'encrypted' );
				...
				var TOP_KEY_PRESS = unsafeCastStringToDOMTopLevelType(
					'keypress' );
				var TOP_KEY_UP = unsafeCastStringToDOMTopLevelType( 'keyup' );
				var TOP_LOAD = unsafeCastStringToDOMTopLevelType( 'load' );
				var TOP_LOAD_START = unsafeCastStringToDOMTopLevelType(
					'loadstart' );
				...
				var TOP_LOST_POINTER_CAPTURE = unsafeCastStringToDOMTopLevelType(
					'lostpointercapture' );
				var TOP_MOUSE_DOWN = unsafeCastStringToDOMTopLevelType(
					'mousedown' );
				var TOP_MOUSE_MOVE = unsafeCastStringToDOMTopLevelType(
					'mousemove' );
				var TOP_MOUSE_OUT = unsafeCastStringToDOMTopLevelType(
					'mouseout' );
				var TOP_MOUSE_OVER = unsafeCastStringToDOMTopLevelType(
					'mouseover' );
				...
				var TOP_POINTER_OVER = unsafeCastStringToDOMTopLevelType(
					'pointerover' );
				var TOP_POINTER_UP = unsafeCastStringToDOMTopLevelType(
					'pointerup' );
				...
				var TOP_TEXT_INPUT = unsafeCastStringToDOMTopLevelType(
					'textInput' );
				...
				var TOP_TOUCH_CANCEL = unsafeCastStringToDOMTopLevelType(
					'touchcancel' );
				var TOP_TOUCH_END = unsafeCastStringToDOMTopLevelType(
					'touchend' );
				var TOP_TOUCH_MOVE = unsafeCastStringToDOMTopLevelType(
					'touchmove' );
				...
				function getEventTarget( nativeEvent ) {
					...
					var target = nativeEvent.target ||
						...
						window; // Normalize SVG <use> element events #4963
					...
					if ( ! listenerMap.has( topLevelType ) ) {
						switch ( topLevelType ) {
							...
							default:
								...
								var isMediaEvent = mediaEventTypes.indexOf(
									topLevelType ) !== -1;
				...
				function accumulateOrCreateContinuousQueuedReplayableEvent(
					...
					if ( existingQueuedEvent ===
						null ||
						existingQueuedEvent.nativeEvent !==
						nativeEvent ) {
						var queuedEvent = createQueuedReplayableEvent(
							blockedOn,
							topLevelType,
							...
							if ( tag === SuspenseComponent ) {
								...
								if ( root.hydrate ) {
									queuedTarget.blockedOn
										= getContainerFromFiber( nearestMounted ); // We don't currently have a way to increase the priority of
				...
				function retryIfBlockedOn( unblocked ) {
					...
					for ( var _i = 0; _i <
					queuedExplicitHydrationTargets.length; _i++ ) {
				...
				function processSimpleEventPluginPairsByPriority(
					...
					for ( var i = 0; i < eventTypes.length; i += 2 ) {
						...
						var capitalizedEvent = event[ 0 ].toUpperCase() +
							event.slice( 1 );
				...
				function hyphenateStyleName( name ) {
					return name.replace( uppercasePattern, '-$1' )
						.toLowerCase()
...

				{
					...
					warnValidStyle = function( name, value ) {
						...
						} else if ( badStyleValueWithSemicolonPattern.test(
							value ) ) {
				...
				function createDangerousStringForStyles( styles ) {
					{
						...
						for ( var styleName in styles ) {
							...
							if ( styleValue != null ) {
								var isCustomProperty = styleName.indexOf( '--' ) ===
									0;
				...
				var rARIA = new RegExp( '^(aria)-[' +
					ATTRIBUTE_NAME_CHAR +
					']*$' );
				var rARIACamel = new RegExp( '^(aria)[A-Z][' +
					ATTRIBUTE_NAME_CHAR +
					']*$' );
				...
				function validateProperty( tagName, name ) {
					{
						if ( hasOwnProperty$1.call( warnedProperties, name ) &&
						...
						if ( rARIACamel.test( name ) ) {
							...
							var correctName = ariaProperties.hasOwnProperty(
								ariaName ) ? ariaName : null; // If this is an aria-* attribute, but is not listed in the known DOM
						...
						if ( rARIA.test( name ) ) {
							...
							var standardName = ariaProperties.hasOwnProperty(
								lowerCasedName ) ? lowerCasedName : null; // If this is an aria-* attribute, but is not listed in the known DOM
							// DOM properties, then it is an invalid aria-* attribute.
...

				{
					...
					var rARIA$1 = new RegExp( '^(aria)-[' +
						ATTRIBUTE_NAME_CHAR +
						']*$' );
					var rARIACamel$1 = new RegExp( '^(aria)[A-Z][' +
						ATTRIBUTE_NAME_CHAR +
						']*$' );
					...
					validateProperty$1 = function(
						...
						if ( _hasOwnProperty.call( warnedProperties$1, name ) &&
						...
						var propertyInfo = getPropertyInfo( name );
						var isReserved = propertyInfo !==
							null &&
							propertyInfo.type ===
							RESERVED; // Known attributes should match the casing specified in the property config.
						...
						if ( typeof value ===
							'boolean' &&
							shouldRemoveAttributeWithWarning( name,
								value,
								propertyInfo,
								false
							) ) {
...

				{
					...
					canDiffStyleForHydrationWarning = canUseDOM &&
						! document.documentMode; // HTML parsing normalizes CR and CRLF to LF.
					...
					normalizeHTML = function( parent, html ) {
						...
						var testElement = parent.namespaceURI ===
						HTML_NAMESPACE$1 ?
				...
				function ensureListeningTo(
					...
					var isDocumentOrFragment = rootContainerElement.nodeType ===
						DOCUMENT_NODE ||
				...
				function setInitialDOMProperties(
					...
					for ( var propKey in nextProps ) {
						...
						if ( propKey === STYLE ) {
							...
							propKey ===
							SUPPRESS_HYDRATION_WARNING ) ; else if ( propKey ===
							AUTOFOCUS ) ; else if ( registrationNameModules.hasOwnProperty(
							propKey ) ) {
							if ( nextProp != null ) {
					...
					for ( propKey in nextProps ) {
						...
						if ( propKey === STYLE ) {
							...
							if ( lastProp !==
								...
								(
									updatePayload = updatePayload || []
								).push( propKey, '' + nextProp );
							}
						} else if ( propKey ===
							SUPPRESS_CONTENT_EDITABLE_WARNING ||
							propKey ===
							SUPPRESS_HYDRATION_WARNING ) ; else if ( registrationNameModules.hasOwnProperty(
							propKey ) ) {
							if ( nextProp != null ) {
				...
				function diffHydratedProperties(
					...
					for ( var propKey in rawProps ) {
						...
						if ( propKey === CHILDREN ) {
							...
							if ( suppressHydrationWarning ) ; else if ( propKey ===
								SUPPRESS_CONTENT_EDITABLE_WARNING ||
								propKey ===
								SUPPRESS_HYDRATION_WARNING || // Controlled attributes are not validated
								// TODO: Only ignore them on controlled tags.
								propKey ===
								'value' ||
								propKey ===
				...
				function isSameOriginFrame( iframe ) {
					try {
						...
						return typeof iframe.contentWindow.location.href ===
							'string';
					} catch ( err ) {
						return false;
					}
...

				{
					...
					var isTagValidWithParent = function( tag, parentTag ) {
						...
						switch ( tag ) {
							...
							case 'rp':
							case 'rt':
								return impliedEndTags.indexOf( parentTag ) ===
									-1;
					...
					validateDOMNesting = function(
						...
						var invalidParentOrAncestor = invalidParent ||
							invalidAncestor;
				...
				function didNotMatchHydratedTextInstance(
					...
					if ( parentProps[ SUPPRESS_HYDRATION_WARNING$1 ] !==
						true ) {
						warnForUnmatchedText( textInstance, text );
					}
				}
							...
							if ( targetInst.child !==
								...
								while ( suspenseInstance !== null ) {
									...
									suspenseInstance
										...
										suspenseInstance ); // If we don't find one, then that should mean that the parent
				...
				function getLowestCommonAncestor( instA, instB ) {
					...
					for ( var tempA = instA; tempA; tempA
						= getParent( tempA ) ) {
						depthA++;
					}
				...
				function SyntheticEvent(
					...
					var defaultPrevented = nativeEvent.defaultPrevented !=
					null ?
				...
				var canUseTextInputEvent = canUseDOM &&
					'TextEvent' in
					window &&
					! documentMode; // In IE9+, we have access to composition events, but the data supplied
				...
				function extractCompositionEvent(
					...
					} else if ( isFallbackCompositionEnd(
						topLevelType,
						nativeEvent
					) ) {
				...
				var EnterLeaveEventPlugin = {
					...
					extractEvents: function(
						...
						var isOverEvent = topLevelType ===
							TOP_MOUSE_OVER ||
							topLevelType ===
							TOP_POINTER_OVER;
						var isOutEvent = topLevelType ===
							TOP_MOUSE_OUT ||
							topLevelType ===
							TOP_POINTER_OUT;
				...
				function is( x, y ) {
					return x ===
						...
						x &&
						y !==
						y // eslint-disable-line no-self-compare
						;
				}
				...
				function shallowEqual( objA, objB ) {
					...
					for ( var i = 0; i < keysA.length; i++ ) {
						if ( ! hasOwnProperty$2.call( objB, keysA[ i ] ) ||
							! objectIs(
								objA[ keysA[ i ] ],
								objB[ keysA[ i ] ]
							) ) {
				...
				var SelectEventPlugin = {
					...
					extractEvents: function(
						...
						var containerOrDoc = container ||
							getEventTargetDocument( nativeEventTarget ); // Track whether all listeners exists for this plugin. If none exist, we do
				...
				function getEventKey( nativeEvent ) {
					if ( nativeEvent.key ) {
						...
						var key = normalizeKey[ nativeEvent.key ] ||
							nativeEvent.key;
				...
				var SimpleEventPlugin = {
					...
					extractEvents: function(
						...
						var dispatchConfig = topLevelEventsToDispatchConfig.get(
							topLevelType );
						...
						switch ( topLevelType ) {
							...
							default: {
								if ( knownHTMLTopLevelTypes.indexOf(
									topLevelType ) === -1 ) {
									error(
				...
				var reactEmoji = "\u269B";
				var warningEmoji = "\u26D4";
				var supportsUserTiming = typeof performance !==
					'undefined' &&
					typeof performance.mark ===
					'function' &&
					typeof performance.clearMarks ===
					'function' &&
					typeof performance.measure ===
					'function' &&
					typeof performance.clearMeasures ===
					'function'; // Keep track of current fiber so that we know the path to unwind on pause.
				...
				function stopFailedWorkTimer( fiber ) {
					{
						...
						fiber._debugIsCurrentlyTiming = false;
						var warning = fiber.tag === SuspenseComponent ?
				...
				function stopCommitSnapshotEffectsTimer() {
					{
						...
						effectCountInCurrentCommit = 0;
						endMark( "(Committing Snapshot Effects: " +
							count +
							" Total)", '(Committing Snapshot Effects)', null );
					}
				}
				...
				function stopCommitHostEffectsTimer() {
					{
						...
						var count = effectCountInCurrentCommit;
						effectCountInCurrentCommit = 0;
						endMark( "(Committing Host Effects: " +
							count +
							" Total)", '(Committing Host Effects)', null );
					}
				}
				...
				function stopCommitLifeCyclesTimer() {
					{
						...
						var count = effectCountInCurrentCommit;
						effectCountInCurrentCommit = 0;
						endMark( "(Calling Lifecycle Methods: " +
							count +
							" Total)", '(Calling Lifecycle Methods)', null );
					}
				}
				...
				function getUnmaskedContext(
					...
					{
						if ( didPushOwnContextIfProvider &&
				...
				function processChildContext( fiber, type, parentContext ) {
					{
						...
						{
							var name = getComponentName( type ) || 'Unknown';
							checkPropTypes_1( childContextTypes,
								childContext,
								'child context',
				...
				function invalidateContextProvider(
				...
				) {
					{
						...
						if ( didChange ) {
							...
							instance.__reactInternalMemoizedMergedChildContext
								= mergedContext; // Replace the old (or empty) context with the new one.
				...
				function computeExpirationBucket(
					...
					return MAGIC_NUMBER_OFFSET -
						ceiling( MAGIC_NUMBER_OFFSET -
							currentTime +
							expirationInMs /
							UNIT_SIZE, bucketSizeMs / UNIT_SIZE );
				...
				function inferPriorityFromExpirationTime(
					...
					var msUntil = expirationTimeToMs( expirationTime ) -
...

				{
					...
					ReactStrictModeWarnings.recordUnsafeLifecycleWarnings
						...
						if ( typeof instance.componentWillMount ===
						...
						if ( typeof instance.componentWillReceiveProps ===
							'function' &&
						...
						if ( typeof instance.componentWillUpdate ===
							'function' &&
					...
					ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings
						...
						if ( pendingUNSAFE_ComponentWillMountWarnings.length >
							0 ) {
						...
						if ( pendingComponentWillReceivePropsWarnings.length >
							0 ) {
						...
						if ( pendingUNSAFE_ComponentWillReceivePropsWarnings.length >
							0 ) {
						...
						if ( pendingUNSAFE_ComponentWillUpdateWarnings.length >
							0 ) {
						...
						if ( UNSAFE_componentWillReceivePropsUniqueNames.size >
							0 ) {
					...
					ReactStrictModeWarnings.flushLegacyContextWarning
						...
						pendingLegacyContextWarning.forEach( function(
							...
							fiberArray.forEach( function( fiber ) {
								uniqueNames.add( getComponentName( fiber.type ) ||
									'Component' );
								didWarnAboutLegacyContext.add( fiber.type );
							} );
							var sortedNames = setToSortedString( uniqueNames );
							var firstComponentStack = getStackByFiberInDevAndProd(
								firstFiber );
				...
				function isCompatibleFamilyForHotReloading( fiber, element ) {
					{
						...
						var $$typeofNextType = typeof nextType ===
						'object' &&
						nextType !==
						null ? nextType.$$typeof : null;
				...
				function calculateChangedBits( context, newValue, oldValue ) {
					if ( objectIs( oldValue, newValue ) ) {
						...
						var changedBits = typeof context._calculateChangedBits ===
						'function' ?
				...
				function propagateContextChange(
					...
					while ( fiber !== null ) {
						...
						if ( list !== null ) {
							...
							nextFiber = fiber.type === workInProgress.type ?
								null :
								fiber.child;
						} else {
							// Traverse down.
				...
				function prepareToReadContext(
					...
					if ( dependencies !== null ) {
						...
						if ( firstContext !== null ) {
							if ( dependencies.expirationTime >=
								renderExpirationTime ) {
				...
				function readContext( context, observedBits ) {
					...
					if ( lastContextWithAllBitsObserved ===
						context ) ; else if ( observedBits ===
						false ||
						observedBits ===
						0 ) ; else {
						var resolvedObservedBits; // Avoid deopting on observable arguments or heterogeneous types.

						if ( typeof observedBits !==
							'number' ||
							observedBits ===
							MAX_SIGNED_31_BIT_INT ) {
							// Observe all updates.
...

				{
					...
					warnOnUndefinedDerivedState = function(
						...
						if ( partialState === undefined ) {
							...
							if ( ! didWarnAboutUndefinedDerivedState.has(
								componentName ) ) {
				...
				function applyDerivedStateFromProps(
					...
					var memoizedState = partialState ===
					null ||
					partialState ===
					undefined ?
						prevState :
				...
				function checkClassInstance( workInProgress, ctor, newProps ) {
...

					{
						...
						if ( typeof instance.componentShouldUpdate ===
							'function' ) {
						...
						if ( typeof instance.componentDidUnmount ===
							'function' ) {
							error( '%s has a method called ' +
						...
						if ( typeof instance.componentDidReceiveProps ===
							'function' ) {
							error(
						...
						if ( typeof instance.componentWillRecieveProps ===
							'function' ) {
							error(
								'%s has a method called ' +
						...
						if ( typeof instance.UNSAFE_componentWillRecieveProps ===
							'function' ) {
							error(
								'%s has a method called ' +
						...
						if ( typeof instance.getSnapshotBeforeUpdate ===
							'function' &&
						...
						if ( typeof instance.getDerivedStateFromProps ===
							'function' ) {
							error(
						...
						if ( typeof instance.getDerivedStateFromError ===
							'function' ) {
							error(
				...
				function constructClassInstance( workInProgress, ctor, props ) {
...

					{
						if ( 'contextType' in ctor ) {
							var isValid = // Allow null for conditional declaration
								...
								undefined; // Not a <Context.Consumer>
							...
							if ( ! isValid &&
								...
								if ( contextType === undefined ) {
									...
									addendum = ' However, it is set to a ' +
										typeof contextType +
										'.';
...

					{
						if ( typeof ctor.getDerivedStateFromProps ===
							...
							state ===
							null ) {
							var componentName = getComponentName( ctor ) ||
								'Component';

							if ( ! didWarnAboutUninitializedState.has(
								componentName ) ) {
						...
						if ( typeof ctor.getDerivedStateFromProps ===
							...
							} else if ( typeof instance.UNSAFE_componentWillMount ===
								'function' ) {
								foundWillMountName
							...
							if ( typeof instance.componentWillReceiveProps ===
								...
								foundWillReceivePropsName
									= 'componentWillReceiveProps';
							} else if ( typeof instance.UNSAFE_componentWillReceiveProps ===
								'function' ) {
								foundWillReceivePropsName
							...
							if ( foundWillMountName !==
								null ||
								foundWillReceivePropsName !==
								null ||
								foundWillUpdateName !==
								null ) {
								var _componentName = getComponentName( ctor ) ||
									'Component';
								...
								if ( ! didWarnAboutLegacyLifecyclesAndDerivedState.has(
									_componentName ) ) {
				...
				function callComponentWillReceiveProps(
					...
					if ( typeof instance.UNSAFE_componentWillReceiveProps ===
						'function' ) {
					...
					if ( instance.state !== oldState ) {
						{
							...
							if ( ! didWarnAboutStateAssignmentForComponent.has(
								componentName ) ) {
				...
				function mountClassInstance(
...

					{
						if ( instance.state === newProps ) {
							...
							if ( ! didWarnAboutDirectlyAssigningPropsToState.has(
								componentName ) ) {
				...
				function resumeMountClassInstance(
					...
					if ( oldProps ===
						...
						if ( typeof instance.componentDidMount ===
							'function' ) {
							workInProgress.effectTag |= Update;
						}
					...
					var shouldUpdate = checkHasForceUpdateAfterProcessing() ||
						checkShouldComponentUpdate( workInProgress,
							ctor,
							oldProps,
							newProps,
							oldState,
				...
				function updateClassInstance(
					...
					cloneUpdateQueue( current, workInProgress );
					var oldProps = workInProgress.memoizedProps;
					instance.props = workInProgress.type ===
					...
					if ( oldProps ===
						...
						// If an update was already in progress, we should schedule an Update
						// effect even though we're bailing out, so that cWU/cDU are called.
						if ( typeof instance.componentDidUpdate ===
							'function' ) {
							if ( oldProps !==
...

				{
					...
					warnForMissingKey = function( child ) {
						...
						var currentComponentErrorInfo = 'Each child in a list should have a unique ' +
				...
				function coerceRef( returnFiber, current, element ) {
					...
					if ( mixedRef !==
						...
						if ( element._owner ) {
							...
							if ( ! inst ) {
								{
									throw Error( "Missing owner for string ref " +
										mixedRef +
										". This error is likely caused by a bug in React. Please file an issue." );
								}
							}
				...
				function ChildReconciler( shouldTrackSideEffects ) {
					...
					function updatePortal(
						...
						if ( current ===
							...
							current.stateNode.implementation !==
					...
					function updateFromMap(
						...
						if ( typeof newChild ===
							...
							var matchedFiber = existingChildren.get( newIdx ) ||
								null;
							return updateTextNode(
								returnFiber,
								matchedFiber,
							...
							if ( _newFiber2 !== null ) {
								if ( shouldTrackSideEffects ) {
									if ( _newFiber2.alternate !== null ) {
										...
										// list.
										existingChildren.delete( _newFiber2.key ===
										null ? newIdx : _newFiber2.key );
									}
								}
					...
					function reconcileChildrenIterator(
...

						{
							...
							if ( typeof Symbol ===
								'function' && // $FlowFixMe Flow doesn't know about toStringTag
							...
							if ( _newFiber4 !== null ) {
								if ( shouldTrackSideEffects ) {
									if ( _newFiber4.alternate !== null ) {
										...
										// it from the child list so that we don't add it to the deletion
										// list.
										existingChildren.delete( _newFiber4.key ===
										null ? newIdx : _newFiber4.key );
									}
								}
					...
					function reconcileChildFibers(
						...
						var isUnkeyedTopLevelFragment = typeof newChild ===
							'object' &&
							newChild !==
							null &&
							newChild.type ===
						...
						if ( isObject ) {
							switch ( newChild.$$typeof ) {
								...
								case REACT_PORTAL_TYPE:
									return placeSingleChild(
										reconcileSinglePortal( returnFiber,
											currentFirstChild,
											newChild,
											expirationTime
										) );
				...
				function findFirstSuspended( row ) {
					...
					while ( node !== null ) {
						if ( node.tag === SuspenseComponent ) {
							...
							SuspenseListComponent && // revealOrder undefined can't be trusted because it don't
							// keep track of whether it suspended or not.
							node.memoizedProps.revealOrder !==
							undefined ) {
							var didSuspend = (
								node.effectTag & DidCapture
							) !== NoEffect;
				...
				function updateHookTypesDev() {
					{
						...
						if ( hookTypesDev !== null ) {
							...
							if ( hookTypesDev[ hookTypesUpdateIndexDev ] !==
								hookName ) {
				...
				function warnOnHookMismatchInDev( currentHookName ) {
					{
						...
						if ( ! didWarnAboutMismatchedHooksForComponent.has(
							componentName ) ) {
				...
				function renderWithHooks(
					...
					if ( workInProgress.expirationTime ===
						renderExpirationTime ) {
						...
						} while ( workInProgress.expirationTime ===
						renderExpirationTime );
					...
					var didRenderTooFewHooks = currentHook !==
						null &&
						currentHook.next !==
						null;
				...
				function mountDeferredValue( value, config ) {
					...
					mountEffect( function() {
						...
						ReactCurrentBatchConfig$1.suspense = config ===
				...
				function startTransition( setPending, config, callback ) {
					...
					runWithPriority$1( priorityLevel < UserBlockingPriority$1 ?
						UserBlockingPriority$1 :
						priorityLevel, function() {
						setPending( true );
					} );
					runWithPriority$1( priorityLevel > NormalPriority ?
						NormalPriority :
						priorityLevel, function() {
						var previousConfig = ReactCurrentBatchConfig$1.suspense;
						ReactCurrentBatchConfig$1.suspense = config ===
				...
				function mountTransition( config ) {
					...
					var start = mountCallback( startTransition.bind(
						null,
						setPending,
						config
					), [ setPending, config ] );
				...
				function updateTransition( config ) {
					...
					var start = updateCallback( startTransition.bind(
						null,
						setPending,
						config
					), [ setPending, config ] );
...

				{
					...
					HooksDispatcherOnMountInDEV = {
						...
						useResponder: function( responder, props ) {
							...
							mountHookTypesDev();
							return createDeprecatedResponderListener(
								responder,
								props
							);
						},
				...
				function updateForwardRef(
					...
					// We'll need to figure out if this is fine or can cause issues.
					{
						if ( workInProgress.type !==
							...
							if ( innerPropTypes ) {
								checkPropTypes_1( innerPropTypes,
				...
				function updateMemoComponent(
					...
					if ( current === null ) {
						...
						if ( isSimpleFunctionComponent( type ) &&
							Component.compare ===
							null && // SimpleMemoComponent codepath doesn't resolve outer props either.
...

					{
						...
						if ( _innerPropTypes ) {
							// Inner memo component props aren't currently validated in createElement.
							// We could move it there, but we'd still need this for lazy code path.
							checkPropTypes_1( _innerPropTypes,
								nextProps, // Resolved props
								'prop',
				...
				function updateSimpleMemoComponent(
					...
					// We'll need to figure out if this is fine or can cause issues.
					{
						if ( workInProgress.type !==
							...
							var outerPropTypes = outerMemoType &&
								outerMemoType.propTypes;

							if ( outerPropTypes ) {
								checkPropTypes_1( outerPropTypes,
				...
				function updateHostRoot(
					...
					var nextProps = workInProgress.pendingProps;
					var prevState = workInProgress.memoizedState;
					var prevChildren = prevState !== null ?
						prevState.element :
						null;
					cloneUpdateQueue( current, workInProgress );
					processUpdateQueue(
				...
				function mountLazyComponent(
					...
					switch ( resolvedTag ) {
						...
						case MemoComponent: {
							...
							child = updateMemoComponent( null,
								workInProgress,
								Component,
								resolveDefaultProps(
									Component.type,
				...
				function mountIndeterminateComponent(
					...
					if ( typeof value ===
						...
						undefined ) {
						{
							var _componentName = getComponentName( Component ) ||
								'Unknown';
				...
				function validateFunctionComponentInDev(
				...
				) {
					{
						...
						if ( typeof Component.getDerivedStateFromProps ===
							'function' ) {
							var _componentName2 = getComponentName( Component ) ||
								'Unknown';
						...
						if ( typeof Component.contextType ===
							'object' &&
							Component.contextType !==
							null ) {
							var _componentName3 = getComponentName( Component ) ||
								'Unknown';
						...
						if ( nextDidTimeout ) {
							...
							if ( (
								...
								null ?
									workInProgress.child.child :
									workInProgress.child;
								primaryChildFragment.child
									= progressedPrimaryChild;
								var progressedChild = progressedPrimaryChild;

								while ( progressedChild !== null ) {
									progressedChild.return
							...
							primaryChildFragment.sibling
								= fallbackChildFragment; // Skip the primary children, and continue working on the
							// fallback children.
						...
						if ( prevState !== null ) {
							...
							if ( nextDidTimeout ) {
								...
								if ( (
									...
									var _progressedPrimaryChild = _progressedState !==
									null ?
										workInProgress.child.child :
										workInProgress.child;

									if ( _progressedPrimaryChild !==
								...
								_primaryChildFragment2.childExpirationTime
									= NoWork; // Skip the primary children, and continue working on the
								// fallback children.
							...
							if ( nextDidTimeout ) {
								...
								if ( (
									...
									var _progressedPrimaryChild2 = _progressedState2 !==
									null ?
										workInProgress.child.child :
										workInProgress.child;
				...
				function validateSuspenseListNestedChild( childSlot, index ) {
					{
						...
						var isIterable = ! isArray &&
							typeof getIteratorFn( childSlot ) ===
							'function';
				...
				function beginWork(
						...
						if ( oldProps !==
							...
							switch ( workInProgress.tag ) {
								...
								case SuspenseListComponent: {
									...
									var _hasChildWork = workInProgress.childExpirationTime >=
										renderExpirationTime;
					...
					switch ( workInProgress.tag ) {
						...
						case FunctionComponent: {
							...
							var resolvedProps = workInProgress.elementType ===
							_Component ?
								unresolvedProps :
								resolveDefaultProps(
									_Component,
						...
						case ClassComponent: {
							...
							var _resolvedProps = workInProgress.elementType ===
							_Component2 ?
								_unresolvedProps :
								resolveDefaultProps(
									_Component2,
						...
						case ForwardRef: {
							...
							var _resolvedProps2 = workInProgress.elementType ===
							type ?
								_unresolvedProps2 :
						...
						case IncompleteClassComponent: {
							...
							var _resolvedProps4 = workInProgress.elementType ===
							_Component3 ?
								_unresolvedProps4 :
								resolveDefaultProps(
									_Component3,
					...
					appendAllChildren = function(
						...
						while ( node !== null ) {
							if ( node.tag ===
								...
								HostPortal ) ; else if ( node.child !== null ) {
								node.child.return = node;
								node = node.child;
								continue;
							}
					...
					switch ( workInProgress.tag ) {
						...
						case SuspenseComponent: {
							...
							if ( (
								...
								workInProgress.expirationTime
									= renderExpirationTime; // Do not reset the effect list.
							...
							if ( current === null ) {
								if ( workInProgress.memoizedProps.fallback !==
									undefined ) {
							...
							if ( nextDidTimeout && ! prevDidTimeout ) {
								...
								if ( (
									...
									var hasInvisibleChildContext = current ===
										null &&
						...
						case SuspenseListComponent: {
							...
							if ( renderedTail === null ) {
								...
								if ( ! didSuspendAlready ) {
									...
									if ( _suspended !== null ) {
										...
										var nextPriority = renderExpirationTime -
											1;
										workInProgress.expirationTime
											= workInProgress.childExpirationTime
											= nextPriority;
							...
							if ( renderState.tail !== null ) {
								...
								if ( renderState.tailExpiration === 0 ) {
									...
									renderState.tailExpiration = now() +
										TAIL_EXPIRATION_TIMEOUT_MS; // TODO: This is meant to mimic the train model or JND but this
				...
				function unwindWork( workInProgress, renderExpirationTime ) {
					switch ( workInProgress.tag ) {
						...
						case HostRoot: {
							...
							workInProgress.effectTag = _effectTag &
								~ShouldCapture |
								DidCapture;
							return workInProgress;
						}
						...
						case SuspenseComponent: {
							...
							if ( _effectTag2 & ShouldCapture ) {
								workInProgress.effectTag = _effectTag2 &
									~ShouldCapture |
									DidCapture; // Captured a suspense effect. Re-render the boundary.
				...
				var PossiblyWeakSet = typeof WeakSet === 'function' ?
					WeakSet :
					Set;
				...
				function commitHookEffectListUnmount( tag, finishedWork ) {
					...
					var lastEffect = updateQueue !== null ?
				...
				function commitPassiveHookEffects( finishedWork ) {
					if ( (
						finishedWork.effectTag & Passive
					) !== NoEffect ) {
						switch ( finishedWork.tag ) {
							case FunctionComponent:
							case ForwardRef:
							...
							case Block: {
								...
								commitHookEffectListUnmount( Passive$1 |
									HasEffect, finishedWork );
								commitHookEffectListMount( Passive$1 |
									HasEffect, finishedWork );
								break;
							}
						}
						...
						case ClassComponent: {
							...
							if ( finishedWork.effectTag & Update ) {
								if ( current === null ) {
									...
									var prevProps = finishedWork.elementType ===
									finishedWork.type ?
										current.memoizedProps :
										resolveDefaultProps(
											finishedWork.type,
							...
							if ( updateQueue !== null ) {
								...
								if ( lastEffect !== null ) {
...

									{
										...
										var priorityLevel = renderPriorityLevel >
										NormalPriority ?
											NormalPriority :
											renderPriorityLevel;
										runWithPriority$1(
				...
				var PossiblyWeakMap$1 = typeof WeakMap === 'function' ?
					WeakMap :
					Map;
				...
				function createClassErrorUpdate(
					...
					if ( inst !==
						...
						update.callback = function callback() {
							...
							if ( typeof getDerivedStateFromError !==
								'function' ) {
						...
						switch ( workInProgress.tag ) {
							...
							case ClassComponent:
								...
								if ( (
									...
									workInProgress.effectTag |= ShouldCapture;
									workInProgress.expirationTime
										= renderExpirationTime; // Schedule the error boundary to re-render using updated state
					...
					if ( suspenseConfig !== null ) {
						...
						switch ( priorityLevel ) {
							...
							default: {
								{
									throw Error(
										"Expected a valid priority level" );
								}
							}
				...
				function getNextRootExpirationTimeToWorkOn( root ) {
					...
					var nextLevel = lastPingedTime > nextKnownPendingLevel ?
						lastPingedTime :
				...
				function ensureRootIsScheduled( root ) {
					...
					if ( existingCallbackNode !== null ) {
						...
						if ( // Callback must have the exact same expiration time.
							...
							expirationTime && // Callback must have greater or equal priority.
					...
					if ( expirationTime === Sync ) {
						...
						callbackNode = scheduleCallback( priorityLevel,
				...
				function finishConcurrentRender(
					...
					switch ( exitStatus ) {
						...
						case RootSuspended: {
							...
							var hasNotProcessedNewUpdates = workInProgressRootLatestProcessedExpirationTime ===
								Sync;
						...
						case RootSuspendedWithDelay: {
							...
							if ( // do not delay if we're inside an act() scope
								...
								var _nextTime = getNextRootExpirationTimeToWorkOn(
									root );
								...
								if ( workInProgressRootLatestSuspenseTimeout !==
									Sync ) {
									// We have processed a suspense config whose expiration time we
									// can use as the timeout.
									_msUntilTimeout = expirationTimeToMs(
										workInProgressRootLatestSuspenseTimeout ) -
										now();
								} else if ( workInProgressRootLatestProcessedExpirationTime ===
									Sync ) {
									...
									var timeUntilExpirationMs = expirationTimeToMs(
										expirationTime ) - currentTimeMs;
									var timeElapsed = currentTimeMs -
										eventTimeMs;
									...
									_msUntilTimeout = jnd( timeElapsed ) -
										timeElapsed; // Clamp the timeout to the expiration time. TODO: Once the
									// event time is exact instead of inferred from expiration time
									// we don't need this.

									if ( timeUntilExpirationMs <
										_msUntilTimeout ) {
				...
				function performSyncWorkOnRoot( root ) {
					...
					var lastExpiredTime = root.lastExpiredTime;
					var expirationTime = lastExpiredTime !== NoWork ?
						lastExpiredTime :
						Sync;
				...
				function markRenderEventTimeAndConfig(
					...
					if ( suspenseConfig !== null ) {
						if ( expirationTime <
							...
							Idle ) {
							workInProgressRootLatestSuspenseTimeout
								= expirationTime; // Most of the time we only have one config and getting wrong is not bad.
				...
				function renderDidSuspendDelayIfPossible() {
					...
					if ( workInProgressRootNextUnprocessedUpdateTime !==
						NoWork &&
						workInProgressRoot !==
						null ) {
				...
				function completeUnitOfWork( unitOfWork ) {
					...
					do {
						...
						if ( (
							...
							if ( returnFiber !==
								null && // Do not append effects to parents if a sibling failed to complete
								(
				...
				function resetChildExpirationTime( completedWork ) {
					...
					if ( (
						...
						var shouldBubbleActualDurations = completedWork.alternate ===
							null ||
							completedWork.child !==
						...
						while ( child !== null ) {
							...
							if ( childUpdateExpirationTime >
								newChildExpirationTime ) {
								newChildExpirationTime
									= childUpdateExpirationTime;
							}

							if ( childChildExpirationTime >
								newChildExpirationTime ) {
								newChildExpirationTime
						...
						while ( _child !== null ) {
							...
							if ( _childUpdateExpirationTime >
								newChildExpirationTime ) {
								newChildExpirationTime
									= _childUpdateExpirationTime;
							}

							if ( _childChildExpirationTime >
								newChildExpirationTime ) {
								newChildExpirationTime
				...
				function commitMutationEffects( root, renderPriorityLevel ) {
					...
					while ( nextEffect !== null ) {
						...
						var primaryEffectTag = effectTag &
							(
				...
				function flushPassiveEffects() {
					if ( pendingPassiveEffectsRenderPriority !== NoPriority ) {
						var priorityLevel = pendingPassiveEffectsRenderPriority >
						NormalPriority ?
							NormalPriority :
							pendingPassiveEffectsRenderPriority;
				...
				function flushPassiveEffectsImpl() {
					...
					nestedPassiveUpdateCount = rootWithPendingPassiveEffects ===
					null ? 0 : nestedPassiveUpdateCount + 1;
					return true;
				}

				function isAlreadyFailedLegacyErrorBoundary( instance ) {
					return legacyErrorBoundariesThatAlreadyFailed !==
						null &&
				...
				function computeMsUntilSuspenseLoadingDelay(
					...
					var busyMinDurationMs = suspenseConfig.busyMinDurationMs |
						0;
					...
					var msUntilTimeout = busyDelayMs +
						busyMinDurationMs -
						timeElapsed; // This is the value that is passed to `setTimeout`.
								...
								case SimpleMemoComponent: {
									...
									if ( ! didWarnAboutUpdateInRenderForAnotherComponent.has(
										...
										didWarnAboutUpdateInRenderForAnotherComponent.add(
											dedupeKey );
										var setStateComponentName = getComponentName(
											fiber.type ) || 'Unknown';
				...
				function warnIfNotScopedWithMatchingAct( fiber ) {
					{
						if ( IsSomeRendererActing.current ===
							true &&
							IsThisRendererActing.current !==
							true ) {
							error(
				...
				function warnIfUnmockedScheduler( fiber ) {
					{
						if ( didWarnAboutUnmockedScheduler ===
							false &&
				...
				function finishPendingInteractions(
					...
					try {
						...
						if ( subscriber !==
							null &&
							root.memoizedInteractions.size >
							0 ) {
							var threadID = computeThreadID(
								root,
								committedExpirationTime
				...
				var isDevToolsPresent = typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ !==
					'undefined';

				function injectInternals( internals ) {
					if ( typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ ===
						'undefined' ) {
						// No DevTools
						return false;
					}
					...
					try {
						...
						onCommitFiberRoot = function( root, expirationTime ) {
							try {
								var didError = (
									root.current.effectTag & DidCapture
								) === DidCapture;
				...
				function createWorkInProgress( current, pendingProps ) {
...

					{
						...
						switch ( workInProgress.tag ) {
							...
							case SimpleMemoComponent:
								workInProgress.type
									= resolveFunctionForHotReloading( current.type );
								break;

							case ClassComponent:
								workInProgress.type
									= resolveClassForHotReloading( current.type );
								break;

							case ForwardRef:
								workInProgress.type
									= resolveForwardRefForHotReloading( current.type );
								break;
						}
					}
				...
				function resetWorkInProgress(
					...
					if ( current === null ) {
						...
						var currentDependencies = current.dependencies;
						workInProgress.dependencies = currentDependencies ===
						null ? null : {
							expirationTime: currentDependencies.expirationTime,
							firstContext: currentDependencies.firstContext,
							responders: currentDependencies.responders
				...
				function createFiberFromProfiler(
					...
					{
						if ( typeof pendingProps.id !==
							'string' ||
							typeof pendingProps.onRender !==
							'function' ) {
							error(
				...
				function markRootUpdatedAtTime( root, expirationTime ) {
					...
					if ( firstSuspendedTime !== NoWork ) {
						if ( expirationTime >= firstSuspendedTime ) {
							...
							root.firstSuspendedTime = root.lastSuspendedTime
								= root.nextKnownPendingLevel = NoWork;
				...
				function markRootFinishedAtTime(
					...
					if ( finishedExpirationTime <= root.lastSuspendedTime ) {
						...
						root.firstSuspendedTime = root.lastSuspendedTime
							= root.nextKnownPendingLevel = NoWork;
					} else if ( finishedExpirationTime <=
				...
				function createRootImpl( container, tag, options ) {
					...
					var hydrationCallbacks = options !=
						null &&
					...
					if ( hydrate && tag !== LegacyRoot ) {
						var doc = container.nodeType === DOCUMENT_NODE ?
							container :
				...
				function legacyCreateRootFromDOMContainer(
					...
					var shouldHydrate = forceHydrate ||
						shouldHydrateDueToLegacyHeuristic( container ); // First clear any existing content.
				...
				function legacyRenderSubtreeIntoContainer(
				...
				) {
					{
						...
						warnOnInvalidCallback$1( callback === undefined ?
							null :
							callback, 'render' );
				...
				function unstable_renderSubtreeIntoContainer(
					...
					if ( ! (
						parentComponent != null && has$1( parentComponent )
					) ) {
						{
							throw Error(
				...
				function unmountComponentAtNode( container ) {
					...
					if ( container._reactRootContainer ) {
					...
					} else {
						{
							...
							var isContainerReactRoot = container.nodeType ===
								ELEMENT_NODE &&
				...
				{
					if ( typeof Map !==
						'function' || // $FlowIssue Flow incorrectly thinks Map has no prototype
						Map.prototype ==
						null ||
