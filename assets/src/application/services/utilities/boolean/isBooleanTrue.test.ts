...
const testCases = [
	...
	{
		desc: 'returns false when input is "true"',
		input: 'true',
		result: false,
	},
	{
		desc: 'returns false when input is "1"',
		input: '1',
		result: false,
	},
	{
		desc: 'returns false when input is "yes"',
		input: 'yes',
		result: false,
	},
	{
	...
	{
		desc: 'returns false when input is a positive number',
		input: 56,
		result: false,
	},
	{
		desc: 'returns false when input is a negative number',
		input: -56,
		result: false,
	},
	{
...
describe('isBooleanTrue', () => {
	testCases.forEach(({ desc, input, result }) => {
		it(desc, () => {
			expect(isBooleanTrue(input)).toBe(result);
		});
	});
});
