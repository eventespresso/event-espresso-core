...
import { currencySignCharacterCount, currencySignPositionClass } from './utils';
...
const usePriceTypeHtmlClass = (priceType = null) => {
	const isPercent = isModelEntityOfModel(priceType, 'price_type') ? priceType.isPercent : false;
	return useMemo(() => {
