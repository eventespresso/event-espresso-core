...
/*!******************************************************!*\
  !*** ./assets/src/data/model/base-date-formatter.js ***!
  \******************************************************/
/*! exports provided: formatDatesOnEntities, formatDatesOnEntity, datesToMysqlFormatOnEntities, datesToMysqlFormatOnEntity, datesToSiteFormatOnEntities, datesToSiteFormatOnEntity, datesToMomentOnEntities, datesToMomentOnEntity */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "datesToMysqlFormatOnEntities", function() { return datesToMysqlFormatOnEntities; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "datesToMysqlFormatOnEntity", function() { return datesToMysqlFormatOnEntity; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "datesToSiteFormatOnEntities", function() { return datesToSiteFormatOnEntities; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "datesToSiteFormatOnEntity", function() { return datesToSiteFormatOnEntity; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "datesToMomentOnEntities", function() { return datesToMomentOnEntities; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "datesToMomentOnEntity", function() { return datesToMomentOnEntity; });
 ...
 *   values formatted
 */
var datesToMysqlFormatOnEntities = function datesToMysqlFormatOnEntities() {
	var entities = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	var entityDateFields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
 ...
 * @return { Object }  Returns a new entity with the date field values formatted
 */
var datesToMysqlFormatOnEntity = function datesToMysqlFormatOnEntity() {
	var entity = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	var entityDateFields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
	var local = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
 ...
 *   values formatted
 */
var datesToSiteFormatOnEntities = function datesToSiteFormatOnEntities() {
	var entities = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	var entityDateFields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
	var local = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
 ...
 * @return { Object }  Returns a new entity with the date field values formatted
 */
var datesToSiteFormatOnEntity = function datesToSiteFormatOnEntity() {
	var entity = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	var entityDateFields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
	var local = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
 ...
 */
var datesToMomentOnEntities = function datesToMomentOnEntities() {
	var entities = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
	var entityDateFields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
	...
	var formattedEntities = [];
	entities.forEach(function (entity) {
		formattedEntities.push(datesToMomentOnEntity(entity, entityDateFields));
	});
	return formattedEntities;
};
 ...
 *   to moment objects.
 */
var datesToMomentOnEntity = function datesToMomentOnEntity() {
	var entity = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	var entityDateFields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
...
var prettyDateFromDateTime = function prettyDateFromDateTime() {
	...
	var content = DateTimeEntity.DTT_name ? DateTimeEntity.DTT_name + ' (' : '';
