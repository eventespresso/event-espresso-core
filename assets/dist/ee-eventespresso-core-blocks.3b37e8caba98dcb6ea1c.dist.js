...
/* harmony import */ var _list__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./list */ "./assets/src/blocks/widgets/event-attendees/list.js");
...
var EventAttendeesEditor = function (_Component) {
	...
	babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(EventAttendeesEditor, [{
		...
		value: function getAttendeesDisplay() {
			return React.createElement(_list__WEBPACK_IMPORTED_MODULE_15__["EventAttendeesList"], { attendees: this.props.attendees });
		}
	}, {
		key: 'render',
			...
			var inspectorControls = React.createElement(
				...
				React.createElement(
					...
					React.createElement(_eventespresso_components__WEBPACK_IMPORTED_MODULE_10__["EditorStatusSelect"], {
						...
						selectLabel: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_9__["__"])('Select Registration Status', 'event_espresso')
					}),
...
/***/ "./assets/src/blocks/widgets/event-attendees/list.js":
/*!***********************************************************!*\
  !*** ./assets/src/blocks/widgets/event-attendees/list.js ***!
  \***********************************************************/
/*! exports provided: EventAttendeesList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(React) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventAttendeesList", function() { return EventAttendeesList; });
...
var EventAttendeesList = function EventAttendeesList(_ref) {
	var attendees = _ref.attendees;

	return !Object(lodash__WEBPACK_IMPORTED_MODULE_1__["isEmpty"])(attendees) ? React.createElement(
		'div',
		{ key: 'events-attendees-block', className: 'event-attendees-block-div' },
		React.createElement(
			'h3',
			null,
			Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('Event Attendees', 'event_espresso')
		),
		React.createElement(
			'ul',
			{ className: 'event-attendees-ul' },
			attendees.map(function (attendee, index) {
				var avatar = typeof attendee._calculated_fields !== 'undefined' ? React.createElement(_eventespresso_components__WEBPACK_IMPORTED_MODULE_2__["AvatarImage"], {
					avatarUrl: attendee._calculated_fields.userAvatar,
					avatarClass: 'event-attendee'
				}) : '';
				return React.createElement(
					'li',
					{ key: index, className: 'event-attendee-li' },
					React.createElement(
						'p',
						null,
						avatar,
						React.createElement(
							'span',
							{ className: 'event-attendee-name-span' },
