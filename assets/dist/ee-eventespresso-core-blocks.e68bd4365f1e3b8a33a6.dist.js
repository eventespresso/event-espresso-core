...
/***/ "./assets/src/blocks/components/index.js":
/*!***********************************************!*\
  !*** ./assets/src/blocks/components/index.js ***!
  \***********************************************/
/*! exports provided: NotPostTypeCheck */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _not_post_type_check__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./not-post-type-check */ "./assets/src/blocks/components/not-post-type-check/index.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NotPostTypeCheck", function() { return _not_post_type_check__WEBPACK_IMPORTED_MODULE_0__["default"]; });



/***/ }),

/***/ "./assets/src/blocks/components/not-post-type-check/index.js":
/*!*******************************************************************!*\
  !*** ./assets/src/blocks/components/not-post-type-check/index.js ***!
  \*******************************************************************/
/*! exports provided: NotPostTypeCheck, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NotPostTypeCheck", function() { return NotPostTypeCheck; });
...
function NotPostTypeCheck(_ref) {
...
/* harmony import */ var _babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @babel/runtime-corejs2/core-js/map */ "./node_modules/@babel/runtime-corejs2/core-js/map.js");
/* harmony import */ var _babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_12__);
...
/* harmony import */ var _eventespresso_model__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @eventespresso/model */ "@eventespresso/model");
/* harmony import */ var _eventespresso_model__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(_eventespresso_model__WEBPACK_IMPORTED_MODULE_19__);
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../constants */ "./assets/src/blocks/constants.js");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../components */ "./assets/src/blocks/components/index.js");
...
var DEFAULT_MAP = new _babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_12___default.a();
/**
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_corejs2_helpers_inherits__WEBPACK_IMPORTED_MODULE_9___default()(EventAttendeesEditor, _Component);
  ...
  function EventAttendeesEditor(props) {
    ...
    _babel_runtime_corejs2_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_5___default()(this, EventAttendeesEditor);

    _this = _babel_runtime_corejs2_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_7___default()(this, _babel_runtime_corejs2_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_8___default()(EventAttendeesEditor).call(this, props));

    _babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_11___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_this)), "setEventId", function (eventId) {
      var value = eventId !== null && eventId.value ? _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_4___default()(eventId.value, 10) : 0;
      ...
      _this.setState({
        datetimeQueryData: _babel_runtime_corejs2_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_3___default()({}, _this.state.datetimeQueryData, {
          forEventId: value
        })
      });
    });

    _babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_11___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_this)), "setDatetimeId", function (datetimeId) {
      var value = datetimeId !== null && datetimeId.value ? _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_4___default()(datetimeId.value, 10) : 0;
      ...
      _this.setState({
        ticketQueryData: _babel_runtime_corejs2_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_3___default()({}, _this.state.ticketQueryData, {
          forDatetimeId: value
        })
      });
    });

    _babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_11___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_this)), "setTicketId", function (ticketId) {
      var value = ticketId !== null && ticketId.value ? _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_4___default()(ticketId.value, 10) : 0;
    ...
    _babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_11___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_this)), "setStatus", function (status) {
      var value = status !== null && status.value ? status.value : _eventespresso_model__WEBPACK_IMPORTED_MODULE_19__["statusModel"].REGISTRATION_STATUS_ID.APPROVED;
    ...
    _babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_11___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_this)), "setLimit", function (limit) {
      _this.props.setAttributes({
        limit: _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_4___default()(limit, 10)
      });
    });

    _babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_11___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_this)), "setOrderBy", function (orderBy) {
      _this.props.setAttributes({
        orderBy: orderBy
      });
    });

    _babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_11___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_this)), "setOrder", function (order) {
      _this.props.setAttributes({
        order: order
      });
    });

    _babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_11___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_this)), "setAvatarSize", function (size) {
      _this.props.setAttributes({
        avatarSize: _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_4___default()(size, 10)
      });
    });
    ...
    _babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_11___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_babel_runtime_corejs2_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_10___default()(_this)), "toggleDisplayOnArchives", function (displayOnArchives) {
      _this.props.setAttributes({
    ...
    _this.state = {
      eventQueryData: _babel_runtime_corejs2_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_3___default()({}, defaultQueryData),
      datetimeQueryData: _babel_runtime_corejs2_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_3___default()({}, defaultQueryData, {
        forEventId: _eventId
      }),
      ticketQueryData: _babel_runtime_corejs2_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_3___default()({}, defaultQueryData, {
        forDatetimeId: _datetimeId
      }),
      statusQueryData: _babel_runtime_corejs2_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_3___default()({}, defaultQueryData, {
        statusType: _eventespresso_model__WEBPACK_IMPORTED_MODULE_19__["statusModel"].STATUS_TYPE_REGISTRATION
      })
    };
    return _this;
  }
  ...
  _babel_runtime_corejs2_helpers_createClass__WEBPACK_IMPORTED_MODULE_6___default()(EventAttendeesEditor, [{
    ...
    value: function getAttendeesDisplay() {
      ...
      if (isLoading) {
        return React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["Placeholder"], null, React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["Spinner"], null));
      }

      if (isNewBlock(this.props.attributes) && attendees === DEFAULT_MAP) {
        return React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["Placeholder"], null, Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('To get started, select what event you want to show attendees from in the block settings.', 'event_espresso'));
      }

      if (!isLoading && Object(lodash__WEBPACK_IMPORTED_MODULE_21__["isEmpty"])(attendees)) {
        return React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["Placeholder"], null, Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('There are no attendees for selected options.', 'event_espresso'));
      } // const newAttendees = this.applyLimit( attendees );
      // console.log( newAttendees );


      return React.createElement(_eventespresso_components__WEBPACK_IMPORTED_MODULE_18__["EventAttendeeList"], {
        attendees: this.applyLimit(attendees),
        showGravatar: showGravatar,
        avatarOptions: avatarOptions,
        isLoading: isLoading,
        containerCssClass: _constants__WEBPACK_IMPORTED_MODULE_22__["CSS_CLASS_CORE_BLOCKS"],
    ...
    value: function applyLimit(attendees) {
      ...
      return new _babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_12___default.a(_babel_runtime_corejs2_core_js_array_from__WEBPACK_IMPORTED_MODULE_2___default()(attendees.entries()).slice(0, this.props.attributes.limit));
    }
    /**
    ...
    value: function getInspectorControls(attributes) {
      var countAttendees = this.props.attendees.size || 0;
      return React.createElement(_wordpress_editor__WEBPACK_IMPORTED_MODULE_13__["InspectorControls"], null, React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["PanelBody"], {
        title: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Filter By Settings', 'event_espresso')
      }, React.createElement(_eventespresso_components__WEBPACK_IMPORTED_MODULE_18__["EditorEventSelect"], {
        key: "attendees-event-select",
        selected: attributes.eventId,
        onSelect: this.setEventId,
        queryData: this.state.eventQueryData
      }), attributes.eventId !== 0 && React.createElement(_eventespresso_components__WEBPACK_IMPORTED_MODULE_18__["EditorDatetimeSelect"], {
      ...
      }), attributes.datetimeId !== 0 && React.createElement(_eventespresso_components__WEBPACK_IMPORTED_MODULE_18__["EditorTicketSelect"], {
        key: "attendees-ticket-select",
        selected: attributes.ticketId,
        onSelect: this.setTicketId,
        queryData: this.state.ticketQueryData
      }), React.createElement(_eventespresso_components__WEBPACK_IMPORTED_MODULE_18__["EditorStatusSelect"], {
        key: "attendees-status-select",
        selected: attributes.status,
        onSelect: this.setStatus,
        queryData: this.state.statusQueryData,
        label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Select Registration Status', 'event_espresso')
      }), React.createElement(_eventespresso_components__WEBPACK_IMPORTED_MODULE_18__["QueryLimit"], {
        label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Number of Attendees to Display:', 'event_espresso'),
        limit: attributes.limit,
        onLimitChange: this.setLimit,
        min: 1,
        max: 100,
        help: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["sprintf"])(Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["_n"])('Used to adjust the number of attendees displayed (There is %d total attendee for the current filter settings).', 'Used to adjust the number of attendees displayed (There are %d total attendees for the current filter settings).', countAttendees, 'event_espresso'), countAttendees)
      }), React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["SelectControl"], {
        label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Order Attendees by:', 'event_espresso'),
        value: attributes.orderBy,
        options: [{
          label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Attendee id', 'event_espresso'),
          value: 'id'
        }, {
          label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Last name only', 'event_espresso'),
          value: 'lastNameOnly'
        }, {
          label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('First name only', 'event_espresso'),
          value: 'firstNameOnly'
        }, {
          label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('First, then Last name', 'event_espresso'),
          value: 'firstThenLastName'
        }, {
          label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Last, then First name', 'event_espresso'),
          value: 'lastThenFirstName'
        }],
        onChange: this.setOrderBy
      }), React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["SelectControl"], {
        label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Sort order:', 'event_espresso'),
        value: attributes.order,
        options: [{
          label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Ascending', 'event_espresso'),
          value: _eventespresso_model__WEBPACK_IMPORTED_MODULE_19__["QUERY_ORDER_ASC"]
        }, {
          label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Descending', 'event_espresso'),
          value: _eventespresso_model__WEBPACK_IMPORTED_MODULE_19__["QUERY_ORDER_DESC"]
        }],
        onChange: this.setOrder
      })), React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["PanelBody"], {
        title: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Gravatar Setttings', 'event_espresso')
      }, React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["ToggleControl"], {
        label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Display Gravatar', 'event_espresso'),
        checked: attributes.showGravatar,
        onChange: this.toggleShowGravatar,
        help: attributes.showGravatar ? Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Gravatar images are shown for each attendee.', 'event_espresso') : Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('No gravatar images are shown for each attendee.', 'event_espresso')
      }), attributes.showGravatar && React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["RangeControl"], {
        label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Size of Gravatar', 'event_espresso'),
        value: attributes.avatarSize,
        min: 10,
        max: 128,
        onChange: this.setAvatarSize
      })), React.createElement(_components__WEBPACK_IMPORTED_MODULE_23__["NotPostTypeCheck"], {
        excludedPostTypeSlugs: 'page'
      }, React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["PanelBody"], {
        title: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Archive Settings', 'event_espresso')
      }, React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["ToggleControl"], {
        label: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Display on Archives', 'event_espresso'),
        checked: attributes.displayOnArchives,
        onChange: this.toggleDisplayOnArchives,
        help: attributes.displayOnArchives ? Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Attendees are shown whenever this post is listed in an archive view.', 'event_espresso') : Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Attendees are hidden whenever this post is listed in an archive view.', 'event_espresso')
      }))));
    }
  }, {
    key: "render",
    value: function render() {
      return React.createElement(_wordpress_element__WEBPACK_IMPORTED_MODULE_14__["Fragment"], null, this.getAttendeesDisplay(), this.getInspectorControls(this.props.attributes));
    }
  }]);
...
_babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_11___default()(EventAttendeesEditor, "propTypes", {
  attendees: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.instanceOf(_babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_12___default.a),
  isLoading: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.bool,
  attributes: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.shape({
    eventId: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.number,
    datetimeId: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.number,
    ticketId: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.number,
    status: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.string,
    showGravatar: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.bool,
    displayOnArchives: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.bool,
    limit: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.number,
    orderBy: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.oneOf(['id', 'lastNameOnly', 'firstNameOnly', 'firstThenLastName', 'lastThenFirstName']),
    order: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.oneOf(_eventespresso_model__WEBPACK_IMPORTED_MODULE_19__["ALLOWED_ORDER_VALUES"]),
    avatarSize: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.number,
    avatarClass: prop_types__WEBPACK_IMPORTED_MODULE_20___default.a.string
  })
});

_babel_runtime_corejs2_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_11___default()(EventAttendeesEditor, "defaultProps", {
  attendees: new _babel_runtime_corejs2_core_js_map__WEBPACK_IMPORTED_MODULE_12___default.a(),
  isLoading: true,
  attributes: {
    eventId: 0,
    datetimeId: 0,
    ticketId: 0,
    status: _eventespresso_model__WEBPACK_IMPORTED_MODULE_19__["statusModel"].REGISTRATION_STATUS_ID.APPROVED,
    showGravatar: true,
    displayOnArchives: false,
    limit: 10,
    orderBy: 'lastThenFirstName',
    order: _eventespresso_model__WEBPACK_IMPORTED_MODULE_19__["QUERY_ORDER_ASC"],
    avatarSize: 24,
    avatarClass: 'contact'
  }
});

/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_16__["withSelect"])(function (select, ownProps) {
  var defaultProps = _babel_runtime_corejs2_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_3___default()({}, EventAttendeesEditor.defaultProps.attributes);
  ...
  var queryString = _eventespresso_model__WEBPACK_IMPORTED_MODULE_19__["attendeeModel"].getQueryString(queryData);
  ...
  return _babel_runtime_corejs2_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_3___default()({}, EventAttendeesEditor.defaultProps, ownProps, {
    attributes: _babel_runtime_corejs2_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_3___default()({}, EventAttendeesEditor.defaultProps.attributes, ownProps.attributes),
    attendees: isNewBlock({
      eventId: eventId,
      datetimeId: datetimeId,
      ticketId: ticketId
    }) ? DEFAULT_MAP : getAttendees(queryString),
