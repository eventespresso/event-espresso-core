  ...
  _babel_runtime_corejs2_helpers_createClass__WEBPACK_IMPORTED_MODULE_6___default()(EventAttendeesEditor, [{
    ...
    value: function getInspectorControls(attributes) {
      return React.createElement(_wordpress_editor__WEBPACK_IMPORTED_MODULE_13__["InspectorControls"], null, React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["PanelBody"], {
        ...
        min: 1,
        max: 100,
        help: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["sprintf"])(Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["_n"])('Used to adjust the number of attendees displayed (There is %d total attendee for the current filter settings).', 'Used to adjust the number of attendees displayed (There are %d total attendees for the current filter settings).', this.props.attendees.size, 'event_espresso'), this.props.attendees.size)
        ...
        title: Object(_eventespresso_i18n__WEBPACK_IMPORTED_MODULE_17__["__"])('Location Settings', 'event_espresso')
      }, React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_15__["ToggleControl"], {
