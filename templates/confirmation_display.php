              ...
              <tr>
				...
				if ( $wpdb->num_rows > 0 ){
					foreach ($x_attendees as $x_attendee){
						...
						//Create edit link
						echo '<a href="'.home_url().'/?page_id='.$event_page_id.'&amp;registration_id='.$registration_id.'&amp;id='.$x_attendee['id'].'&amp;regevent_action=register&amp;form_action=edit_attendee&amp;primary='.$attendee_id.'&amp;p_id='.$p_id.'&amp;coupon_code='.$coupon_code.'&amp;groupon_code='.$groupon_code.'">'. __('Edit', 'event_espresso').'</a>';
						//Create delete link
