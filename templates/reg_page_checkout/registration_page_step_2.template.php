<!--**********************************  STEP 2 	**********************************-->		
	...
	<h2 id="mer-reg-page-step-title-2-hdr" class="mer-reg-page-step-title-hdr">
		<?php _e('Step 2 - Payment Options', 'espresso'); ?>
		<a id="mer-reg-page-edit-step-2-lnk" class="mer-reg-page-go-to-step-2 mer-reg-page-edit-step-lnk <?php echo $step_2_edit_lnk_class; ?>" ><?php _e('edit', 'espresso'); ?></a>
	</h2>
...
<?php 
		if ( $events_requiring_pre_approval != '' ) { ?>
			<h4 class="important-notice small-text"><?php _e('Important Notice:', 'espresso');?></h4>
			<p id="events-requiring-pre-approval-pg" class="small-text drk-grey-text"><?php echo __('The following events require attendee pre-approval and will not be billed during this transaction. Billing will only occur after the attendee has been approved by the event organizer. If this is a free event, then no billing will occur.', 'espresso'); ?></p>
			<h6><?php _e('Events Requiring Pre-Approval:', 'espresso');?></h6>
...
?>
			...
			<h5><strong><?php _e('Discount Codes', 'espresso'); ?></strong></h5>
			
			<p id="mer-reg-page-coupon-code-input-pg" class="event_form_field">
				<label><?php _e('Enter discount code', 'espresso'); ?></label>			
				...
				<a id="mer-reg-page-apply-coupon-btn" class="ui-button ui-priority-secondary ui-state-default ui-corner-all add-hover-fx hide-if-no-js" href="<?php echo $mer_reg_page_ajax_coupons_url;?>" >
					<span class="ui-icon ui-icon-tag"></span><?php _e('apply&nbsp;coupon&nbsp;', 'espresso'); ?>
				</a>
			</p>
				
			<p id="mer-reg-page-coupon-codes-pg" class="smaller-text lt-grey-text hide-if-no-js">
				<?php _e('Enter any coupon codes (including Groupons) you have into the above text field and then click apply coupon. Additional coupon codes can be entered one at a time.', 'espresso'); ?>
			</p>
...
<?php } // end if $use_coupon_codes ?>
		...
		<div id="mer-reg-page-discounts-dv" class="<?php echo $reg_page_discounts_dv_class;?>">		
			<h4 class="mer-reg-page-discounts-hdr"><?php _e('Discounts:', 'espresso'); ?></h4>				
		</div>

		<h4 id="mer-reg-page-totals-hdr" class="overline-hdr">
			<span class="drk-grey-text"><?php _e('Billable Registrations:', 'espresso'); ?></span> <?php echo $total_items;?> 
			<span id="mer-reg-page-totals-spn">
				<span class="drk-grey-text"><?php echo __('Total Amount Due: ', 'espresso');?></span>
...
<?php }  ?>
		...
		<div id="mer-reg-page-whats-next-buttons" class="mer-whats-next-buttons">
			...
			<a id="mer-reg-page-go-to-step-3-btn" class="mer-register-btn ui-button ui-button-big ui-priority-primary ui-state-default ui-corner-all add-hover-fx icon-right hide-if-no-js" >
				<?php _e('Registration&nbsp;Step&nbsp;3&nbsp;', 'espresso'); ?><span class="ui-icon ui-icon-carat-1-e"></span>
			</a>
			...
			<noscript>
				<input type="submit" 
							...
							value="&nbsp;<?php  _e('Registration&nbsp;Step&nbsp;3&nbsp;', 'events'); ?>&nbsp;&raquo;" 
					/>				
			</noscript>	
