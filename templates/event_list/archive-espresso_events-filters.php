<div id="espresso-events-list-filters-wrapper-dv" class="column columns">
	...
	<div id="espresso-events-list-filters-dv">
		<form id="espresso-events-list-filters-frm" action="<?php echo $form_url;?>" method="POST">
			...
			<?php _e( 'View:' );?>&nbsp;
					<a id="events-list-filter-grid-lnk" class="events-list-filter-view-lnk submit-this" rel="grid" href="<?php echo $form_url;?>"  title="<?php _e( 'click to view the events in a grid' );?>"><img src="<?php echo EE_IMAGES_URL;?>event-list-grid.png" width="16" height="16" alt="<?php _e( 'Grid View' );?>" /></a>&nbsp;
					<a id="events-list-filter-text-view-lnk" class="events-list-filter-view-lnk submit-this" rel="text" href="<?php echo $form_url;?>"   title="<?php _e( 'click to view the events as a text list' );?>"><img src="<?php echo EE_IMAGES_URL;?>event-list-text.png" width="16" height="16" alt="<?php _e( 'List View' );?>" /></a>&nbsp;
					<a id="events-list-filter-dates-view-lnk" class="events-list-filter-view-lnk submit-this" rel="dates" href="<?php echo $form_url;?>"   title="<?php _e( 'click to view the events as a dates list' );?>"><img src="<?php echo EE_IMAGES_URL;?>event-list-dates.png" width="16" height="16" alt="<?php _e( 'Dates List View' );?>" /></a><!--&nbsp;
