<div class="espresso_payment_overview">
    ...
    <p><strong><?php _e('Primary Registrant:', 'event_espresso'); ?></strong> <?php echo $fname. ' ' . $lname ?></p>
    ...
    <p><strong><?php _e('Amount Paid/Owed:', 'event_espresso'); ?></strong> <?php echo $org_options[ 'currency_symbol' ] ?><?php echo $total_cost?> <?php event_espresso_paid_status_icon( $payment_status ) ?> </p>
