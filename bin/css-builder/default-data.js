export const themeColors = ['primary', 'secondary', 'accent', 'default'];

export const themeColorDesc = {
	primary:
...
export const defaultSizes = ['micro', 'tiny', 'smaller', 'small', 'default', 'big', 'bigger', 'huge', 'extreme'];

export const defaultRadii = ['none', 'small', 'default', 'big', 'bigger', 'huge', 'full'];

export const fontSizeDesc = {
	micro:
...
export const entityStatusGroups = {
	datetime: [
