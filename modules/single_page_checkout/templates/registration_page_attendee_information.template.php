...
<h2 id="spco-attendee_information-hdr" class="spco-step-title-hdr">
	...
	<a id="spco-edit-attendee_information-lnk" class="spco-go-to-attendee_information spco-edit-step-lnk <?php echo $edit_lnk_class; ?>"  href="<?php echo $edit_lnk_url; ?>"><?php _e('edit', 'event_espresso'); ?></a>
</h2>
