<!--**********************************  STEP 3 	**********************************-->			
	...
	<h2 id="mer-reg-page-step-title-3-hdr" class="mer-reg-page-step-title-hdr">
		...
		<a id="mer-reg-page-edit-step-3-lnk" class="mer-reg-page-go-to-step-3 mer-reg-page-edit-step-lnk <?php echo $edit_lnk_class; ?>"  href="<?php echo $edit_lnk_url; ?>"><?php _e('edit', 'event_espresso'); ?></a>
	</h2>
	
	<div id="mer-reg-page-step-3-dv" class="mer-reg-page-step-dv <?php echo $step_dv_class; ?>	">
