...
//		EE_Registry::instance()->load_file( SPCO_INC_PATH, 'EE_SPCO_Reg_Step', 'class'  );
	...
	public function translate_js_strings() {
		...
		EE_Registry::$i18n_js_strings['registration_expiration_notice'] = sprintf(
			__( '%1$sWe\'re sorry, but you\'re registration time has expired.%2$s%3$s%4$sIf you still wish to complete your registration, please return to the %5$sEvent List%6$sEvent List%7$s and reselect your tickets if available. Please except our apologies for any inconvenience this may have caused.%8$s', 'event_espresso' ),
