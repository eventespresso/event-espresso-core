			...
			<tbody>
				...
				<tr>
					<th><label for="timezone">
						<?php _e('Choose a timezone for the transaction? ', 'event_espresso'); ?><?php // do_action('AHEE_help', 'timezone') // removed: no relevent help available, is it required? self explanatory?  ?>
					</label></th>
					<td><?php
						$values = array(
