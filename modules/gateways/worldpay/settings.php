					...
					<ul>
						...
						<li>
							<label for="button_url">
								<?php _e('Button Image URL: ', 'event_espresso'); ?> <?php do_action('AHEE_help', 'button_image'); ?>
							</label>
						...
						<li>
							<label for="image_url">
								<?php _e('Image URL (logo for payment page):', 'event_espresso'); ?> <?php do_action('AHEE_help', 'worldpay_image_url_info'); ?>
							</label>
					...
					<ul>
						<li>
							<label for="currency_format">
								<?php _e('Select the currency for your country:', 'event_espresso'); ?> <?php do_action('AHEE_help', 'worldpay_currency_info'); ?>
							</label>
						...
						<li><label for="bypass_payment_page">
								<?php _e('Bypass Payment Overview Page?', 'event_espresso'); ?> <?php do_action('AHEE_help', 'worldpay_bypass_confirmation'); ?>
							</label>
							<?php
							$values = array(
									array('id' => false, 'text' => __('No', 'event_espresso')),
									array('id' => true, 'text' => __('Yes', 'event_espresso')));
							echo EEH_Form_Fields::select_input('bypass_payment_page', $values, $payment_settings['worldpay']['bypass_payment_page']);
							?></li>

						<li>
							<label for="use_sandbox">
								<?php _e('Use the Debugging Feature and the worldpay Sandbox?', 'event_espresso'); ?> <?php do_action('AHEE_help', 'worldpay_sandbox_info'); ?>
							</label>
