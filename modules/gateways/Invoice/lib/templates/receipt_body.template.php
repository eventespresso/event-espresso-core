...
<div id="invoice">
        ...
        <tr>
            ...
            <td>
                <div id="invoice-info">
                    ...
                    <h3 id="invoice-txn-status"><?php
                        esc_html_e('Status:', 'event_espresso') ?>
    ...
    <div class="events">
        ...
        foreach ($events_for_txn as $event_id => $event) { ?>
            <h3 class="section-title event-name">
                ...
                echo EE_IMAGES_URL . 'calendar_year-24x24.png'; ?>">
                <?php
                esc_html_e(
                    "Event Name:",
                    "event_espresso"
                ) ?> <span class="plain-text"><?php
                    echo $event->name(); ?></span> <span class="small-text link">[ <a
                        href='<?php
                        echo $event->get_permalink() ?>'><?php
                        esc_html_e('view', 'event_espresso'); ?></a> ]</span>
            </h3>
            <?php
                    ...
                    <li class="event-ticket">
                        <div class="ticket-details">
                            <table class="invoice-amount">
                                <thead>
                                <tr class="header_row">
                                    <th class="name-column"><?php
                                        esc_html_e("Ticket", "event_espresso"); ?></th>
                                    ...
                                    <th class="number-column item_c"><?php
                                        esc_html_e("Quantity", "event_espresso"); ?></th>
                                    <th class="number-column item_c"><?php
                                        esc_html_e("Price", "event_espresso"); ?></th>
                                    <th class="number-column item_r"><?php
                                        esc_html_e("Total", "event_espresso"); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                if (count($subitems) < 2) { ?>
                                    <tr class="item">
                                        <td><?php
                                            echo $line_item->name() . $taxable_html ?></td>
                                        <td colspan="2"><?php
                                            echo $line_item->desc(); ?><p
                                                class="ticket-note">
                                                <?php
                                                echo sprintf(
                                                    __(
                                        ...
                                        <td class="item_c"><?php
                                            echo $line_item->quantity() ?></td>
                                        <td class="item_c"><?php
                                            echo $line_item->prettyUnitPrice() ?></td>
                                        <td class="item_r"><?php
                                            echo $line_item->prettyTotal() ?></td>
                                    </tr>
                                    <?php
                                } else { ?>
                                    <tr class="item">
                                        <td class="aln-left"><?php
                                            echo $line_item->name() . $taxable_html ?></td>
                                        <td colspan="2"><?php
                                            echo $line_item->desc(); ?><p
                                                class="ticket-note">
                                    ...
                                    foreach ($subitems as $sub_line_item) {
                                        ...
                                        <tr class="subitem-row">
                                            <td class="subitem"><?php
                                                echo $sub_line_item->name() ?></td>
                                            <td colspan="2"><?php
                                                echo $sub_line_item->desc() ?></td>
                                            <td class="item_c"><?php
                                                // echo $is_percent ? '' : $sub_line_item->quantity()?></td>
                                            <td class="item_c"><?php
                                                echo $is_percent ? $sub_line_item->percent() . "%"
                                                    : $sub_line_item->prettyUnitPrice() ?></td>
                                            <td class="item_r"><?php
                                                echo $sub_line_item->prettyTotal() ?></td>
                                        </tr>
                                        <?php
                                    } ?>
                                    ...
                                    <div class="ticket-place-details">
                                        ...
                                        <ul class="event-venues">
                                            ...
                                            foreach ($event->venues() as $venue) { ?>
                                                <li><?php
                                                    echo $venue->name() ?> <span class="small-text">[ <a
                                                            href='<?php
                                    ...
                                    foreach ($registrations_per_line_item[ $line_item_id ] as $registration) {
                                        ...
                                        <li class="ticket-registration">
                                            <table class="registration-details">
                                                <tr class="odd">
                                                    <th><?php
                                                        echo esc_html_e("Registration Code:", "event_espresso"); ?></th>
                                                    <td><?php
                                                        echo $registration->reg_code(); ?> - <span
                                                            class="<?php
                                                            echo $registration->status_ID() ?>">
                                                            <?php
                                                            echo $registration->pretty_status() ?></span>
                                                    </td>
                                                </tr>
                                                <?php
                                                foreach ($event->question_groups() as $question_group) {
                                                    ...
                                                    foreach ($question_group->questions() as $question) {
                                                        ...
                                                        <tr>
                                                        <th><?php
                                                            echo $question->display_text() ?></th>
                                                        <td>
                                                            <?php
                                                            echo $registration->answer_value_to_question(
                                                                $question
                                                            ); ?></td>
                                                        </tr><?php
                                                    }
                                                    if ($has_personal_info) {
                                                        ...
                                                        <tr>
                                                        <th><?php
                                                            esc_html_e('Attendee', 'event_espresso'); ?></th>
                                                        <td>
                                                            <?php
                                                            echo sprintf(
    ...
    <div class="taxes">
        <?php
        if ($tax_total_line_item && $tax_total_line_item->children()) { ?>
            <h3 class="section-title"><?php
                esc_html_e("Taxes", 'event_espresso') ?></h3>
            <table class="invoice-amount">
                ...
                foreach ($tax_total_line_item->children() as $child_tax) {
                    ...
                    <tr>
                        ...
                        <td class="item_r">
                            <?php echo $child_tax->prettyTotal() ?>
                        </td>
                    </tr>
                    <?php
                } ?>
                <tr class="total_tr odd">
                    ...
                    <td class="item_r">
                        <?php echo $tax_total_line_item->prettyTotal() ?>
                    </td>
                </tr>
                </tbody>
        ...
        <p><?php
            esc_html_e("* taxable items", "event_espresso"); ?></p>
    </div>
    ...
    <div class="payment-dv">
        <h3 class="section-title"><?php
            esc_html_e("Payments", 'event_espresso') ?></h3>
        <p>[instructions]</p>
        <table class="invoice-amount">
            <thead>
            <tr class="header_row">
                <th><span class=""><?php
                        esc_html_e('Payment Method', 'event_espresso'); ?></span></th>
                <th class='left datetime_th'><?php
                    esc_html_e("Date", 'event_espresso') ?></th>
                <th><span class=""><?php
                        esc_html_e('Transaction Id / Cheque #', 'event_espresso'); ?></span></th>
                <th><span class=""><?php
                        esc_html_e('P.O. / S.O.#', 'event_espresso'); ?></span></th>
                <th><span class=""><?php
                        esc_html_e('Status', 'event_espresso'); ?></span></th>
                <th><?php
                    esc_html_e('Amount', 'event_espresso'); ?></th>
            </tr>
            </thead>
            <tbody>
            <?php
            ...
            if (! empty($payments)) {
                foreach ($payments as $payment) {
                    ...
                    echo(($c = ! $c) ? ' odd' : '') ?>'>
                        <td><?php
                            $payment->e('PAY_gateway') ?></td>
                        <td><?php
                            echo $payment->timestamp() ?></td>
                        <td><?php
                            $payment->e('PAY_txn_id_chq_nmbr') ?></td>
                        <td><?php
                            $payment->e('PAY_po_number') ?></td>
                        <td><?php
                            $payment->e_pretty_status() ?></td>
                        <td class='item_r'><?php
                            echo $payment->amount_no_code() ?></td>
                    </tr>
                    <?php
                }
            } else {
    ...
    <div class="additional-info-dv">
        <h3 class="section-title"><?php
            esc_html_e("Additional Information:", "event_espresso"); ?></h3>
