...
Class EE_Authnet extends EE_Offsite_Gateway {
	...
	public static function instance(EEM_Gateways &$model) {
		...
		if (self::$_instance === NULL or !is_object(self::$_instance) or ! ( self::$_instance instanceof  EE_Authnet )) {
	...
	protected function _display_settings() {
		...
		<tr>
			<th><label for="authnet_transaction_key">
					...
					<?php do_action('AHEE_help', 'transaction_key_info') ?>
				</label></th>
		...
		<tr>
			<th><label for="sim_image_url">
					...
					<?php do_action('AHEE_help', 'authnet_image_url_info') ?>
				</label></th>
		...
		<tr>
			<th><label for="use_sandbox">
					...
					<?php do_action('AHEE_help', 'authnet_sandbox'); ?>
				</label></th>
		...
		<tr>
			<th><label for="use_md5">
					...
					<?php do_action('AHEE_help', 'authnet_use_md5'); ?>
				</label></th>
			<td><?php echo EEH_Form_Fields::select_input('use_md5', $this->_yes_no_options, $this->_payment_settings['use_md5']); ?></td>
		</tr>
		
		<tr>
			<th><label for="authnet_md5_value">
					<?php _e('Authorize.net MD5 Hash value', 'event_espresso'); ?>
					<?php do_action('AHEE_help', 'authnet_md5_value') ?>
				</label></th>
		...
		<tr>
			<th><label for="sim_button_url">
					...
					<?php do_action('AHEE_help', 'authnet_button_url_info') ?>
				</label></th>
	...
	public function espresso_display_payment_gateways() {
		...
		<?php _e('After finalizing your registration, you will be transferred to the Authorize.net website where your payment will be securely processed.', 'event_espresso'); ?>
		</div>
