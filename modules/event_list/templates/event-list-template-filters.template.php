	...
	<div id="espresso-events-list-filters-dv">
		<form id="espresso-events-list-filters-frm" action="<?php echo $form_url;?>" method="POST">
			...
			<?php _e( 'View:' );?>&nbsp;
					...
					<a id="events-list-filter-text-view-lnk" class="events-list-filter-view-lnk submit-this" rel="text-list" href="<?php echo $form_url;?>"   title="<?php _e( 'click to view the events as a text list' );?>"><img src="<?php echo EE_IMAGES_URL;?>event-list-list-view.png" width="16" height="16" alt="<?php _e( 'List View' );?>" /></a>&nbsp;
					<a id="events-list-filter-dates-view-lnk" class="events-list-filter-view-lnk submit-this" rel="dates-list" href="<?php echo $form_url;?>"   title="<?php _e( 'click to view the events as a dates list' );?>"><img src="<?php echo EE_IMAGES_URL;?>event-list-dates-list-view.png" width="16" height="16" alt="<?php _e( 'Dates List View' );?>" /></a><!--&nbsp;
