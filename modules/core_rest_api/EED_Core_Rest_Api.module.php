...
class EED_Core_Rest_Api extends EED_Module
{
     ...
     * @return bool
     */
    public static function should_have_write_endpoints($model)
    {
     ...
     * @return string
     */
    public static function get_collection_route($model)
    {
     ...
     * @return string
     */
    public static function get_relation_route_via($model, $id, $relation_obj)
    {
     ...
     * @return array
     */
    protected function _get_response_selection_query_params($model, $version, $single_only = false)
    {
     ...
     * @return array
     */
    protected function _get_delete_query_params($model, $version)
    {
        $params_for_delete = [
            'allow_blocking' => [
                'required' => false,
     ...
     * @since $VID:$
     */
    protected function _get_add_relation_query_params($source_model, $related_model, $version)
    {
     ...
     * @throws EE_Error
     */
    protected function _get_read_query_params($model, $version)
    {
        $default_orderby = [];
     ...
     */
    public static function default_sanitize_callback($value, $request, $param)
    {
