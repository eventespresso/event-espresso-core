...
// ---------------------------------------
		...
		if ((function_exists('event_espresso_email_config_mnu') || $org_options['use_personnel_manager'] || $org_options['use_venue_manager']) && $espresso_premium) {
			...
			//Pricing Manager
				add_submenu_page('events', __('Event Espresso - Pricing Manager', 'event_espresso'), __('Pricing', 'event_espresso'), apply_filters('filter_hook_espresso_management_capability', 'administrator', $espresso_manager['espresso_manager_event_pricing']), 'event_prices', 'espresso_price_manager_menu');
