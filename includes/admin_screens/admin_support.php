...
function espresso_admin_help_links_meta_box() {
	?>
	<div class="padding">
		<ul id="quick-links">
			<li><a href="#install">
...
function espresso_admin_help_installation_meta_box() {
	?>
...
function espresso_admin_help_partners_meta_box() {
	?>
	<div class="padding">
		<dl id="partners">
...
function espresso_admin_help_hire_devs_meta_box() {
	?>
	<a name="hire_devs" id="hire_devs"></a>
	<div class="padding">
		<dl id="hire_devs">
...
function espresso_admin_help_theme_devs_meta_box() {
	?>
	<a name="theme_devs" id="theme_devs"></a>
	<div class="padding">
		<dl id="developers">
...
function espresso_admin_help_plugins_meta_box() {
	?>
...
function espresso_admin_help_themes_meta_box() {
	?>
...
function espresso_admin_help_resources_meta_box() {
	?>
...
function espresso_admin_help_shortcodes_meta_box() {
	?>
...
function espresso_admin_help_information_meta_box() {
	?>
...
function espresso_admin_help_support_meta_box() {
	?>
...
function espresso_admin_help_faq_meta_box() {
	?>
	<a name="faq" id="faq"></a>
	<div class="padding">
		<dl id="faqs">
...
function espresso_admin_help_additional_info_meta_box() {
	?>
	<a name="additonal" id="additonal"></a>
	<div class="padding">
		<dl id="additonal">
