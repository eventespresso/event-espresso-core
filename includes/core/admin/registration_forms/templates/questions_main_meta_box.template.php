			...
			<tr>
				...
				<td>
					...
					<span class="description">
						...
						echo sprintf( 
							__("
								'Text' is best for small text (fewer than 100 characters).%s
								'Text area' is best for large text (paragraphs).%s
								'SINGLE' is for a multiple-choice question where registrants can only choose one option.%s
								'DROPDOWN' and 'MULTIPLE' allow users to select multiple options.%s
								'DATE' allows users to select a date."  ,'event_espresso'),
							'<br />',
							'<br />',
							'<br />',
							'<br />'
