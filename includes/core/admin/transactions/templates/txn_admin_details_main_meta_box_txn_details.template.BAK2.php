<div id="admin-primary-mbox-dv" class="admin-primary-mbox-dv">
	...
	<h4 class="admin-primary-mbox-h4 hdr-has-icon">
		<img class="cash-single" src="<?php echo EVENT_ESPRESSO_PLUGINFULLURL;?>images/icons/Cash - Single_16x16.png" alt="" /><?php _e( 'Payment Details', 'event_espresso' );?>
	</h4>
	...
	<ul id="txn-admin-payment-options-ul">
		...
		<li>
			<a id="display-txn-admin-apply-refund" class="button-secondary display-the-hidden no-icon no-hide" rel="txn-admin-apply-refund" >
	...
	<div id="txn-admin-apply-payment-dv" class="txn-admin-payment-option auto-hide hidden">
		...
		<form id="txn-admin-apply-payment-frm" name="txn-admin-apply-payment-frm">		
			<!--<div class="admin-primary-mbox-tbl-wrap clear">-->
				<!--<div class="admin-primary-mbox-tbl-wrap-inner clear">-->
				
					<div class="txn-admin-apply-payment-date float-left">
						<label for="txn-admin-payment-date-inp"><?php _e( 'Payment Date', 'event_espresso' );?></label>
					</div>
					
					<div class="txn-admin-apply-payment-amount float-left">
						<label for="txn-admin-payment-amount-inp"><?php _e( 'Amount', 'event_espresso' );?></label>
					</div>
					
					<div class="txn-admin-apply-payment-method float-left">
						<label for="txn-admin-payment-method-inp"><?php _e( 'Method of Payment', 'event_espresso' );?></label>
					</div>
					
					<div class="mop-CC mop">
						<div class="txn-admin-apply-payment-gateway float-left">
							<label for="txn-admin-payment-gateway-inp"><?php _e( 'Gateway', 'event_espresso' );?></label>
						</div>
						
						<div class="txn-admin-apply-payment-response float-left">
							<label for="txn-admin-payment-gateway-response-inp"><?php _e( 'Gateway Response', 'event_espresso' );?></label>
						</div>
						
						<div class="txn-admin-apply-payment-gw-txn-id float-left">
							<label for="txn-admin-payment-gateway-txn-id-inp"><?php _e( 'Gateway TXN ID', 'event_espresso' );?></label>
						</div>		
					</div>
				
					<div class="mop-CHQ mop hidden">
					</div>
	
					<div class="mop-CSH mop hidden">
					</div>
	
					<div class="clear"></div>
				
					<div class="txn-admin-apply-payment-date float-left">
						<input name="txn_admin_payment[date]" id="txn-admin-payment-date-inp" class="datepicker hasDatepicker" type="text" value="<?php echo date( 'F j, Y g:i a' ); ?>">
					</div>
					...
					<div class="mop-CC mop">
						...
						<div class="txn-admin-apply-payment-gw-txn-id float-left">
							<input id="txn-admin-payment-gateway-txn-id-inp" name="txn_admin_payment[txn_id_chq_nmbr]" type="text" />
						</div>
					</div>
