...
abstract class EE_Admin_Page_Init extends EE_BASE {
	...
	protected function _initialize_admin_page() {
		...
		$path_to_file=apply_filters("filter_hooks_espresso_path_to_{$name}_{$admin_page}",$path_to_file);//so if the file would be in EE_CORE_ADMIN/attendees/Attendee_Admin_Page.core.php, the filter would be filter_hooks_espresso_path_to_attendees_Attendee_Admin_Page
