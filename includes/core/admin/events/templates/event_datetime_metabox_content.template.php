		...
		<?php foreach ($times as $time) : ?>
			<tr valign="top" id="event-dates-and-times-row-<?php echo $row; ?>" class="">
				...
				<td class="">
					...
					<input id="event-end-<?php echo $row; ?>" name="event_datetimes[<?php echo $row; ?>][evt_end]" type="text" class="dtm-ee-picker dtm-inp" value="<?php $time->e_end_date_and_time(  'Y-m-d '  ); ?>"/>
				...
				<td class="">
					...
					<input id="reg-start-<?php echo $row; ?>" name="event_datetimes[<?php echo $row; ?>][reg_start]" type="text" class="dtm-rs-picker dtm-inp" value="<?php $time->e_reg_start_date_and_time(  'Y-m-d '  ) ?>" />
				...
				<td class="">
					...
					<input id="reg-end-<?php echo $row; ?>" name="event_datetimes[<?php echo $row; ?>][reg_end]" type="text" class="dtm-re-picker dtm-inp" value="<?php $time->e_reg_end_date_and_time(  'Y-m-d '  ) ?>" />
