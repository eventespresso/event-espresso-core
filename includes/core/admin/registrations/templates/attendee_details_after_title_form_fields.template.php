...
<div id="titlediv">
	<div id="titlewrap">
		...
		<input type="text" class="smaller-text-field" name="ATT_lname" value="<?php echo $attendee->get('ATT_lname'); ?>" id="ATT_lname" placeholder="<?php _e('Last Name', 'event_espresso'); ?>" required>
