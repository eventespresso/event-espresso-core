...
<div id="titlediv">
	<div id="titlewrap">
		...
		<input type="text" class="smaller-text-field" name="ATT_fname" value="<?php echo $attendee->get('ATT_fname'); ?>" id="ATT_fname" placeholder="<?php _e('First Name', 'event_espresso'); ?>">
