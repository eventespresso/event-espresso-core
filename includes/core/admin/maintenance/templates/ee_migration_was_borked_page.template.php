...
<p><?php_e('Please contact %1$s Event Espresso Support %2$s, and copy-and-paste the below information into your message', "event_espresso"); ?></p>
<form action='<?php echo EE_Admin_Page::add_query_args_and_nonce(array('action'=>'send_migration_crash_report'), EE_MAINTENANCE_ADMIN_URL);?>' method='post'>
	<table class='widefat'> 
		<tr><td><label for='from'><?php _e("From/Reply-To:", "event_espresso");?></label></td><td><input name='from' id='from' type='text' style="width:200px"value='<?php echo EE_Registry::instance()->CFG->organization->email ?>'></td></tr>
