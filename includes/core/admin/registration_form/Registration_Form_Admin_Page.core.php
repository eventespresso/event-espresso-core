...
//					'restore_questions' => __('Restore', 'event_espresso'),
	...
	protected function _edit_question_group( $type = 'add' ) {
		...
		$this->_template_args['admin_page_content'] = EEH_Template::display_template( REGISTRATION_FORM_TEMPLATE_PATH . 'question_groups_main_meta_box.template.php', $this->_template_args, TRUE );
	...
	protected function get_query_params($model, $per_page=10,$current_page=10){
		...
		$orderby_field = $model instanceof EEM_Question ? 'QST_order' : $model->get_primary_key_field()->get_name();
	...
	protected function _reg_form_settings() {
		...
		$this->_template_args['recaptcha_theme'] = isset( $this->EE->CFG->registration->recaptcha_theme ) ? $this->_display_nice( $this->EE->CFG->registration->recaptcha_theme ) : 'clean';
	...
	protected function _update_reg_form_settings() {
		...
		$this->EE->CFG = apply_filters( 'FHEE_reg_form_settings_save', $this->EE->CFG );	
