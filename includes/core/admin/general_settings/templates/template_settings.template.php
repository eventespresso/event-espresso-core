		<div class="padding">
			...
			<h4 class="ee-admin-settings-hdr"><?php _e('Event Listings', 'event_espresso'); ?></h4>
		...
		<h4 class="ee-admin-settings-hdr"><?php _e('Registration Pages', 'event_espresso'); ?></h4>
		...
		<table class="form-table">
			<tbody>
					...
					<tr>
						...
						<td><?php echo EE_Form_Fields::select_input('display_address_in_regform', $values, $template_settings['display_address_in_regform'], 'id="display_address_in_regform"'); ?>
							<span class="description">
		...
		<h4 class="ee-admin-settings-hdr"><?php _e('Themes & Styles', 'event_espresso'); ?></h4>
		...
		<table class="form-table">
			...
			<p class="padding">
				<em class="important"><strong><?php _e('ATTENTION:', 'event_espresso'); ?></strong><br /></em>
				<?php 
					echo sprintf( 
	...
	<?php if ( $custom_templates_exist ) { ?>
	
		<h4 class="ee-admin-settings-hdr"><?php _e('Custom Templates', 'event_espresso'); ?></h4>
		...
		<?php if ( ! $template_settings['use_custom_templates']) { ?>
		...
		<div class="ee-attention"> 
			...
			<p>
				...
				<strong><?php _e("Path: ", 'event_espresso'); ?>wp-content/uploads/espresso/templates/</strong>
			</p>

				<h6><?php _e('Current Template Files:', 'event_espresso'); ?></h6>
			...
			<p class="fugue f-error">
				...
				<span class='display-path'>
					<strong><?php _e("Path:", 'event_espresso'); ?></strong> wp-content/uploads/espresso/templates/ 
				</span>
			</p>
