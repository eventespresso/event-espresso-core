<div style="padding:1em;">	
	<form id="att-admin-add-new-attendee-frm" method="post" action="<?php echo $form_url; ?>">
		...
		<table class="form-table">
			<tbody>
				...
				<tr valign="top">
					...
					<td>
						<div class="validation-notice-dv"><?php _e( 'The following is  a required field', 'event_espresso' );?></div>
						<input class="regular-text required" type="text" id="ATT_email" name="ATT_email" value="<?php echo $attendee_email; ?>"/>
					</td>
				</tr>
		...
		<div id="publishing-action">
			<input class="button-primary" type="submit" name="save_and_edit" value="<?php _e('Save'); ?>" class="add_new_attendee" />
			<input class="button-primary" type="submit" name="save_and_close" value="<?php _e('Save &amp; Close'); ?>" class="add_new_attendee" />
		</div>
		<div class="clear"></div>
