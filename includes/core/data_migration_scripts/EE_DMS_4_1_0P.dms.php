		...
		if ($wpdb->get_var("SHOW TABLES LIKE '$price_table'") == $price_table) {
			...
			if ( ! $prices_exist ) {
				$SQL = "INSERT INTO $price_table
							...
							(2, 2, '10', 'Early Bird Discount', 'Sign up early and receive an additional 10% discount off of the regular price. Example content - delete if you want to', 1, NULL, 20, 0, 3, 0),
							(3, 5, '7.50', 'Service Fee', 'Covers administrative expenses. Example content - delete if you want to', 1, NULL, 30, 0, 4, 0),
							(4, 6, '7.00', 'Local Sales Tax', 'Locally imposed tax. Example content - delete if you want to', 1, NULL, 40, 0, 5, 0),
							(5, 7, '15.00', 'Sales Tax', 'Federally imposed tax. Example content - delete if you want to', 1, NULL, 50, 0, 6, 0);";			
