...
//					printr( $CPT_Strategy, '$CPT_Strategy  <br /><span style="font-size:10px;font-weight:normal;">' . __FILE__ . '<br />line no: ' . __LINE__ . '</span>', 'auto' );
					add_filter( 'posts_fields', array( $CPT_Strategy, 'posts_fields' ));
					add_filter( 'posts_join',	array( $CPT_Strategy, 'posts_join' ));
 ...
 * ------------------------------------------------------------------------
 */
class EE_CPT_Venue_Strategy extends EE_CPT_Strategy {
