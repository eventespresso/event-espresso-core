	...
	if (espresso_total_events() > 0) {
		...
		<?php _e('Actions', 'event_espresso'); ?>
			...
			<?php 			} ?>
							...
							<td class="date"><div style="width:180px;"><a href="<?php echo espresso_reg_url( $event->id, $event->slug ); ?>" title="<?php _e('View Event', 'event_espresso'); ?>" target="_blank"><div class="view_btn"></div></a>
