 ...
 * ------------------------------------------------------------------------
 *
 * Events Locale Rel Model
 * 
 *
 * @package				Event Espresso
 * @subpackage		mvc-models
 * @author					Brent Christensen 
 * @table 						wp_events_locale_rel
 *
 * ------------------------------------------------------------------------
 */
class Events_locale_rel extends espresso_model {
	
	protected $table_name = EVENTS_LOCALE_REL_TABLE;

	// array representation of wp_events_locale_rel table and the data types for each field 
...
// End of file Events_locale_rel.model.php
// Location: /ee-mvc/models/Events_locale_rel.model.php