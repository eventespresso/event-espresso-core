 ...
 * ------------------------------------------------------------------------
 *
 * Events Category Detail Model
 * 
 *
 * @package				Event Espresso
 * @subpackage		mvc-models
 * @author					Brent Christensen 
 * @table 						wp_events_category_detail
 *
 * ------------------------------------------------------------------------
 */
class Events_category_detail extends espresso_model {
	
	protected $table_name = EVENTS_CATEGORY_TABLE;

	// array representation of wp_events_category_detail table and the data types for each field 
	protected $table_data_types = array (	
			'id' 														=> '%d', 	
			'category_name' 					=> '%s', 	
			'category_identifier' 		=> '%s', 	
			'category_desc' 					=> '%s', 	 	
			'display_desc' 						=> '%s', 	 	
			'wp_user'										=> '%d'
		);
...
// End of file Events_category_detail.model.php
// Location: /ee-mvc/models/Events_category_detail.model.php