 ...
 * ------------------------------------------------------------------------
 *
 * Events Venue Rel Model
 * 
 *
 * @package				Event Espresso
 * @subpackage		mvc-models
 * @author					Brent Christensen 
 * @table 						wp_events_venue_rel
 *
 * ------------------------------------------------------------------------
 */
class Events_venue_rel extends espresso_model {
	
	protected $table_name = EVENTS_VENUE_REL_TABLE;

	// array representation of wp_events_venue_rel table and the data types for each field 
...
// End of file Events_venue_rel.model.php
// Location: /ee-mvc/models/Events_venue_rel.model.php