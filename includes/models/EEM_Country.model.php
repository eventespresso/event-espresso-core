	...
	*/	
	public function get_all_countries() {
		if ( ! self::$_all_countries ) {
			self::$_all_countries = self::instance()->get_all( 'CNT_name', 'ASC', array( 0,99999 ));
		}
	...
	*/	
	public function get_all_active_countries() {
		if ( ! self::$_active_countries ) {
			self::$_active_countries =  self::instance()->get_all_where( array( 'CNT_active' => 1 ), 'CNT_name', 'ASC', '=', array( 0,99999 ));
		}
