 ...
 * ------------------------------------------------------------------------
 *
 * Events Category Rel Model
 * 
 *
 * @package				Event Espresso
 * @subpackage		mvc-models
 * @author					Brent Christensen 
 * @table 						wp_events_category_rel
 *
 * ------------------------------------------------------------------------
 */
class Events_category_rel extends espresso_model {
	
	protected $table_name = EVENTS_CATEGORY_REL_TABLE;

	// array representation of wp_events_category_rel table and the data types for each field 
...
// End of file Events_category_rel.model.php
// Location: /ee-mvc/models/Events_category_rel.model.php