 ...
 * @table 						wp_events_email
 *
 * ------------------------------------------------------------------------
 */
class Events_email extends espresso_model {
	
	protected $table_name = EVENTS_EMAIL_TABLE;

	// array representation of wp_events_email table and the data types for each field 
...
// End of file Events_email.model.php
// Location: /ee-mvc/models/Events_email.model.php