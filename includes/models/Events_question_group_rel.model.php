 ...
 * ------------------------------------------------------------------------
 *
 * Events Question Group Rel Model
 * 
 *
 * @package				Event Espresso
 * @subpackage		mvc-models
 * @author					Brent Christensen 
 * @table 						wp_events_qst_group_rel
 *
 * ------------------------------------------------------------------------
 */
class Events_question_group_rel extends espresso_model {
	
	protected $table_name = EVENTS_QST_GROUP_REL_TABLE;

	// array representation of wp_events_qst_group_rel table and the data types for each field 
...
// End of file Events_question_group_rel.model.php
// Location: /ee-mvc/models/Events_question_group_rel.model.php