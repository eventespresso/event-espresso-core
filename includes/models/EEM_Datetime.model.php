	...
	*/
	private function _get_event_datetimes( $EVT_ID = FALSE, $primary = FALSE ) {
		...
		if ( ! $EVT_ID ) {
			...
			$espresso_notices['errors'][] = 'No Event datetimes could be retreived because no event ID was received. ' . EE_Error::generate_error_code (  __FILE__, __FUNCTION__, __LINE__ );
			return FALSE;
		}
