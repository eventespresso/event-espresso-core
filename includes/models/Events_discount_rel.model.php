 ...
 * ------------------------------------------------------------------------
 *
 * Events Discount Rel Model
 * 
 *
 * @package				Event Espresso
 * @subpackage		mvc-models
 * @author					Brent Christensen 
 * @table 						wp_events_discount_rel
 *
 * ------------------------------------------------------------------------
 */
class Events_discount_rel extends espresso_model {
	
	protected $table_name = EVENTS_DISCOUNT_REL_TABLE;

	// array representation of wp_events_discount_rel table and the data types for each field 
...
// End of file Events_discount_rel.model.php
// Location: /ee-mvc/models/Events_discount_rel.model.php