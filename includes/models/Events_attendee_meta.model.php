 ...
 * ------------------------------------------------------------------------
 *
 * Events Attendee Meta Model
 * 
 *
 * @package				Event Espresso
 * @subpackage		mvc-models
 * @author					Brent Christensen 
 * @table 						wp_events_attendee_meta
 *
 * ------------------------------------------------------------------------
 */
class Events_attendee_meta extends espresso_model {
	
	protected $table_name = EVENTS_ATTENDEE_META_TABLE;

	// array representation of wp_events_attendee_meta table and the data types for each field 
...
// End of file Events_attendee_meta.model.php
// Location: /ee-mvc/models/Events_attendee_meta.model.php