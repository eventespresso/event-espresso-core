 ...
 * @table 						wp_events_venue
 *
 * ------------------------------------------------------------------------
 */
class Events_venue extends espresso_model {
	
	protected $table_name = EVENTS_VENUE_TABLE;

	// array representation of wp_events_venue table and the data types for each field 
...
// End of file Events_venue.model.php
// Location: /ee-mvc/models/Events_venue.model.php