...
class EE_Has_Many_Any_Relation extends EE_Has_Many_Relation{	
	...
	function get_join_statement(){
		...
		return $this->_left_join($fk_table, 
				...
				$field_with_model_name->get_qualified_column()."='".$this->get_this_model()->get_this_model_name()."'") . $this->get_other_model()->_construct_internal_join_to_table_with_alias($other_table_alias)
