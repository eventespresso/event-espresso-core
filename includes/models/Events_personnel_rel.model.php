 ...
 * ------------------------------------------------------------------------
 *
 * Events Personnel Rel Model
 * 
 *
 * @package				Event Espresso
 * @subpackage		mvc-models
 * @author					Brent Christensen 
 * @table 						wp_events_personnel_rel
 *
 * ------------------------------------------------------------------------
 */
class Events_personnel_rel extends espresso_model {
	
	protected $table_name = EVENTS_PERSONNEL_REL_TABLE;

	// array representation of wp_events_personnel_rel table and the data types for each field 
...
// End of file Events_personnel_rel.model.php
// Location: /ee-mvc/models/Events_personnel_rel.model.php