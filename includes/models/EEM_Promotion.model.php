...
class EEM_Promotion extends EEM_Base {
	...
	protected function __construct(){
		$this->singlular_item = __('Promotion','event_espresso');
		...
		$this->_fields = array(
			'Promotion'=>array(
				...
				'PRO_uses'=>new EE_Integer_Field('PRO_uses', __("Times used within a given scope", "event_espresso"), false,1),
				'PRO_global'=>new EE_Boolean_Field('PRO_global', __("Usable Globally?", "event_espresso"), false,false),
				'PRO_global_uses'=>new EE_Integer_Field('PRO_global_uses', __("Times used Globally", "event_espresso"), false,0),
