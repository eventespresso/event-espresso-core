 ...
 * @table 						wp_events_meta
 *
 * ------------------------------------------------------------------------
 */
class Events_meta extends espresso_model {
	
	protected $table_name = EVENTS_CATEGORY_TABLE;

	// array representation of wp_events_meta table and the data types for each field 
...
// End of file Events_meta.model.php
// Location: /ee-mvc/models/Events_meta.model.php