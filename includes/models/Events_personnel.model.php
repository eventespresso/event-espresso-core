 ...
 * ------------------------------------------------------------------------
 *
 * Events Personnel Model
 * 
 *
 * @package				Event Espresso
 * @subpackage		mvc-models
 * @author					Brent Christensen 
 * @table 						wp_events_personnel
 *
 * ------------------------------------------------------------------------
 */
class Events_personnel extends espresso_model {
	
	protected $table_name = EVENTS_PERSONNEL_TABLE;

	// array representation of wp_events_personnel table and the data types for each field 
...
// End of file Events_personnel.model.php
// Location: /ee-mvc/models/Events_personnel.model.php