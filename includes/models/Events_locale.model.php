 ...
 * @table 						wp_events_locale
 *
 * ------------------------------------------------------------------------
 */
class Events_locale extends espresso_model {
	
	protected $table_name = EVENTS_LOCALE_TABLE;

	// array representation of wp_events_locale table and the data types for each field 
...
// End of file Events_locale.model.php
// Location: /ee-mvc/models/Events_locale.model.php