 ...
 * @table 						wp_events_prices
 *
 * ------------------------------------------------------------------------
 */
class Events_prices extends espresso_model {
	
	protected $table_name = EVENTS_PRICES_TABLE;

	// array representation of wp_events_prices table and the data types for each field 
...
// End of file Events_prices.model.php
// Location: /ee-mvc/models/Events_prices.model.php