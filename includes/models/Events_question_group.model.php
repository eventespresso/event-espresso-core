 ...
 * ------------------------------------------------------------------------
 *
 * Events Question Group Model
 * 
 *
 * @package				Event Espresso
 * @subpackage		mvc-models
 * @author					Brent Christensen 
 * @table 						wp_events_qst_group
 *
 * ------------------------------------------------------------------------
 */
class Events_question_group extends espresso_model {
	
	protected $table_name = EVENTS_QST_GROUP_TABLE;

	// array representation of wp_events_qst_group table and the data types for each field 
...
// End of file Events_question_group.model.php
// Location: /ee-mvc/models/Events_question_group.model.php