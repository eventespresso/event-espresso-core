...
function espresso_help_popup($name) {
	return '<a class="thickbox" href="#TB_inline?height=400&amp;width=500&amp;inlineId=' . $name . '" target="_blank"><span class="question"><img width="16" height="16" src="'.EVENT_ESPRESSO_PLUGINFULLURL.'images/question-frame.png"></span></a>';
}
