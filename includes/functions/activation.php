	...
	if ($wpdb->get_var("SHOW TABLES LIKE '" . ESP_PRICE_TABLE . "'") == ESP_PRICE_TABLE) {
		...
		if ( ! $prices_exist ) {
			$SQL = "INSERT INTO " . ESP_PRICE_TABLE . "
						...
						(1, 1, 0, '10.00', 'General Admission', 'Regular price for all Events. Example content - delete if you want to', 0, NULL, NULL, 0, NULL, 0, 1),
						(2, 3, 0, '20', 'Members Discount', 'Members receive a 20% discount off of the regular price. Example content - delete if you want to', 0, NULL, NULL, 0, NULL, 10, 1),
						(3, 4, 0, '10', 'Early Bird Discount', 'Sign up early and receive an additional 10% discount off of the regular price. Example content - delete if you want to',  1, NULL, NULL, 0, NULL, 20, 1),
						(4, 5, 0, '7.50', 'Service Fee', 'Covers administrative expenses. Example content - delete if you want to', 0, NULL, NULL, 0, NULL, 30, 1),
						(5, 6, 0, '7.00', 'Local Sales Tax', 'Locally imposed tax. Example content - delete if you want to', 0, NULL, NULL, 0, NULL, 40, 1),
						(6, 7, 0, '15.00', 'Sales Tax', 'Federally imposed tax. Example content - delete if you want to', 0, NULL, NULL, 0, NULL, 50, 1);";			
...
function espresso_default_countries() {
	...
	if ( $wpdb->get_var( "SHOW TABLES LIKE '" . ESP_COUNTRY_TABLE . "'") == ESP_COUNTRY_TABLE ) {
		...
		if ( ! $countries ) {
			...
			(CNT_ISO, CNT_ISO3, RGN_ID, CNT_name, CNT_cur_code, CNT_cur_single, CNT_cur_plural, CNT_cur_sign, CNT_cur_sign_b4, CNT_cur_dec_plc, CNT_cur_dec_mrk, CNT_cur_thsnds, CNT_tel_code, CNT_is_EU, CNT_active) VALUES
