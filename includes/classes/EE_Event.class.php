...
class EE_Event { //extends EE_Event_Object
	...
	public function poplulate_event_details_from_db() {
		...
		$this->is_display_desc = $vars['display_desc'];
		$this->is_display_reg_form = $vars['display_reg_form'];
		...
		$this->is_eb_percentage = $vars['early_disc_percentage'];
		$this->is_allow_coupons = $vars['use_coupon_code'];
		$this->is_allow_groupons = $vars['use_groupon_code'];
		$this->featured_image_url = $meta['event_thumbnail_url'];
		$this->is_use_image_in_event_lists = $meta['display_thumb_in_lists'];
		$this->is_use_image_in_registration = $meta['display_thumb_in_regpage'];
