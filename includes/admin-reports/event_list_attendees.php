				...
				if ($total_attendees > 0) {
					foreach ($attendees as $attendee) {
						...
						<tr>
							...
							<?php echo function_exists('espresso_invoice_url') ? '<a href="'.espresso_invoice_url($attendee_id, $registration_id, 'admin=true').'" target="_blank"  title="'.__('Download Invoice', 'event_espresso').'"><img src="'. EVENT_ESPRESSO_PLUGINFULLURL.'images/icons/page_white_acrobat.png" width="16" height="16" alt="'.__('Download Invoice', 'event_espresso').'" /></a>' : ''; ?> 
