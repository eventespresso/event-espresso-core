...
function event_list_attendees() {
	...
	<?php echo $ticketing_installed == true ? 'null,' : '' ?>
									...
									"aoColumnDefs": [
										{ "bVisible": false, "aTargets": [  <?php if (isset($_REQUEST['event_id'])) {
		echo '4,';
	} else {
		echo '2,';
