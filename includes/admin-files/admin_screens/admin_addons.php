		...
		<div id="poststuff" class="metabox-holder has-right-sidebar">
			...
			<div id="post-body">
				<div id="post-body-content">
					<?php do_meta_boxes('event-espresso_page_admin_addons', 'advanced', null); ?>
				</div>
			</div>
		</div>
	</div>
...
function espresso_admin_addons_rem_meta_box() {
	?>
	<div class="inside">
		<ul>
...
function espresso_admin_addons_groupon_meta_box() {
	?>
	<div class="inside">
		<ul>
...
function espresso_admin_addons_members_meta_box() {
	?>
	<div class="inside">
		<ul>
			<?php
...
function espresso_admin_addons_custom_files_meta_box() {
	?>
	<div class="inside">
		<ul>
