    ...
    <fieldset class="template-settings a">
      ...
      <ul>
        <li>
          ...
          <?php echo select_input('display_short_description_in_event_list', $values, isset($org_options['display_short_description_in_event_list']) ? $org_options['display_short_description_in_event_list'] : '', 'id="display_short_description_in_event_list"'); ?> </li>
        ...
        <li>
          ...
          <?php echo select_input('display_description_on_multi_reg_page', $values, isset($org_options['display_description_on_multi_reg_page']) ? $org_options['display_description_on_multi_reg_page'] : '', 'id="display_description_on_multi_reg_page"'); ?> </li>
        <?php } ?>
        <li>
          <label for="display_address_in_event_list">
            <?php _e('Display addresses in the event listings?','event_espresso'); ?>
          </label>
          <?php echo select_input('display_address_in_event_list', $values, isset($org_options['display_address_in_event_list']) ? $org_options['display_address_in_event_list'] : '', 'id="display_address_in_event_list"'); ?> </li>
        <li>
        ...
        <li>
          ...
          <?php echo select_input('display_address_in_regform', $values, isset($org_options['display_address_in_regform']) ? $org_options['display_address_in_regform'] : '', 'id="display_address_in_regform"'); ?> </li>
        <li>
          <label for="use_custom_post_types">
            <?php _e('Use the custom post types feature?','event_espresso'); ?>
          </label>
          <?php echo select_input('use_custom_post_types', $values, isset($org_options['use_custom_post_types']) ? $org_options['use_custom_post_types']: '', 'id="use_custom_post_types"'); ?> </li>
      </ul>
    </fieldset>
  </li>
</ul>
