<div style="display: block;" id="event-post" class="postbox">
    ...
    <div class="inside">
        ...
        $post_page_array = isset($org_options['use_custom_post_types']) && $org_options['use_custom_post_types'] == 'Y' ? array_merge($custom_post_array, $post_page_array) : $post_page_array;
