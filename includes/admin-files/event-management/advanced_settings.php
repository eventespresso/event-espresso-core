...
$advanced_options .= '<p class="inputunder"><label>' . __('Use an alternate registration page? ', 'event_espresso') . '<a class="thickbox" href="#TB_inline?height=300&amp;width=400&amp;inlineId=external_URL_info"><span class="question">[?]</span></a></label>
				<input name="externalURL" size="20" type="text" value="' . $externalURL . '"> </p>';
$advanced_options .= '<p class="inputunder"><label>' . __('Use an alternate email address? ', 'event_espresso') . '<a class="thickbox" href="#TB_inline?height=300&width=400&inlineId=alt_email_info"><span class="question">[?]</span></a></label>
