...
if (function_exists('espresso_member_data') && espresso_member_data('role') == 'espresso_event_manager' && $espresso_manager['event_manager_approval'] == 'Y' && ($event_status == '' || $event_status == 'X' || $event_status == 'P')) {
	...
	$advanced_options .= '<p><label>' . __('Event Status: ', 'event_espresso')  . '<a class="thickbox" href="#TB_inline?height=300&width=400&inlineId=status_types_info"><img src="' . EVENT_ESPRESSO_PLUGINFULLURL . '/images/question-frame.png" width="16" height="16" /></a></label>'  . __(select_input('event_status', $status, $event_status)) . ' </p>';
}
...
$advanced_options .= '<p class="inputunder"><label>' . __('Use an alternate registration page? ', 'event_espresso') . '<a class="thickbox" href="#TB_inline?height=300&amp;width=400&amp;inlineId=external_URL_info"><img src="' . EVENT_ESPRESSO_PLUGINFULLURL . '/images/question-frame.png" width="16" height="16" alt="" /></a></label>
				<input name="externalURL" size="20" type="text" value="' . $externalURL . '"> </p>';
$advanced_options .= '<p class="inputunder"><label>' . __('Use an alternate email address? ', 'event_espresso') . '<a class="thickbox" href="#TB_inline?height=300&width=400&inlineId=alt_email_info"><img src="' . EVENT_ESPRESSO_PLUGINFULLURL . '/images/question-frame.png" width="16" height="16" /></a></label>
