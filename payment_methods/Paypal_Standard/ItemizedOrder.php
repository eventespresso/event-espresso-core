...
class ItemizedOrder
{
     ...
     * @throws EE_Error
     */
    private function paymentIsForTransactionTotal()
    {
     ...
     * @throws ReflectionException
     */
    private function itemizeOrderForFullPayment(EE_Line_Item $total_line_item, $item_num)
    {
     ...
     * @throws ReflectionException
     */
    private function handlePartialPayment($item_num)
    {
        $item_num = (int) $item_num;
     ...
     * @throws ReflectionException
     */
    private function addOrderItemsForLineItems(EE_Line_Item $total_line_item, $item_num)
    {
        $item_num = (int) $item_num;
     ...
     * @throws ReflectionException
     */
    private function handleItemizedOrderSumDifference(EE_Line_Item $total_line_item, $item_num)
    {
        $item_num = (int) $item_num;
     ...
     */
    private function addSandboxModeArgs($item_num, $notify_url, $return_url)
    {
        $item_num = (int) $item_num;
     ...
     * @param string $return_url
     */
    private function addGeneralOrderItems($cancel_url, $notify_url, $return_url)
    {
