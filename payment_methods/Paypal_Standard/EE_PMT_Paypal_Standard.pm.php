...
class EE_PMT_Paypal_Standard extends EE_PMT_Base{
	...
	public function __construct($pm_instance = NULL) {
		...
		$this->_default_description = sprintf( __( 'After clicking \'Finalize Registration\', you will be forwarded to PayPal to make your payment. %1$sMake sure you return to this site in order to properly finalize your registration.%2$s', 'event_espresso' ), '<strong>', '</strong>' );
