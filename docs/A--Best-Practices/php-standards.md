 ...
 * As a consequence of that, you should almost never need to put HTML tags into a translated string. Use placeholders for anywhere there is translated text.
