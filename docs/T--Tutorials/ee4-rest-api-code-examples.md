...
$data_url = "http://demoee.org/use-cases/wp-json/ee/v4.8.29/events?include=Datetime&filter[where][Datetime.DTT_EVT_end][]=>&filter[where][Datetime.DTT_EVT_end][]=" . urlencode($curdate_utc);
