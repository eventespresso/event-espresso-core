...
function espresso_init() {
	...
	add_action ( 'hook_espresso_regevent_default_action', 'display_all_events', 10, 1 );				
	...
	add_action ( 'hook_espresso_regevent_post_attendee', 'event_espresso_add_attendees_to_db', 10, 1 );				
	// add the function register_attendees() as the default action to be performed for the regevent_register_attendees hook
	add_action ( 'hook_espresso_regevent_register_attendees', 'register_attendees', 10, 1 );				
		...
		function event_espresso_run() {
			...
			switch ($regevent_action) {
				...
				case "post_attendee":				
					...
					// add functionality before posting attendees (optional)
					do_action( 'hook_espresso_before_regevent_post_attendee', $regevent_action );
					...
					do_action( 'hook_espresso_regevent_post_attendee', $regevent_action );					
					// add functionality after posting attendees (optional)
					do_action( 'hook_espresso_after_regevent_post_attendee', $regevent_action );
					
				break;
	
				case "register":
					
					// add functionality before registering attendees (optional)
					do_action( 'hook_espresso_before_regevent_register_attendees', $regevent_action );					
					...
					do_action( 'hook_espresso_regevent_register_attendees', $regevent_action );					
					// add functionality after registering attendees (optional)
					do_action( 'hook_espresso_after_regevent_register_attendees', $regevent_action );
				...
				default:
					...
					// add functionality before regevent default action (optional)
					do_action( 'hook_espresso_before_regevent_default_action', $regevent_action );
					...
					do_action( 'hook_espresso_regevent_default_action', $regevent_action );
					// add functionality after regevent default action (optional)
					do_action( 'hook_espresso_after_regevent_default_action', $regevent_action );
