...
//ajax constants
define( 'EE_FRONT_AJAX', defined( 'DOING_AJAX' ) && DOING_AJAX && ( isset( $_REQUEST['ee_front_ajax'] ) || isset( $_REQUEST['data']['ee_front_ajax'] )) ? TRUE : FALSE );
define( 'EE_ADMIN_AJAX', defined( 'DOING_AJAX' ) && DOING_AJAX && ( isset( $_REQUEST['ee_admin_ajax'] ) || isset( $_REQUEST['data']['ee_admin_ajax'] )) ? TRUE : FALSE );
